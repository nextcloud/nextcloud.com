...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <h3>Description</h3>
        <p><p>Incomplete blacklist vulnerability in lib/migrate.php in Nextcloud before 4.5.2 allows authenticated remote attackers to execute arbitrary code by uploading a crafted mount.php file in an imported ZIP file.</p>
</p>
