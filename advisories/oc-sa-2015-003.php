...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <h3>Description</h3>
        <p><p>A blacklist bypass vulnerability including UTF-8 encoding in file paths in the mentioned Nextcloud Server versions, when running on a Microsoft Windows Platform, allows authenticated remote attackers to bypass the file blacklist and upload files such as the <code>.htaccess</code> files.</p>
