...
(function() {
    // Config
    var text = {
        youtube: '<strong>Embedded YouTube-Video</strong><p class="dsgvo-text"><b>Note: </b> This embedded video is provided by YouTube, LLC, 901 Cherry Ave, San Bruno, CA 94066, USA. <a class="hyperlink" href="https://youtu.be/%id%" rel="noopener" target="_blank" title="Watch video on YouTube">Direct link to video: https://youtu.be/%id%</a> <br/> During playback, a connection to the Youtube servers is established. Youtube will be informed which pages you visit. If you are logged into your Youtube account, Youtube can assign your surfing behavior to you personally. You can prevent this by logging out of your YouTube account beforehand. If a Youtube video is started, the provider uses cookies that collect information about user behavior.<br><br>Whoever has deactivated the storage of cookies for the Google Ad program will also not have to reckon with such cookies when viewing YouTube videos. Youtube also stores non-personal usage information in other cookies. If you want to prevent this, you must block the saving of cookies in your browser. Further information on data protection at "Youtube" can be found in the privacy policy of the provider at: <a class="hyperlink" href="https://www.google.com/policies/privacy/" rel="noopener" target="_blank">https://www.google.com/policies/privacy/</a></p><button title="Watch video on this page">play video</button>',
       ...
       document.addEventListener("DOMContentLoaded", function() {
           ...
           for (var i=0, max = window.frames.length - 1; i <= max; i+=1) {
               ...
               if (video_frame.src.match(/youtube/) == null) {
                   continue;
               }
