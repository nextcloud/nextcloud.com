    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="section--paragraph"><?php echo $l->t('Nextcloud products are designed with compliance in mind, providing extensive data policy enforcement, encryption, user management and auditing capabilities.');?></p>
                <div class="row learnmore">
                    <h3 class="text-center"><?php echo $l->t('Learn more');?></h3>
                    <div class="col-sm-6">
