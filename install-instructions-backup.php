			...
			<div  class="tab-content">
				<div id="tab-archive" role="tabpanel" class="tab-pane active">
					<div class="overlay-body row">
						<div class="col-md-6">
							<p>The .tar <strong>archive</strong> is the classic way of installing Nextcloud server. It provides the server and all immediate 3rd party PHP libraries.</p>
							<ol>
								...
								<li>Verify the authenticity via PGP (<a target="_blank" href="<?php echo $DOWNLOAD_SERVER_STABLE_TAR_PGP; ?>">.tar.bz2 </a>/<a target="_blank" href="<?php echo $DOWNLOAD_SERVER_STABLE_ZIP_PGP ?>">.zip</a>). The Nextcloud GPG key <a target="_blank" href="<?php echo $OWNCLOUD_GPG ; ?>">is here</a>.</li>
							...
							<p><strong>Security note:</strong></br>To receive information about updates and security issues, we recommend a subscription to our low-traffic <a href="http://mailman.nextcloud.org/mailman/listinfo/announcements">announcement mailing list</a>.</p>
						</div>
						<div class="col-md-6">
							<div class="thumbnail">
							...
							<div class="overlay-body row">
								...
								<div class="col-md-6">
									<div class="thumbnail">
										...
										<p><strong>Security note:</strong></br> We recommend a subscription to our low-traffic <a href="http://mailman.nextcloud.org/mailman/listinfo/announcements">announcement mailing list</a> for notifications on updates and security 	issues. Find the <a href="<?php echo $OWNCLOUD_GPG; ?>">public Nextcloud GPG key here</a>.</p>
				...
				<div id="tab-mobile" role="tabpanel" class="tab-pane">
					<div class="overlay-body row">
						<div class="col-md-6">
							...
							<br />
							<p>Looking for the <a href="https://github.com/nextcloud/android">Android</a> or <a href="https://github.com/nextcloud/ios">iOS sources</a>? Looking for <a href="http://f-droid.org/app/com.nextcloud.android">F-Droid</a>?</p>
						</div>
						<div class="col-md-6">
							<div class="thumbnail">
