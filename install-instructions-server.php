                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p><?php echo $l->t('For organizations and private users, Nextcloud GmbH maintains a free appliance built on the Univention Corporate Server (UCS) with easy graphical setup and web-based administration. It includes user management via LDAP as well as optional online office integration. ');?><a class="button button--blue" href="https://www.univention.com/products/univention-app-center/app-catalog/nextcloud/" target="_blank"><?php echo $l->t('Download appliance');?></a></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
