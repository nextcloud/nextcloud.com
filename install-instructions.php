				...
				<div id="tab-cloud" role="tabpanel" class="tab-pane">
					<div class="overlay-body row">
						<div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5><?php echo $l->t('SME and home user appliance');?></h5>
                                    ...
                                    <p><?php echo $l->t('<a class="btn btn-lg btn-primary" href="https://www.techandme.se/nextcloud-vm/">Get SME and home user appliance</a>');?></p>
