...
<div class="wrap pad-bottom">
	<div class="row">
		<div class="col-md-6 col-md-offset-3 text-center">
		    ...
		    <p class="section--paragraph"><?php echo $l->t('<a href="https://newsletter.nextcloud.com/?p=subscribe&id=1" class="btn btn-primary btn-lg join-button">Subscribe</a>');?></p>
		</div>
	</div>
</div>
