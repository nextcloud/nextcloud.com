...
<div class="container">
    ...
    <div class="row">
        ...
        <p class="section--paragraph"><?php echo $l->t('By 2020, Nextcloud finalized its transition from a secure file exchange solution to a full collaboration platform with the introduction of Hub. Nextcloud Hub brings together Nextcloud Files, Talk and Groupware in a single, integrated productivity suite that empowers modern, digital organizations. Later in the year, Nextcloud responded to unprecedented demand by scaling up its video and chat capabilities for larger groups and with features specifically aimed at remote learning and day-to-day interactions of remote workers.');?></p>
        <p class="section--paragraph"><?php echo $l->t('The fast growing company and its quickly expanding partner base added thousands of new customers in the first half of 2021 and continues to innovate in the collaboration space.');?></p>
