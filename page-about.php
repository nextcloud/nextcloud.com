<div class="background abackground">
	<div class="container">
		<div class="col-md-6 topheader">
			<h1><?php echo $l->t('About Nextcloud');?></h1>
			<h2><?php echo $l->t('You should have full control over your data. We help you achieve that: a safe home for all your data. Secure, under your control and developed in an open, transparent and trustworthy way. <strong>We are Nextcloud</strong>.');?></h2>
		</div>
	</div>
</div>
<div class="container">
