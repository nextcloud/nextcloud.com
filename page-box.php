...
<div class="boxinfo">
	...
	<div class="col-md-6">
	<p><?php echo $l->t('<br /><a href="<?php echo get_template_directory_uri(); ?>/assets/img/pidrive/accessoires.jpg"><img class="conf-img img-responsive" src="<?php echo get_template_directory_uri(); ?>/assets/img/pidrive/accessoires.jpg" alt="" /></a>');\?></p>
	</div>
	</div>
</div>
...
<div class="row boxinfo">
	...
	<div class="col-lg-6 col-sm-12">
		<p><?php echo $l->t('<a href="<?php echo get_template_directory_uri(); ?>/assets/files/Box-Assembly-Guide.pdf"><img class="conf-img img-responsive" src="<?php echo get_template_directory_uri(); ?>/assets/img/pidrive/guide.png" alt="" /></a>');\?></p>
		<p><?php echo $l->t('<a href="<?php echo get_template_directory_uri(); ?>/assets/files/Box-Assembly-Guide.pdf" class="btn btn-default">download <i class="icon-file-pdf-o"></i></a>');\?></p>
	</div>
	<div class="col-lg-6 col-sm-12">
