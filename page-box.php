...
<section class="section-data-home">
	<div class="container">
		...
		<p class="section--paragraph"><?php echo $l->t('The software for the box as well as similar solutions are still being developed by Nextcloud contributors. You can use the <a class="hyperlink" href="https://uappexplorer.com/snap/ubuntu/nextcloud">Ubuntu Snap image</a> for easy installation on small and large devices that already have an operating system. Alternatively you could use <a class="hyperlink" href="https://nextcloudpi.com">the NextcloudPi image,</a> a pre-configured Raspbian system aimed at the Raspberry Pi and other boards.');?></p>
		</div>
	</div>
</section>
...
<section class="section-getbox">
	<div class="container">
		<div class="row">
			<div class="box-perspective col-lg-8"></div>
			<div class="wrapper-text col-lg-4">
				<h2 class="section--title"><?php echo $l->t('Get the box');?></h2>
				<p class="section--paragraph"><?php echo $l->t('Sadly, <strong>the box is sold.</strong> Western Digital has shut down their <a class="hyperlink" href="https://www.digitaltrends.com/computing/wdlabs-may-close-raspberry-pi/">research team WDLabs</a> which produced the box. Read our <a class="hyperlink" href="https://nextcloud.com/blog/nextcloud-box-updates-raspberry-pi-3-nextcloud-12-and-looking-for-a-new-provider/">last status update blog on the Nextcloud Box</a> for more details.s');?></p>
                <p class="section--paragraph"><a class="hyperlink" href="<?php echo home_url('devices') ?>"><?php echo $l->t('Check out our devices page for alternatives.');?></a></p>
...
<section class="section-video">
	<div class="container">
		<div class="row">
			...
			<div class="wrapper-text col-md-7">
