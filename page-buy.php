...
<div class="container">
	<div class="pricingdetails">
		...
		<table class="table table-striped">
			...
			<tr>
				<td class=""><?php echo $l->t('Users 10.001-25.000');?></td>
				<td class="ebasic price"><?php echo $l->t('<i class="icon-times"></i>');?></td>
				<td class="epro price"><?php echo $l->t('<i class="icon-times"></i>');?></td>
				<td class="eenterprise price"><?php echo $l->t('<a href="#contact">10€/user</a>');?></td>
			</tr>
			<tr>
				<td class=""><?php echo $l->t('Users >25.000');?></td>
				<td class="ebasic price"><?php echo $l->t('<i class="icon-times"></i>');?></td>
				<td class="epro  price"><?php echo $l->t('<i class="icon-times"></i>');?></td>
	...
	<p class="epricevat"><?php echo $l->t('Prices are in Euro per year and net/excl. VAT. <span class="caret"></span><a href="#pricing" data-toggle="collapse"> pricing example</a>');?></p>
		<div id="pricing" class="collapse">
			<div class="row">
				<div class="col-md-6 col-md-offset-6">
					<p><?php echo $l->t('We have a tiered price list.');?></p>
					<p><?php echo $l->t('Example for 500 users Standard Subscription:');?></p>
					<table class="table table-striped">
						<tr>
							<td><?php echo $l->t('The first 50 users:');?></td>
							<td><?php echo $l->t('+ 2.500€');?></td>
						</tr>
						<tr>
							<td><?php echo $l->t('User 51-100 (50*50€):');?></td>
							<td><?php echo $l->t('	+ 2.500€');?></td>
						</tr>
						<tr>
							<td><?php echo $l->t('User 101-250 (150*30€):');?></td>
							<td><?php echo $l->t('	+ 4.500€');?></td>
						</tr>
						<tr>
							<td><?php echo $l->t('User 251-500 (250*20€):');?></td>
							<td><?php echo $l->t('	+ 5.500€');?></td>
						</tr>
						<tr class="success">
							<td><?php echo $l->t('total for 500 users');?></td>
							<td><?php echo $l->t('	= 14.500€');?></td>
						</tr>
					</table>
				</div>
