...
<div class="container">
    ...
    <ul>
    <li><a href="#latest23">Nextcloud 23</a></li>
...
<h3 id="23-0-2">Version 23.0.2 <small>February 16 2022</small></h3>
<p>Download: <a href="https://download.nextcloud.com/server/releases/nextcloud-23.0.2.tar.bz2">nextcloud-23.0.2.tar.bz2</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-23.0.2.zip">nextcloud-23.0.2.zip</a></br>
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-23.0.2.tar.bz2.md5">nextcloud-23.0.2.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-23.0.2.zip.md5">nextcloud-23.0.2.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-23.0.2.tar.bz2.sha256">nextcloud-23.0.2.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-23.0.2.zip.sha256">nextcloud-23.0.2.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-23.0.2.tar.bz2.sha512">nextcloud-23.0.2.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-23.0.2.zip.sha512">nextcloud-23.0.2.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-23.0.2.tar.bz2.asc">nextcloud-23.0.2.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-23.0.2.zip.asc">nextcloud-23.0.2.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/29798">Check for disk_free_space (server#29798)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29965">Avoid use of iconv to get rid of unicode (server#29965)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30026">Don't query the bruteforce attempts when we just deleted them (server#30026)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30144">Fix input for groups validation in new user form (server#30144)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30151">Reload page instead of file list when getting 401 authentification error (server#30151)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30175">Allow to delete non-migrated previews instead of moving them (server#30175)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30176">Fix relation "user_id" already exists migration error (server#30176)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30180">Check resource before closing in encryption wrapper (server#30180)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30187">Use correct icon for dir-external-root (server#30187)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30190">Properly format sharing datepicker locale (server#30190)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30212">Update guzzlehttp/guzzle requirement from 6.5.2 to 6.5.5 in /build/integration (server#30212)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30213">Update sabre/dav requirement from 4.2.1 to 4.2.3 in /build/integration (server#30213)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30214">Bump dompurify from 2.3.3 to 2.3.4 (server#30214)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30215">Bump core-js from 3.19.2 to 3.19.3 (server#30215)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30236">Don't check the configvalue for lastLogin which is never null (server#30236)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30238">Support LDAP dns longer than 255 characters (server#30238)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30245">Only wildcard search if enumeration is allowed (server#30245)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30252">Fix setting up 2FA when no providers are set up but backup codes (server#30252)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30267">Carefully filter out non matching time ranges for CalDAV search (server#30267)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30272">Use bigint for autoincremented column (server#30272)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30289">Fix ShareLink Upload UI for Folders (server#30289)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30301">Use proper translation source for direct editing (server#30301)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30306">Ignore non-existing groups when notifying group shares (server#30306)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30315">Fix share owner not being displayed in sharing tab (server#30315)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30325">Update sabre/dav requirement from 4.2.3 to 4.3.0 in /build/integration (server#30325)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30339">Enhance and complement OPcache setup checks (server#30339)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30343">Fix potential unwarranted memberships in nested groups from LDAP (server#30343)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30344">Fix overlapping in the help settings section (server#30344)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30351">Remove iconv from dependencies and tests (server#30351)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30356">Fix persistent tooltip in the "new folder" input of the file picker (server#30356)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30390">Don't die with LockedException when removing/restoring multiple files from trash (server#30390)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30411">Improve personal settings on mobile (server#30411)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30431">Fix rendering app authors with homepage or email (server#30431)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30433">Add missing index for propertypath only queries of DAV properties (server#30433)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30443">Handle external share with invalid host (server#30443)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30449">Make sure to get file model in template picker (server#30449)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30455">Improve status modal (server#30455)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30462">Allow using composer plugin with composer 2.2 (server#30462)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30480">Fix uploading text position (server#30480)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30486">Run migrations fully when reenabling an app (server#30486)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30522">Fix passing on the parameter (server#30522)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30525">Fix email verification (server#30525)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30528">Update CRL after revocation of sharerenamer.crt (server#30528)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30557">Handle LocalServerException when scanning external shares (server#30557)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30576">Fix fail when keys/files folder already exists (server#30576)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30580">Use npm ci when running JS tests (server#30580)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30592">Fix: only use jquery once it is available (server#30592)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30594">Avoid zero division in setup checks (server#30594)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30602">Prevent loading images that would require too much memory. (server#30602)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30611">Fix undefined/unset scope in account properties (server#30611)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30619">Fix RequestURL check for cli commands (server#30619)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30621">Reset job disabling timer on adding the job again (server#30621)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30623">Set the file's mtime from the headers in bulk upload (server#30623)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30627">Trigger "changeDirectory" event on URL change (server#30627)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30636">Properly abort uploads (server#30636)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30643">Fix idn emails not working in shares (server#30643)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30659">Implement multibucket shift for ObjectStore (server#30659)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30662">Fix wrong unified search link to folder (server#30662)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30663">Fix primary key change in user_ldap migration (server#30663)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30671">Improve accessibility settings on mobile (server#30671)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30672">Fix file picker not respecting hidden files settings (server#30672)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30674">Add version of disabled apps when available (server#30674)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30684">Optimize FileSystemTags workflow for groupfolder (server#30684)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30685">Fix users can't login external mount user entered credentials not set (server#30685)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30688">Remove inefficient fed share scanner (server#30688)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30689">New Files internal link GET param to avoid opening the file (server#30689)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30695">UpdateEncryptedVersion: cleanup on target if cache already got renamed (server#30695)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30698">Improve layout for the public download page (server#30698)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30722">Fix loading of the text app in public shared links (server#30722)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30728">Fix non-ascii characters present in the header (server#30728)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30734">Hash job argument (server#30734)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30740">Increase email main buttons width for non-english languages (server#30740)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30747">Improve install process (server#30747)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30753">Create block-merge-freeze.yml (server#30753)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30759">Log bruteforce throttle and blocking (server#30759)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30773">Always call flush() as getAllKeys() is broken (server#30773)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30782">Add KerberosApacheAuth support to files_external (server#30782)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30799">Update sabre/dav requirement from 4.3.0 to 4.3.1 in /build/integration (server#30799)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30800">Bump jquery-ui from 1.13.0 to 1.13.1 (server#30800)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30811">Fix accessing undefined offsets (server#30811)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30814">Fix psalm not running (server#30814)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30840">23.0.1 Final (server#30840)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30847">Fix php:cs (server#30847)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30872">Prevent merging on EOL branches (server#30872)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30890">Fixes occ user:info when the user never logged in (server#30890)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30911">Bump dompurify from 2.3.4 to 2.3.5 (server#30911)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30912">Bump clipboard from 2.0.8 to 2.0.9 (server#30912)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30913">Bump webpack-cli from 4.9.1 to 4.9.2 (server#30913)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30915">Fix psalm warning related to registerEventListener (server#30915)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/30975">Update version.php (server#30975)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/31107">Fix duplicated UUID migration issue (server#31107)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/31108">Revert the 'broken' public page changes (server#31108)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/31171">Disable bulk upload by not advertising it (server#31171)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/971">Create block-merge-freeze.yml (3rdparty#971)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/715">Fix sorting of filters on php 8.0+ (activity#715)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/865">Filter allowed type of member (circles#865)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/867">Lighten select for single circle (circles#867)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/873">Bypass moderator check on CFG_FRIEND (circles#873)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/876">Better display of federated user (circles#876)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/882">Strtolower on mail address (circles#882)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/885">Only returns population on direct request from the front-end or occ command (circles#885)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/887">Enforce password on new share (circles#887)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/894">Ignore exception to group sync (circles#894)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/896">Exception on null token (circles#896)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/898">L10n: Improved grammar (circles#898)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/907">Create block-merge-freeze.yml (circles#907)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/914">Fix loosing memberships in low depth (circles#914)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/918">Remove shares during circles destruction, clean orphan shares on cron (circles#918)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/919">Paginate Circles through OCS query parameters (circles#919)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/922">GetSingleId(): string; (circles#922)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/530">Bump actions (files_pdfviewer#530)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/534">Bump @nextcloud/eslint-config from 6.1.0 to 6.1.2 (files_pdfviewer#534)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/535">Bump @nextcloud/webpack-vue-config from 4.1.0 to 4.1.4 (files_pdfviewer#535)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/544">Create block-merge-freeze.yml (files_pdfviewer#544)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/549">Updating lint-php.yml workflow from template (files_pdfviewer#549)</a></li>
        <li><a href="https://github.com/nextcloud/files_rightclick/pull/131">Create block-merge-freeze.yml (files_rightclick#131)</a></li>
        <li><a href="https://github.com/nextcloud/files_videoplayer/pull/256">Create block-merge-freeze.yml (files_videoplayer#256)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/652">Fix overlapping buttons (firstrunwizard#652)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/661">Create block-merge-freeze.yml (firstrunwizard#661)</a></li>
        <li><a href="https://github.com/nextcloud/logreader/pull/636">Create block-merge-freeze.yml (logreader#636)</a></li>
        <li><a href="https://github.com/nextcloud/nextcloud_announcements/pull/92">Create block-merge-freeze.yml (nextcloud_announcements#92)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1137">Create block-merge-freeze.yml (notifications#1137)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/315">Create block-merge-freeze.yml (password_policy#315)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/1009">Bump autoprefixer from 10.3.6 to 10.3.7 (photos#1009)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/1010">Bump @nextcloud/eslint-config from 6.1.0 to 6.1.2 (photos#1010)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/1011">Bump postcss-loader from 6.2.0 to 6.2.1 (photos#1011)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/1012">Bump @nextcloud/event-bus from 2.1.0 to 2.1.1 (photos#1012)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/1013">Bump @nextcloud/initial-state from 1.2.0 to 1.2.1 (photos#1013)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/951">Fix default previews (photos#951)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/960">Fix Tags: Don't display tags without photos (photos#960)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/981">Update workflows (photos#981)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/985">Bump @nextcloud/webpack-vue-config from 4.1.0 to 4.1.4 (photos#985)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/986">Bump url-parse from 1.5.3 to 1.5.4 (photos#986)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/987">Bump vue-router from 3.5.2 to 3.5.3 (photos#987)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/988">Bump qs from 6.10.1 to 6.10.3 (photos#988)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/989">Bump camelcase from 6.2.0 to 6.2.1 (photos#989)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/998">Create block-merge-freeze.yml (photos#998)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/676">Fix label of account name and hide parts with subscription (privacy#676)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/684">Create block-merge-freeze.yml (privacy#684)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/690">Update workflows (privacy#690)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/470">Create block-merge-freeze.yml (recommendations#470)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/473">Update test.yml (recommendations#473)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/352">Create block-merge-freeze.yml (serverinfo#352)</a></li>
        <li><a href="https://github.com/nextcloud/survey_client/pull/123">Create block-merge-freeze.yml (survey_client#123)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1976">Update mark input/paste rules to tiptap v2 regular expressions (text#1976)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1979">Don't show "Link file" button when using direct edition (text#1979)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1984">Make sure translations are detected (text#1984)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2005">Fix only the first item gets tasklist-ified issue (text#2005)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2023">Fix: use stable23 branch for cypress tests (text#2023)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2035">Fix autofocus on empty documents without a node (Fixes: #1974) (text#2035)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2041">Add stylelint to github actions (text#2041)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2046">Fix: cypress login with new session feature (text#2046)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2078">Bump @nextcloud/event-bus from 2.1.0 to 2.1.1 (text#2078)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2081">Bump @nextcloud/initial-state from 1.2.0 to 1.2.1 (text#2081)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2084">Bump @nextcloud/webpack-vue-config from 4.1.0 to 4.1.4 (text#2084)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2085">Bump @cypress/browserify-preprocessor from 3.0.1 to 3.0.2 (text#2085)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2086">Bump prosemirror-markdown from 1.6.0 to 1.6.2 (text#2086)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2088">Bump @nextcloud/eslint-config from 6.1.0 to 6.1.2 (text#2088)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2100">Bump prosemirror-view from 1.23.5 to 1.23.6 (text#2100)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2105">Fix closing the editor modal in public folder view (text#2105)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2109">Fix: 2020 let heading menu overflow workspace (text#2109)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/2115">Create block-merge-freeze.yml (text#2115)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1066">Disable fade-out because of accessbility reasons (viewer#1066)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1089">Fix german (Sie) translations comming from nextcloud-vue (viewer#1089)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1094">Add cypress summary for easier branch protection mgmt (viewer#1094)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1099">Add engines support for cypress tests (viewer#1099)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1108">Always check for `OCA.Files` before using it (Fixes: #1106) (viewer#1108)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1114">Disable swiping on viewer video controls (viewer#1114)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1122">Disable swiping on viewer audio controls (viewer#1122)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1133">Create block-merge-freeze.yml (viewer#1133)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1138">Update lint-php.yml (viewer#1138)</a></li>
</ul>
...
<h3 id="22-2-5">Version 22.2.5 <small>February 16 2022</small></h3>
<p>Download: <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.5.tar.bz2">nextcloud-22.2.5.tar.bz2</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.5.zip">nextcloud-22.2.5.zip</a></br>
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.5.tar.bz2.md5">nextcloud-22.2.5.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.5.zip.md5">nextcloud-22.2.5.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.5.tar.bz2.sha256">nextcloud-22.2.5.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.5.zip.sha256">nextcloud-22.2.5.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.5.tar.bz2.sha512">nextcloud-22.2.5.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.5.zip.sha512">nextcloud-22.2.5.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.5.tar.bz2.asc">nextcloud-22.2.5.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.5.zip.asc">nextcloud-22.2.5.zip.asc</a></p>

<h4>Changes</h4>
<ul>
	<li><a href="https://github.com/nextcloud/server/pull/28659">Delete calendar subscriptions as well when deleting user (server#28659)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/29324">Add a prefix index to filecache.path, attempt 2 (server#29324)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/29799">Check for disk_free_space (server#29799)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/29962">Interpolate the log message also for logged exceptions (server#29962)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30237">Don't check the configvalue for lastLogin which is never null (server#30237)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30250">Fix setting up 2FA when no providers are set up but backup codes (server#30250)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30260">Support LDAP dns longer than 255 characters (server#30260)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30288">Fix ShareLink Upload UI for Folders (server#30288)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30300">Use proper translation source for direct editing (server#30300)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30307">Ignore non-existing groups when notifying group shares (server#30307)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30316">Fix share owner not being displayed in sharing tab (server#30316)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30323">Update sabre/dav requirement from 4.2.3 to 4.3.0 in /build/integration (server#30323)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30340">Fix potential unwarranted memberships in nested groups from LDAP (server#30340)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30345">Fix overlapping in the help settings section (server#30345)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30347">Stable23] Avoid use of iconv to get rid of unicode (server#30347)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30357">Fix persistent tooltip in the "new folder" input of the file picker (server#30357)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30391">Don't die with LockedException when removing/restoring multiple files from trash (server#30391)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30432">Fix rendering app authors with homepage or email (server#30432)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30434">Add missing index for propertypath only queries of DAV properties (server#30434)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30444">Handle external share with invalid host (server#30444)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30450">Make sure to get file model in template picker (server#30450)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30453">Improve status modal (server#30453)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30481">Fix uploading text position (server#30481)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30487">Run migrations fully when reenabling an app (server#30487)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30515">Remove iconv from dependencies and tests (server#30515)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30523">Fix passing on the parameter (server#30523)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30526">Fix email verification (server#30526)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30529">Update CRL after revocation of sharerenamer.crt (server#30529)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30558">Handle LocalServerException when scanning external shares (server#30558)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30578">Fix fail when keys/files folder already exists (server#30578)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30581">Use npm ci when running JS tests (server#30581)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30591">Fix: only use jquery once it is available (server#30591)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30598">Add better index for finding unindexed paths (server#30598)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30603">Prevent loading images that would require too much memory. (server#30603)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30610">Fix undefined/unset scope in account properties (server#30610)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30618">Fix RequestURL check for cli commands (server#30618)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30622">Reset job disabling timer on adding the job again (server#30622)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30628">Trigger "changeDirectory" event on URL change (server#30628)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30637">Properly abort uploads (server#30637)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30644">Fix idn emails not working in shares (server#30644)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30658">Implement multibucket shift for ObjectStore (server#30658)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30664">Fix wrong unified search link to folder (server#30664)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30666">Fix primary key change in user_ldap migration (server#30666)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30670">Improve accessibility settings on mobile (server#30670)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30673">Fix file picker not respecting hidden files settings (server#30673)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30675">Add version of disabled apps when available (server#30675)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30683">Optimize FileSystemTags workflow for groupfolder (server#30683)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30687">Remove inefficient fed share scanner (server#30687)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30690">New Files internal link GET param to avoid opening the file (server#30690)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30692">Fix users can't login external mount user entered credentials not set (server#30692)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30694">UpdateEncryptedVersion: cleanup on target if cache already got renamed (server#30694)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30697">Improve layout for the public download page (server#30697)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30727">Fix non-ascii characters present in the header (server#30727)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30736">Hash job argument (server#30736)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30741">Increase email main buttons width for non-english languages (server#30741)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30748">Improve install process (server#30748)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30752">Revert "Improve layout for the public download page" (server#30752)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30754">Create block-merge-freeze.yml (server#30754)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30760">Log bruteforce throttle and blocking (server#30760)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30774">Always call flush() as getAllKeys() is broken (server#30774)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30780">Add KerberosApacheAuth support to files_external (server#30780)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30786">Fix backport/30470/stable22 (server#30786)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30807">Update sabre/dav requirement from 4.3.0 to 4.3.1 in /build/integration (server#30807)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30812">Fix accessing undefined offsets (server#30812)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30826">Fix psalm (server#30826)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30839">22.2.4 Final (server#30839)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30848">Fix php:cs (server#30848)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30873">Prevent merging on EOL branches (server#30873)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30910">Bump clipboard from 2.0.8 to 2.0.9 (server#30910)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30914">Fix psalm warning related to registerEventListener (server#30914)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30930">Cast orphan subscription id to int (server#30930)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30971">Fix preview generation for office documents (server#30971)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30976">Update version.php (server#30976)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/31013">Prevent writing invalid mtime (server#31013)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/31109">Fix duplicated UUID migration issue (server#31109)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/31114">Revert the 'broken' public page changes (server#31114)</a></li>
	<li><a href="https://github.com/nextcloud/3rdparty/pull/972">Create block-merge-freeze.yml (3rdparty#972)</a></li>
	<li><a href="https://github.com/nextcloud/activity/pull/667">Pass activity link to notification (activity#667)</a></li>
	<li><a href="https://github.com/nextcloud/activity/pull/716">Fix sorting of filters on php 8.0+ (activity#716)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/827">Backport of #797 (circles#827)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/864">Filter allowed type of member (circles#864)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/868">Lighten select for single circle (circles#868)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/874">Bypass moderator check on CFG_FRIEND (circles#874)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/877">Better display of federated user (circles#877)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/883">Strtolower on mail address (circles#883)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/886">Only returns population on direct request from the front-end or occ command (circles#886)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/888">Enforce password on new share (circles#888)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/893">Exception on null token (circles#893)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/895">Ignore exception to group sync (circles#895)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/899">L10n: Improved grammar (circles#899)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/908">Create block-merge-freeze.yml (circles#908)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/915">Fix loosing memberships in low depth (circles#915)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/920">Paginate Circles through OCS query parameters (circles#920)</a></li>
	<li><a href="https://github.com/nextcloud/circles/pull/921">Remove shares during circles destruction, clean orphan shares on cron (circles#921)</a></li>
	<li><a href="https://github.com/nextcloud/files_pdfviewer/pull/531">Bump actions (files_pdfviewer#531)</a></li>
	<li><a href="https://github.com/nextcloud/files_pdfviewer/pull/545">Create block-merge-freeze.yml (files_pdfviewer#545)</a></li>
	<li><a href="https://github.com/nextcloud/files_pdfviewer/pull/550">Updating lint-php.yml workflow from template (files_pdfviewer#550)</a></li>
	<li><a href="https://github.com/nextcloud/files_rightclick/pull/132">Create block-merge-freeze.yml (files_rightclick#132)</a></li>
	<li><a href="https://github.com/nextcloud/files_videoplayer/pull/257">Create block-merge-freeze.yml (files_videoplayer#257)</a></li>
	<li><a href="https://github.com/nextcloud/firstrunwizard/pull/639">Disable fade-out because of accessbility reasons (firstrunwizard#639)</a></li>
	<li><a href="https://github.com/nextcloud/firstrunwizard/pull/653">Fix overlapping buttons (firstrunwizard#653)</a></li>
	<li><a href="https://github.com/nextcloud/firstrunwizard/pull/662">Create block-merge-freeze.yml (firstrunwizard#662)</a></li>
	<li><a href="https://github.com/nextcloud/logreader/pull/637">Create block-merge-freeze.yml (logreader#637)</a></li>
	<li><a href="https://github.com/nextcloud/nextcloud_announcements/pull/93">Create block-merge-freeze.yml (nextcloud_announcements#93)</a></li>
	<li><a href="https://github.com/nextcloud/notifications/pull/1138">Create block-merge-freeze.yml (notifications#1138)</a></li>
	<li><a href="https://github.com/nextcloud/password_policy/pull/316">Create block-merge-freeze.yml (password_policy#316)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/924">Bump @nextcloud/initial-state from 1.2.0 to 1.2.1 (photos#924)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/952">Fix default previews (photos#952)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/961">Fix Tags: Don't display tags without photos (photos#961)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/963">Bump qs from 6.10.1 to 6.10.3 (photos#963)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/964">Bump url-parse from 1.5.3 to 1.5.4 (photos#964)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/982">Update workflows (photos#982)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/999">Create block-merge-freeze.yml (photos#999)</a></li>
	<li><a href="https://github.com/nextcloud/privacy/pull/677">Fix label of account name and hide parts with subscription (privacy#677)</a></li>
	<li><a href="https://github.com/nextcloud/privacy/pull/685">Create block-merge-freeze.yml (privacy#685)</a></li>
	<li><a href="https://github.com/nextcloud/privacy/pull/691">Update workflows (privacy#691)</a></li>
	<li><a href="https://github.com/nextcloud/recommendations/pull/471">Create block-merge-freeze.yml (recommendations#471)</a></li>
	<li><a href="https://github.com/nextcloud/recommendations/pull/474">Update test.yml (recommendations#474)</a></li>
	<li><a href="https://github.com/nextcloud/serverinfo/pull/353">Create block-merge-freeze.yml (serverinfo#353)</a></li>
	<li><a href="https://github.com/nextcloud/survey_client/pull/124">Create block-merge-freeze.yml (survey_client#124)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1912">Bump babel-loader from 8.2.2 to 8.2.3 (text#1912)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1935">Bump @nextcloud/initial-state from 1.2.0 to 1.2.1 (text#1935)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1936">Bump @cypress/browserify-preprocessor from 3.0.1 to 3.0.2 (text#1936)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1967">Hide menu and keep focus when using menubar popover items (text#1967)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1977">Update mark input/paste rules to tiptap v2 regular expressions (text#1977)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1980">Don't show "Link file" button when using direct edition (text#1980)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1989">Make sure translations are parsed correctly (text#1989)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1993">Fix scss deprecated syntax (text#1993)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1997">Pin node/npm versions (text#1997)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2003">Fix header popover in richworkspace (text#2003)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2010">Fix only the first item gets tasklist-ified issue (text#2010)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2019">Azul/rebase stable22 fix 1677 menububble position (text#2019)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2021">Fix: use stable22 branch for cypress tests (text#2021)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2036">Fix autofocus on empty documents without a node (Fixes: #1974) (text#2036)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2042">Add stylelint to github actions (text#2042)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2054">Stable22 update cypress (text#2054)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2055">Fix: cypress login with new session feature (text#2055)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2057">Backport/1883/stable22 (text#2057)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2074">Avoid creating invalid URIs from user input (text#2074)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2075">Allow to insert text after trailing codeblock (text#2075)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2076">Only register trailing node for rich text editing (text#2076)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2080">Bump cypress from 9.2.0 to 9.2.1 (text#2080)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2094">Make collabora on top of text idle message (text#2094)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2095">Only show image author annotations if needed (text#2095)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2113">Backport/stable22/2020 (text#2113)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2116">Create block-merge-freeze.yml (text#2116)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1067">Disable fade-out because of accessbility reasons (viewer#1067)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1070">Add light ⬇️ dowload icon (viewer#1070)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1071">Fix github actions (viewer#1071)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1074">Add light ⬇️ dowload icon (fixed) (viewer#1074)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1076">Build(deps): bump camelcase from 6.2.0 to 6.2.1 (viewer#1076)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1090">Fix german (Sie) translations comming from nextcloud-vue (viewer#1090)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1093">Add cypress summary for easier branch protection mgmt (viewer#1093)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1100">Add engines support for cypress tests (viewer#1100)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1109">Always check for `OCA.Files` before using it (Fixes: #1106) (viewer#1109)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1115">Disable swiping on viewer video controls (viewer#1115)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1123">Disable swiping on viewer audio controls (viewer#1123)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1134">Create block-merge-freeze.yml (viewer#1134)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1139">Update lint-php.yml (viewer#1139)</a></li>
</ul>
...
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.1.tar.bz2.sha256">nextcloud-22.2.1.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.1.zip.sha256">nextcloud-22.2.1.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.1.tar.bz2.sha512">nextcloud-22.2.1.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.1.zip.sha512">nextcloud-22.2.1.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.1.tar.bz2.asc">nextcloud-22.2.1.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-22.2.1.zip.asc">nextcloud-22.2.1.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/28968">Ensure that user and group IDs in LDAP's tables are also max 64chars (server#28968)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29016">Fix Lots of Error: file_exists(): open_basedir restriction in effect.… (server#29016)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29046">Change output format of Psalm to Github (server#29046)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29062">Don't further setup disabled users when logging in with apache (server#29062)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29066">Allow "TwoFactor Nextcloud Notifications" to pull the state of the 2FA again (server#29066)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29073">Fix path of `file_get_contents` (server#29073)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29078">Do not transfer shares for deleted users (server#29078)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29086">Add a few sensitive config keys (server#29086)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29096">Update the certificate bundle (server#29096)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29113">Add button color variables (server#29113)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29121">Generate a better optimized query for path prefix search filters (server#29121)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29124">Set associative = true for cleanup job (server#29124)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29129">Keep pw based auth tokens valid when pw-less login happens (server#29129)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29133">Explicitly close source stream on local / encryption storage (server#29133)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29160">Properly handle folder deletion on external s3 storage (server#29160)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29162">Tokens without password should not trigger changed password invalidation (server#29162)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29183">Add 'supported'-label to all supported apps (server#29183)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29196">Keep group restrictions when reenabling apps after an update (server#29196)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29207">Fix translated app details (server#29207)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29217">Add documentation for files_no_background_scan (server#29217)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29221">Don't setup the filesystem to check for a favicon we don't use anyway (server#29221)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29225">Add proper message to created share not found (server#29225)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29251">Fix background scan doc in config (server#29251)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29262">Add configuration flag to disable the background job for files_trashbin (server#29262)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29263">Add configuration flag to disable the background job for files_versions (server#29263)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29283">Fix bug introduced on drag and drop external files (server#29283)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29288">Get `filesize()` if `file_exists()` (server#29288)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29301">Fix app upgrade (server#29301)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29311">Fix cliping issues in alternative logging buttons (server#29311)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29316">Avoid PHP errors when the LDAP attribute is not found (server#29316)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29341">Fix basic auth for OAuth token endpoint (server#29341)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29359">Fix login button alignment (server#29359)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29365">Fix security issues when copying groupfolder with advanced ACL (server#29365)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29381">Prevent duplicate auth token activity updates (server#29381)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29383">Catch null path in share manager (server#29383)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29385">Scheduling plugin not updating responding attendee status (server#29385)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29389">Make calendar schedule options translatable (server#29389)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29391">S3 external storage fixes (server#29391)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29393">Fix federated scope not shown when public addressbook upload is disabled (server#29393)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29398">Make the route name error more helpful (server#29398)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29409">Bump babel-loader from 8.2.2 to 8.2.3 (server#29409)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29410">Update behat/behat requirement from ~3.8.0 to ~3.9.0 in /build/integration (server#29410)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29415">Handle files with `is_file` instead of `file_exists` (server#29415)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29419">Fixes an undefined index when getAccessList returns an empty array (server#29419)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29427">Backport #29260: Respect user enumeration settings in user status lists (server#29427)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29442">Implement local filtering in file list (server#29442)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29459">Detect mimetype by content only with content (server#29459)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29475">Fix permissions when copying from ObjectStorage (server#29475)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29494">Bump vue-router from 3.5.2 to 3.5.3 (server#29494)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29495">Bump bootstrap from 4.6.0 to 4.6.1 (server#29495)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29503">Update CRL (server#29503)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29506">Limit parameter count per query in Cache.removeChildren (server#29506)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29519">Fix/images php 8.0 (server#29519)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29528">Revert split capability "AccountPropertyScopesFederationEnabled" (server#29528)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29534">Expose send_password_by_mail via capabilities (server#29534)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29549">Update update-psalm-baseline workflow (server#29549)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29562">Do not retain VerifyUserData job when lookup server is not available (server#29562)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29575">Bump @nextcloud/initial-state from 1.2.0 to 1.2.1 (server#29575)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29578">Update behat/behat requirement from ~3.9.0 to ~3.10.0 in /build/integration (server#29578)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29597">Handle empty directory drag-and-drop in Files UI (server#29597)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29598">Fix HTML entity rendering in file comments sidebar (server#29598)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/816">Reduce the sleep time in test-dummy-token handler (circles#816)</a></li>
        <li><a href="https://github.com/nextcloud/circles/pull/825">Dispatching event before the action (circles#825)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/513">Bump version (files_pdfviewer#513)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1078">Allow to open links in new tab (notifications#1078)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1088">Fix deleting notifications with numeric user ID (notifications#1088)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1095">Add integration tests for push registration (notifications#1095)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1103">Restore old device signature so the proxy works again (notifications#1103)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/902">Bump autoprefixer from 9.8.6 to 9.8.7 (photos#902)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/907">Bump autoprefixer from 9.8.7 to 9.8.8 (photos#907)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1871">Bump prosemirror-schema-list from 1.1.5 to 1.1.6 (text#1871)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1881">Bump prosemirror-transform from 1.3.2 to 1.3.3 (text#1881)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1885">Additional checks for workspace controller (text#1885)</a></li>
</ul>
...
<h3 id="21-0-9">Version 21.0.9 <small>February 16 2022</small></h3>
<p>Download: <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.9.tar.bz2">nextcloud-21.0.9.tar.bz2</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.9.zip">nextcloud-21.0.9.zip</a></br>
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.9.tar.bz2.md5">nextcloud-21.0.9.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.9.zip.md5">nextcloud-21.0.9.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.9.tar.bz2.sha256">nextcloud-21.0.9.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.9.zip.sha256">nextcloud-21.0.9.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.9.tar.bz2.sha512">nextcloud-21.0.9.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.9.zip.sha512">nextcloud-21.0.9.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.9.tar.bz2.asc">nextcloud-21.0.9.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.9.zip.asc">nextcloud-21.0.9.zip.asc</a></p>

<h4>Changes</h4>
<ul>
	<li><a href="https://github.com/nextcloud/server/pull/28657">Delete calendar subscriptions as well when deleting user (server#28657)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/29325">Add a prefix index to filecache.path, attempt 2 (server#29325)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/29963">Interpolate the log message also for logged exceptions (server#29963)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30117">Avoid calling image* methods on boolean (server#30117)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30178">Allow to delete non-migrated previews instead of moving them (server#30178)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30182">Check resource before closing in encryption wrapper (server#30182)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30189">Use correct icon for dir-external-root (server#30189)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30192">Properly format sharing datepicker locale (server#30192)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30216">Update sabre/dav requirement from 4.2.1 to 4.2.3 in /build/integration (server#30216)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30248">Only wildcard search if enumeration is allowed (server#30248)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30251">Fix setting up 2FA when no providers are set up but backup codes (server#30251)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30261">Support LDAP dns longer than 255 characters (server#30261)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30270">Also use case sensitive like when searching in a folder (server#30270)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30287">Fix ShareLink Upload UI for Folders (server#30287)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30308">Ignore non-existing groups when notifying group shares (server#30308)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30314">Fix share owner not being displayed in sharing tab (server#30314)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30327">Update sabre/dav requirement from 4.2.3 to 4.3.0 in /build/integration (server#30327)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30341">Fix potential unwarranted memberships in nested groups from LDAP (server#30341)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30346">Fix overlapping in the help settings section (server#30346)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30348">Stable23] Avoid use of iconv to get rid of unicode (server#30348)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30435">Add missing index for propertypath only queries of DAV properties (server#30435)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30442">Handle external share with invalid host (server#30442)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30448">Make sure to get file model in template picker (server#30448)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30454">Improve status modal (server#30454)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30482">Fix uploading text position (server#30482)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30488">Run migrations fully when reenabling an app (server#30488)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30521">Remove iconv from dependencies and tests (server#30521)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30524">Fix passing on the parameter (server#30524)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30527">Update CRL after revocation of sharerenamer.crt (server#30527)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30559">Handle LocalServerException when scanning external shares (server#30559)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30579">Fix fail when keys/files folder already exists (server#30579)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30583">Use npm ci when running JS tests (server#30583)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30590">Fix: only use jquery once it is available (server#30590)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30596">Fix static analysis on CI (server#30596)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30599">Add better index for finding unindexed paths (server#30599)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30601">Prevent loading images that would require too much memory. (server#30601)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30617">Fix RequestURL check for cli commands (server#30617)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30629">Trigger "changeDirectory" event on URL change (server#30629)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30633">Reset job disabling timer on adding the job again (server#30633)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30638">Properly abort uploads (server#30638)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30642">Fix idn emails not working in shares (server#30642)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30660">Implement multibucket shift for ObjectStore (server#30660)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30665">Fix wrong unified search link to folder (server#30665)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30667">Fix primary key change in user_ldap migration (server#30667)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30669">Improve accessibility settings on mobile (server#30669)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30676">Add version of disabled apps when available (server#30676)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30677">Fix file picker not respecting hidden files settings (server#30677)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30682">Optimize FileSystemTags workflow for groupfolder (server#30682)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30686">Remove inefficient fed share scanner (server#30686)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30693">Fix users can't login external mount user entered credentials not set (server#30693)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30737">Hash job argument (server#30737)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30749">Improve install process (server#30749)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30755">Create block-merge-freeze.yml (server#30755)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30775">Always call flush() as getAllKeys() is broken (server#30775)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30787">Fix backport/30470/stable21 (server#30787)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30809">Update sabre/dav requirement from 4.3.0 to 4.3.1 in /build/integration (server#30809)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30838">21.0.8 Final (server#30838)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30874">Prevent merging on EOL branches (server#30874)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30909">Bump clipboard from 2.0.8 to 2.0.9 (server#30909)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30946">Use existing API (server#30946)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/30977">Update version.php (server#30977)</a></li>
	<li><a href="https://github.com/nextcloud/server/pull/31115">Fix duplicated UUID migration issue (server#31115)</a></li>
	<li><a href="https://github.com/nextcloud/3rdparty/pull/973">Create block-merge-freeze.yml (3rdparty#973)</a></li>
	<li><a href="https://github.com/nextcloud/activity/pull/717">Fix sorting of filters on php 8.0+ (activity#717)</a></li>
	<li><a href="https://github.com/nextcloud/files_pdfviewer/pull/532">Bump actions (files_pdfviewer#532)</a></li>
	<li><a href="https://github.com/nextcloud/files_pdfviewer/pull/546">Create block-merge-freeze.yml (files_pdfviewer#546)</a></li>
	<li><a href="https://github.com/nextcloud/files_pdfviewer/pull/551">Updating lint-php.yml workflow from template (files_pdfviewer#551)</a></li>
	<li><a href="https://github.com/nextcloud/files_rightclick/pull/133">Create block-merge-freeze.yml (files_rightclick#133)</a></li>
	<li><a href="https://github.com/nextcloud/files_videoplayer/pull/258">Create block-merge-freeze.yml (files_videoplayer#258)</a></li>
	<li><a href="https://github.com/nextcloud/firstrunwizard/pull/640">Disable fade-out because of accessbility reasons (firstrunwizard#640)</a></li>
	<li><a href="https://github.com/nextcloud/firstrunwizard/pull/654">Fix overlapping buttons (firstrunwizard#654)</a></li>
	<li><a href="https://github.com/nextcloud/firstrunwizard/pull/663">Create block-merge-freeze.yml (firstrunwizard#663)</a></li>
	<li><a href="https://github.com/nextcloud/logreader/pull/638">Create block-merge-freeze.yml (logreader#638)</a></li>
	<li><a href="https://github.com/nextcloud/nextcloud_announcements/pull/94">Create block-merge-freeze.yml (nextcloud_announcements#94)</a></li>
	<li><a href="https://github.com/nextcloud/notifications/pull/1139">Create block-merge-freeze.yml (notifications#1139)</a></li>
	<li><a href="https://github.com/nextcloud/password_policy/pull/317">Create block-merge-freeze.yml (password_policy#317)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/1000">Create block-merge-freeze.yml (photos#1000)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/1007">Bump babel-loader from 8.2.2 to 8.2.3 (photos#1007)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/1008">Bump eslint-config-standard from 16.0.2 to 16.0.3 (photos#1008)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/959">Bump @nextcloud/vue from 3.3.1 to 3.3.2 (photos#959)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/962">Fix Tags: Don't display tags without photos (photos#962)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/967">Bump vue-loader from 15.9.6 to 15.9.8 (photos#967)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/969">Bump @nextcloud/initial-state from 1.2.0 to 1.2.1 (photos#969)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/970">Bump autoprefixer from 9.8.6 to 9.8.8 (photos#970)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/971">Bump regenerator-runtime from 0.13.7 to 0.13.9 (photos#971)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/983">Update workflows (photos#983)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/990">Bump vue-virtual-grid from 2.3.0 to 2.3.2 (photos#990)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/991">Bump vuex from 3.6.0 to 3.6.2 (photos#991)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/992">Bump vue and vue-template-compiler (photos#992)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/993">Bump qs from 6.9.6 to 6.9.7 (photos#993)</a></li>
	<li><a href="https://github.com/nextcloud/photos/pull/994">Bump camelcase from 6.2.0 to 6.2.1 (photos#994)</a></li>
	<li><a href="https://github.com/nextcloud/privacy/pull/678">Fix label of account name and hide parts with subscription (privacy#678)</a></li>
	<li><a href="https://github.com/nextcloud/privacy/pull/686">Create block-merge-freeze.yml (privacy#686)</a></li>
	<li><a href="https://github.com/nextcloud/privacy/pull/692">Update workflows (privacy#692)</a></li>
	<li><a href="https://github.com/nextcloud/recommendations/pull/472">Create block-merge-freeze.yml (recommendations#472)</a></li>
	<li><a href="https://github.com/nextcloud/recommendations/pull/475">Update test.yml (recommendations#475)</a></li>
	<li><a href="https://github.com/nextcloud/serverinfo/pull/354">Create block-merge-freeze.yml (serverinfo#354)</a></li>
	<li><a href="https://github.com/nextcloud/survey_client/pull/125">Create block-merge-freeze.yml (survey_client#125)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1894">Bump @babel/preset-env from 7.15.6 to 7.15.8 (text#1894)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1911">Bump babel-loader from 8.2.2 to 8.2.3 (text#1911)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1937">Bump @nextcloud/initial-state from 1.2.0 to 1.2.1 (text#1937)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1938">Bump @cypress/browserify-preprocessor from 3.0.1 to 3.0.2 (text#1938)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1991">Make sure translations are parsed correctly (text#1991)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1994">Fix deprecated scss syntax (text#1994)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/1998">Pin node/npm versions (text#1998)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2022">Fix: use stable21 branch for cypress tests (text#2022)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2043">Add stylelint to github actions (text#2043)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2110">Only show image author annotations if needed (text#2110)</a></li>
	<li><a href="https://github.com/nextcloud/text/pull/2117">Create block-merge-freeze.yml (text#2117)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1072">Fix github actions (viewer#1072)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1073">Add light ⬇️ download  icon (viewer#1073)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1078">Disable fade-out because of accessbility reasons (viewer#1078)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1091">Fix german (Sie) translations comming from nextcloud-vue (viewer#1091)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1095">Bump workflows (viewer#1095)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1101">Add engines support for cypress tests (viewer#1101)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1116">Disable swiping on viewer video controls (viewer#1116)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1124">Disable swiping on viewer audio controls (viewer#1124)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1135">Create block-merge-freeze.yml (viewer#1135)</a></li>
	<li><a href="https://github.com/nextcloud/viewer/pull/1140">Update lint-php.yml (viewer#1140)</a></li>
</ul>
...
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.6.tar.bz2.md5">nextcloud-21.0.6.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.6.zip.md5">nextcloud-21.0.6.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.6.tar.bz2.sha256">nextcloud-21.0.6.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.6.zip.sha256">nextcloud-21.0.6.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.6.tar.bz2.sha512">nextcloud-21.0.6.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.6.zip.sha512">nextcloud-21.0.6.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.6.tar.bz2.asc">nextcloud-21.0.6.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-21.0.6.zip.asc">nextcloud-21.0.6.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/28505">3rdparty: Bump icewind/streams from 0.7.2 to 0.7.5 (server#28505)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/28730">Handle case where storage can't be created in getStorageRootId (server#28730)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/28969">Ensure that user and group IDs in LDAP's tables are also max 64chars (server#28969)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29037">Fix Lots of Error: file_exists(): open_basedir restriction in effect (server#29037)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29047">Change output format of Psalm to Github (server#29047)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29068">File-upload: Correctly handle error responses for HTTP2 (server#29068)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29070">Update psalm baseline (server#29070)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29071">Allow "TwoFactor Nextcloud Notifications" to pull the state of the 2F… (server#29071)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29074">ExecuteQuery and executeStatement are 22+ (server#29074)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29075">Fix path of file_get_contents (server#29075)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29080">Generate a better optimized query for path prefix search filters (server#29080)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29087">Add a few sensitive config keys (server#29087)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29097">Update the certificate bundle (server#29097)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29130">Keep pw based auth tokens valid when pw-less login happens (server#29130)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29134">Explicitly close source stream on local / encryption storage (server#29134)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29137">Update icewind/streams to 0.7.5 in files_external (server#29137)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29159">Properly handle folder deletion on external s3 storage (server#29159)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29161">Tokens without password should not trigger changed password invalidation (server#29161)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29164">Don't further setup disabled users when logging in with apache (server#29164)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29178">Add button color variables (server#29178)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29182">Add 'supported'-label to all supported apps (server#29182)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29194">Revert "Add button color variables" (server#29194)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29197">Keep group restrictions when reenabling apps after an update (server#29197)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29203">Add proper message to created share not found (server#29203)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29208">Fix translated app details (server#29208)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29218">Add documentation for files_no_background_scan (server#29218)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29222">Don't setup the filesystem to check for a favicon we don't use anyway (server#29222)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29252">Fix background scan doc in config (server#29252)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29267">Add configuration flag to disable the background job for files_versions (server#29267)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29268">Add configuration flag to disable the background job for files_trashbin (server#29268)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29282">Fix bug introduced on drag and drop external files (server#29282)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29289">Get `filesize()` if `file_exists()` (server#29289)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29302">Fix app upgrade (server#29302)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29315">Avoid PHP errors when the LDAP attribute is not found (server#29315)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29322">Tell mysql to ignore the sort index for search queries (server#29322)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29367">Fix security issues when copying groupfolder with advanced ACL (server#29367)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29384">Fix federated scope not shown when public addressbook upload is disabled (server#29384)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29386">Scheduling plugin not updating responding attendee status (server#29386)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29390">Make calendar schedule options translatable (server#29390)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29399">Make the route name error more helpful (server#29399)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29403">Update behat/behat requirement from ~3.8.0 to ~3.9.0 in /build/integration (server#29403)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29411">Bump babel-loader from 8.2.2 to 8.2.3 (server#29411)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29416">Handle files with `is_file` instead of `file_exists` (server#29416)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29420">Fixes an undefined index when getAccessList returns an empty array (server#29420)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29428">Backport #29260: Respect user enumeration settings in user status lists (server#29428)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29443">Implement local filtering in file list (server#29443)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29447">S3 external storage fixes (server#29447)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29458">Detect mimetype by content only with content (server#29458)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29476">Fix permissions when copying from ObjectStorage (server#29476)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29492">Bump bootstrap from 4.6.0 to 4.6.1 (server#29492)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29493">Update guzzlehttp/guzzle requirement from 6.5.2 to 6.5.5 in /build/integration (server#29493)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29504">Update CRL (server#29504)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29507">Limit parameter count per query in Cache.removeChildren (server#29507)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29520">Fix/images php 8.0 (server#29520)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29550">Update update-psalm-baseline workflow (server#29550)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29551">Revert "tell mysql to ignore the sort index for search queries" (server#29551)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29576">Bump @nextcloud/initial-state from 1.2.0 to 1.2.1 (server#29576)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29579">Update behat/behat requirement from ~3.9.0 to ~3.10.0 in /build/integration (server#29579)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29596">Handle empty directory drag-and-drop in Files UI (server#29596)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29599">Fix HTML entity rendering in file comments sidebar (server#29599)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/730">Bump icewind/streams from 0.7.2 to 0.7.5 (3rdparty#730)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/511">Bump version (files_pdfviewer#511)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/515">Bump eslint-import-resolver-webpack from 0.13.1 to 0.13.2 (files_pdfviewer#515)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/516">Bump babel-loader from 8.2.2 to 8.2.3 (files_pdfviewer#516)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1089">Fix deleting notifications with numeric user ID (notifications#1089)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1096">Add integration tests for push registration (notifications#1096)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1104">Restore old device signature so the proxy works again (notifications#1104)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1770">Fix: rich workspaces overlap with new file dropdown (text#1770)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1870">Bump prosemirror-schema-list from 1.1.5 to 1.1.6 (text#1870)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1880">Bump prosemirror-transform from 1.3.2 to 1.3.3 (text#1880)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1886">Additional checks for workspace controller (text#1886)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1895">Bump @babel/core from 7.15.5 to 7.15.8 (text#1895)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1055">Build(deps-dev): bump eslint-import-resolver-webpack from 0.13.1 to 0.13.2 (viewer#1055)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/1056">Build(deps-dev): bump babel-loader from 8.2.2 to 8.2.3 (viewer#1056)</a></li>
</ul>
...
<h3 id="20-0-14">Version 20.0.14 <small>November 12 2021</small></h3>
<p>Download: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.14.tar.bz2">nextcloud-20.0.14.tar.bz2</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.14.zip">nextcloud-20.0.14.zip</a></br>
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.14.tar.bz2.md5">nextcloud-20.0.14.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.14.zip.md5">nextcloud-20.0.14.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.14.tar.bz2.sha256">nextcloud-20.0.14.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.14.zip.sha256">nextcloud-20.0.14.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.14.tar.bz2.sha512">nextcloud-20.0.14.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.14.zip.sha512">nextcloud-20.0.14.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.14.tar.bz2.asc">nextcloud-20.0.14.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.14.zip.asc">nextcloud-20.0.14.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/26630">Add command to repair broken filesystem trees (server#26630)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/28971">Ensure that user and group IDs in LDAP's tables are also max 64chars (server#28971)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29048">Change output format of Psalm to Github (server#29048)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29069">File-upload: Correctly handle error responses for HTTP2 (server#29069)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29072">Allow "TwoFactor Nextcloud Notifications" to pull the state of the 2F… (server#29072)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29085">Add a few sensitive config keys (server#29085)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29095">Fix path of file_get_contents (server#29095)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29098">Update the certificate bundle (server#29098)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29131">Keep pw based auth tokens valid when pw-less login happens (server#29131)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29158">Properly handle folder deletion on external s3 storage (server#29158)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29166">Tokens without password should not trigger changed password invalidation (server#29166)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29167">Don't further setup disabled users when logging in with apache (server#29167)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29181">Add 'supported'-label to all supported apps (server#29181)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29192">21] generate a better optimized query for path prefix search filters (server#29192)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29198">Keep group restrictions when reenabling apps after an update (server#29198)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29205">Add proper message to created share not found (server#29205)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29219">Add documentation for files_no_background_scan (server#29219)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29223">Don't setup the filesystem to check for a favicon we don't use anyway (server#29223)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29253">Fix background scan doc in config (server#29253)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29290">Get `filesize()` if `file_exists()` (server#29290)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29291">Fix unable to login errors due to file system not being initialized (server#29291)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29297">Update 3rdparty ref (server#29297)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29298">Bump icewind/streams from 0.7.3 to 0.7.5 in files_external (server#29298)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29303">Fix app upgrade (server#29303)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29314">Avoid PHP errors when the LDAP attribute is not found (server#29314)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29366">Fix security issues when copying groupfolder with advanced ACL (server#29366)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29387">Scheduling plugin not updating responding attendee status (server#29387)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29388">Make calendar schedule options translatable (server#29388)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29396">Add whitelist for apps inside of the server repo (server#29396)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29417">Handle files with `is_file` instead of `file_exists` (server#29417)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29421">Fixes an undefined index when getAccessList returns an empty array (server#29421)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29426">Extra fixes needed for icewind/streams update to 0.7.2 (server#29426)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29429">Backport #29260: Respect user enumeration settings in user status lists (server#29429)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29441">Implement local filtering in file list (server#29441)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29457">Detect mimetype by content only with content (server#29457)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29505">Update CRL (server#29505)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/29548">Update update-psalm-baseline workflow (server#29548)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/855">Bump icewind/streams from 0.7.1 to 0.7.5 (3rdparty#855)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/512">Bump version (files_pdfviewer#512)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1090">Fix deleting notifications with numeric user ID (notifications#1090)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1097">Add integration tests for push registration (notifications#1097)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1105">Restore old device signature so the proxy works again (notifications#1105)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/864">Bump vue and vue-template-compiler (photos#864)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1868">Bump prosemirror-schema-list from 1.1.5 to 1.1.6 (text#1868)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1887">Additional checks for workspace controller (text#1887)</a></li>
</ul>
