...
<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/22628">Coalesce RewriteCond lines in .htaccess (server#22628)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24318">Use proper methods for display name retrieval (server#24318)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25950">Add dedicated product name to OCP\Defaults (server#25950)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26319">Move files_external to IBootstrap and remove some deprecated stuff in the process (server#26319)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26323">Use constant for supported formats (server#26323)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26344">Return early if path is root (server#26344)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26346">Cleaner removePassword regex (server#26346)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26421">OCC command to delete calendars (server#26421)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26430">Dashboard API for clients (server#26430)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26571">Only allow removing existing shares that would not be allowed due to reshare restrictions (server#26571)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26701">[3rdparty] streams-0.7.4 (server#26701)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26874">Rework search api to allow searching on multiple caches at once (server#26874)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26939">Let apps toggle an unread counter on app icons (server#26939)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27051">Add timestamp tooltip (server#27051)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27089">[ProvisioningAPI] Allow specifying group display name during creation (server#27089)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27098">Force 'name' key in array (server#27098)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27102">Trigger the default action when openfile URL param is set (server#27102)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27190">Deduplicate translations and fix double . (server#27190)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27282">Bump @babel/preset-env from 7.13.15 to 7.14.4 (server#27282)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27283">L10n: Spelling unification (server#27283)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27383">Bump puppeteer from 5.5.0 to 10.0.0 in /build (server#27383)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27385">Update symfony/event-dispatcher requirement from ~4.4 to ~5.3 in /build/integration (server#27385)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27387">Bump sass from 1.34.0 to 1.34.1 (server#27387)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27410">Bump Symfony from 4.4.19 to 4.4.25 (server#27410)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27419">Bump webpack-merge from 5.7.3 to 5.8.0 (server#27419)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27426">Allow certain custom DAV props to be readable by everyone (server#27426)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27429">Don't pass a column object to addOrderBy (server#27429)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27430">Correctly check the reception of a remote feedback (server#27430)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27436">Allow apps to get photos of VObjects (server#27436)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27439">Bump giggsey/libphonenumber-for-php from 8.12.20 to 8.12.24 (server#27439)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27444">Header must contain a colon (server#27444)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27449">Bump 3rdparty from `8c6da7b` to `e924cba` (server#27449)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27450">[Automated] Update psalm-baseline.xml (server#27450)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27451">Move exception logging to separate field (server#27451)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27452">Bump opis/closure from 3.6.1 to 3.6.2 (server#27452)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27459">Bump christophwurst/id3parser from 0.1.1 to 0.1.2 (server#27459)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27464">Bump guzzlehttp/guzzle from 7.2.0 to 7.3.0 (server#27464)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27469">[Automated] Update psalm-baseline.xml (server#27469)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27470">Bump php-http/guzzle7-adapter from 0.1.1 to 1.0.0 (server#27470)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27482">Bump @babel/preset-env from 7.14.4 to 7.14.5 (server#27482)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27483">Bump @testing-library/jest-dom from 5.12.0 to 5.14.1 (server#27483)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27486">Bump @babel/plugin-proposal-class-properties from 7.13.0 to 7.14.5 (server#27486)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27497">Bump aws/aws-sdk-php from 3.171.21 to 3.184.2 (server#27497)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27506">Fix avatar actions (server#27506)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27508">Skip deleted calendar objects of deleted calendars (server#27508)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27512">Add return type for writeToCache (server#27512)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27514">Fix share activity dispatch (server#27514)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27515">Add method to read multi-value attributes from ldap (server#27515)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27516">Bump postcss from 7.0.35 to 7.0.36 (server#27516)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27517">[Automated] Update psalm-baseline.xml (server#27517)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27520">Change reviewers of Psalm baseline update (server#27520)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27522">Save a request everytime we send the heartbeat (server#27522)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27529">Fix default product name for old themes (server#27529)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27532">Properly cleanup entries of WebAuthn on user deletion (server#27532)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27534">[Automated] Update psalm-baseline.xml (server#27534)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27535">Update shipped info.xsd too (server#27535)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27537">Allow WebAuthn on localhost as well (server#27537)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27540">Handle case where storage can't be created in getStorageRootId (server#27540)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27544">Phase out the controller reflector (server#27544)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27548">[Automated] Update psalm-baseline.xml (server#27548)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27555">Bump sass from 1.34.1 to 1.35.1 (server#27555)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27561">Allow setting offset for dav search queries not limited to the users home storage (server#27561)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27566">Update Login with device page styles (server#27566)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27567">Bump karma from 5.2.3 to 6.3.4 in /build (server#27567)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27573">Bump vue-material-design-icons from 4.11.0 to 4.12.1 (server#27573)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27581">Bump vimeo/psalm from 4.7.2 to 4.8.1 (server#27581)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27583">Upgrade to GitHub-native Dependabot (server#27583)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27585">Bump phpseclib/phpseclib from 2.0.31 to 2.0.32 (server#27585)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27587">Bump icewind/streams from 0.7.4 to 0.7.5 (server#27587)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27590">Bump swiftmailer/swiftmailer from 6.2.5 to 6.2.7 (server#27590)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27593">Bump giggsey/libphonenumber-for-php from 8.12.24 to 8.12.25 (server#27593)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27595">Mail-template - don't show hyphen if slogan is empty (server#27595)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27604">Proper opacity on multiselect actions in files (server#27604)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27605">Make security warning stand out more (server#27605)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27609">Bump aws/aws-sdk-php from 3.184.2 to 3.184.6 (server#27609)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27610">Throttle on public DAV endpoint (server#27610)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27611">Bump query-string from 5.1.1 to 7.0.1 (server#27611)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27627">Bump @babel/preset-env from 7.14.5 to 7.14.7 (server#27627)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27628">Add security.txt (server#27628)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27629">Bump core-js from 3.13.1 to 3.15.1 (server#27629)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27632">Use ISO8601 timestamps for the CalDAV trashbin (server#27632)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27635">Fix usage of DateTime constants (server#27635)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27649">Fix branch selection in stable22 (server#27649)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27669">Unshift crash reports when they are loaded, to break the recusion (server#27669)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27678">Validate the theming color also on CLI (server#27678)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27682">Harden bootstrap context registrations when apps are missing (server#27682)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27702">LDAP: determine shares of offline users only when needed (server#27702)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27716">Revert "First attempt to check against core routes before loading all app routes" (server#27716)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27719">Make Provisioning API aware of multiple mails (server#27719)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27726">Downstream encryption:fix-encrypted-version for repairing "bad signature" errors (server#27726)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27736">Fix LDAPProviderFactory not found (server#27736)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/27743">Design fixes to app-settings button (server#27743)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/616">Add the psr/event-dispatcher package (3rdparty#616)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/617">Bump sabre/dav from 4.1.4 to 4.1.5 (3rdparty#617)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/621">Bump symfony/polyfill-intl-grapheme from 1.22.0 to 1.22.1 (3rdparty#621)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/622">Bump pear/archive_tar from 1.4.12 to 1.4.13 (3rdparty#622)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/623">Bump symfony/polyfill-intl-normalizer from 1.22.0 to 1.22.1 (3rdparty#623)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/627">Bump giggsey/libphonenumber-for-php from 8.12.16 to 8.12.19 (3rdparty#627)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/633">Bump psr/container from 1.0.0 to 1.1.1 (3rdparty#633)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/640">Bump giggsey/libphonenumber-for-php from 8.12.19 to 8.12.20 (3rdparty#640)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/645">Bump phpseclib/phpseclib from 2.0.30 to 2.0.31 (3rdparty#645)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/649">Upgrade to GitHub-native Dependabot (3rdparty#649)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/654">Bump opis/closure from 3.6.1 to 3.6.2 (3rdparty#654)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/662">Bump nikic/php-parser from 4.10.4 to 4.10.5 (3rdparty#662)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/672">Bump giggsey/libphonenumber-for-php from 8.12.20 to 8.12.24 (3rdparty#672)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/678">Bump Symfony from 4.4.19 to 4.4.25 (3rdparty#678)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/680">Bump Symfony from 4.4.19 to 4.4.25 (3rdparty#680)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/682">Bump php-http/guzzle7-adapter from 0.1.1 to 1.0.0 (3rdparty#682)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/683">Bump icewind/streams from 0.7.2 to 0.7.4 (3rdparty#683)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/685">Bump guzzlehttp/guzzle from 7.2.0 to 7.3.0 (3rdparty#685)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/686">Bump christophwurst/id3parser from 0.1.1 to 0.1.2 (3rdparty#686)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/687">Bump swiftmailer/swiftmailer from 6.2.5 to 6.2.7 (3rdparty#687)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/691">Bump aws/aws-sdk-php from 3.171.21 to 3.184.2 (3rdparty#691)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/692">Bump aws/aws-sdk-php from 3.184.2 to 3.184.6 (3rdparty#692)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/693">Bump phpseclib/phpseclib from 2.0.31 to 2.0.32 (3rdparty#693)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/694">Bump giggsey/libphonenumber-for-php from 8.12.24 to 8.12.25 (3rdparty#694)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/695">Bump icewind/streams from 0.7.4 to 0.7.5 (3rdparty#695)</a></li>
        ...
        <li><a href="https://github.com/nextcloud/activity/pull/565">Fix notifying own activities (activity#565)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/569">Send the footer with the defined language (activity#569)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/572">Remove self setting checking which can not be set anymore (activity#572)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/576">Ensure link names are unique for accessibility, thanks @nickvergessen, fix #575 (activity#576)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/577">Remove unneeded service replacements (activity#577)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/583">Use PNG images in daily activity summary emails (activity#583)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/587">Add .l10nignore (activity#587)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/588">Add filename in the preview docs (activity#588)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/593">Use npm 7 (activity#593)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/595">Replace deprecated occ app:check-code with xml linter (activity#595)</a></li>
        ...
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/290">Bump pdf.js to 2.6.347 (files_pdfviewer#290)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/304">Update version on master (files_pdfviewer#304)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/307">Bump cli-progress from 3.8.2 to 3.9.0 (files_pdfviewer#307)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/313">Bump @babel/preset-env from 7.12.11 to 7.12.16 (files_pdfviewer#313)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/314">Bump babel-loader-exclude-node-modules-except from 1.0.3 to 1.1.2 (files_pdfviewer#314)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/315">Bump stylelint from 13.9.0 to 13.10.0 (files_pdfviewer#315)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/316">Bump @babel/core from 7.12.10 to 7.12.16 (files_pdfviewer#316)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/317">Bump stylelint-scss from 3.18.0 to 3.19.0 (files_pdfviewer#317)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/318">Bump eslint-plugin-promise from 4.2.1 to 4.3.1 (files_pdfviewer#318)</a></li>
        ...
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/322">Bump @babel/preset-env from 7.12.16 to 7.12.17 (files_pdfviewer#322)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/323">Bump @babel/core from 7.12.16 to 7.12.17 (files_pdfviewer#323)</a></li>
        ...
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/327">Bump stylelint from 13.10.0 to 13.11.0 (files_pdfviewer#327)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/328">Bump @babel/core from 7.12.17 to 7.13.1 (files_pdfviewer#328)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/329">Bump @nextcloud/browserslist-config from 1.0.0 to 2.0.0 (files_pdfviewer#329)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/330">Bump @babel/preset-env from 7.12.17 to 7.13.5 (files_pdfviewer#330)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/331">Bump @babel/preset-env from 7.13.5 to 7.13.8 (files_pdfviewer#331)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/332">Bump @babel/core from 7.13.1 to 7.13.8 (files_pdfviewer#332)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/333">Bump @babel/preset-env from 7.13.8 to 7.13.9 (files_pdfviewer#333)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/335">Bump stylelint from 13.11.0 to 13.12.0 (files_pdfviewer#335)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/336">Bump @babel/core from 7.13.8 to 7.13.10 (files_pdfviewer#336)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/337">Bump @babel/preset-env from 7.13.9 to 7.13.10 (files_pdfviewer#337)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/342">Ignore node_modules for php-cs (files_pdfviewer#342)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/343">Bump phpunit/phpunit from 8.5.14 to 8.5.15 (files_pdfviewer#343)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/345">Bump @babel/preset-env from 7.13.10 to 7.13.12 (files_pdfviewer#345)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/346">Bump @nextcloud/browserslist-config from 2.0.0 to 2.1.0 (files_pdfviewer#346)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/347">Bump @babel/core from 7.13.10 to 7.13.13 (files_pdfviewer#347)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/348">Bump y18n from 4.0.0 to 4.0.1 (files_pdfviewer#348)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/349">Bump @babel/core from 7.13.13 to 7.13.14 (files_pdfviewer#349)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/350">Bump @babel/core from 7.13.14 to 7.13.15 (files_pdfviewer#350)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/351">Bump @babel/preset-env from 7.13.12 to 7.13.15 (files_pdfviewer#351)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/356">Bump @babel/core from 7.13.15 to 7.13.16 (files_pdfviewer#356)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/357">Bump ssri from 6.0.1 to 6.0.2 (files_pdfviewer#357)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/358">Bump dependencies (files_pdfviewer#358)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/360">Bump @babel/core from 7.13.16 to 7.14.0 (files_pdfviewer#360)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/361">Bump sass from 1.32.11 to 1.32.12 (files_pdfviewer#361)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/362">Bump @babel/preset-env from 7.13.15 to 7.14.0 (files_pdfviewer#362)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/363">Bump stylelint from 13.12.0 to 13.13.0 (files_pdfviewer#363)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/364">Bump webpack from 5.35.1 to 5.36.2 (files_pdfviewer#364)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/365">Bump webpack-cli from 4.6.0 to 4.7.0 (files_pdfviewer#365)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/366">Bump @nextcloud/eslint-config from 5.0.0 to 5.1.0 (files_pdfviewer#366)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/367">Bump node-polyfill-webpack-plugin from 1.1.0 to 1.1.1 (files_pdfviewer#367)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/368">Bump @babel/preset-env from 7.14.0 to 7.14.1 (files_pdfviewer#368)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/369">Bump stylelint from 13.13.0 to 13.13.1 (files_pdfviewer#369)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/370">Bump hosted-git-info from 2.8.8 to 2.8.9 (files_pdfviewer#370)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/371">Bump lodash from 4.17.19 to 4.17.21 (files_pdfviewer#371)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/372">Bump vue-loader from 15.9.6 to 15.9.7 (files_pdfviewer#372)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/373">Bump @babel/core from 7.14.0 to 7.14.2 (files_pdfviewer#373)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/374">Bump eslint from 7.25.0 to 7.26.0 (files_pdfviewer#374)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/375">Bump eslint-plugin-import from 2.22.1 to 2.23.0 (files_pdfviewer#375)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/377">Bump @babel/eslint-parser from 7.13.14 to 7.14.2 (files_pdfviewer#377)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/378">Bump webpack from 5.36.2 to 5.37.0 (files_pdfviewer#378)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/379">Bump node-polyfill-webpack-plugin from 1.1.1 to 1.1.2 (files_pdfviewer#379)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/380">Bump @babel/preset-env from 7.14.1 to 7.14.2 (files_pdfviewer#380)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/384">Remove encodeURI code (files_pdfviewer#384)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/385">Bump @babel/eslint-parser from 7.14.2 to 7.14.3 (files_pdfviewer#385)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/386">Bump sass from 1.32.12 to 1.33.0 (files_pdfviewer#386)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/387">Bump webpack from 5.37.0 to 5.37.1 (files_pdfviewer#387)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/388">Bump eslint-plugin-import from 2.23.0 to 2.23.3 (files_pdfviewer#388)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/389">Bump eslint-plugin-standard from 4.1.0 to 5.0.0 (files_pdfviewer#389)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/390">Bump @babel/core from 7.14.2 to 7.14.3 (files_pdfviewer#390)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/394">Bump pdf.js from 2.6.347 to 2.7.570 (files_pdfviewer#394)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/395">Bump browserslist from 4.16.3 to 4.16.6 (files_pdfviewer#395)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/402">Bump @babel/preset-env from 7.14.2 to 7.14.4 (files_pdfviewer#402)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/403">Bump @babel/eslint-parser from 7.14.3 to 7.14.4 (files_pdfviewer#403)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/404">Bump sass from 1.33.0 to 1.34.0 (files_pdfviewer#404)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/405">Bump eslint-config-standard from 16.0.2 to 16.0.3 (files_pdfviewer#405)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/406">Bump webpack from 5.37.1 to 5.38.1 (files_pdfviewer#406)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/408">Bump eslint-plugin-vue from 7.9.0 to 7.10.0 (files_pdfviewer#408)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/409">Bump babel-loader-exclude-node-modules-except from 1.1.2 to 1.2.1 (files_pdfviewer#409)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/410">Bump eslint-plugin-import from 2.23.3 to 2.23.4 (files_pdfviewer#410)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/411">Bump sass from 1.34.0 to 1.34.1 (files_pdfviewer#411)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/412">Bump eslint from 7.26.0 to 7.28.0 (files_pdfviewer#412)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/413">Bump vue-template-compiler from 2.6.12 to 2.6.13 (files_pdfviewer#413)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/414">Disable content copy for PDF files that specify it (files_pdfviewer#414)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/415">Bump trim-newlines from 3.0.0 to 3.0.1 (files_pdfviewer#415)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/416">Bump glob-parent from 5.1.1 to 5.1.2 (files_pdfviewer#416)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/422">Bump phpunit/phpunit from 8.5.15 to 8.5.16 (files_pdfviewer#422)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/423">Bump @babel/preset-env from 7.14.4 to 7.14.5 (files_pdfviewer#423)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/424">Bump vue-template-compiler from 2.6.13 to 2.6.14 (files_pdfviewer#424)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/425">Bump eslint-plugin-vue from 7.10.0 to 7.11.0 (files_pdfviewer#425)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/426">Bump @babel/eslint-parser from 7.14.4 to 7.14.5 (files_pdfviewer#426)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/427">Bump @babel/core from 7.14.3 to 7.14.5 (files_pdfviewer#427)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/428">Bump webpack-cli from 4.7.0 to 4.7.2 (files_pdfviewer#428)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/429">Bump node and npm version in package.json (files_pdfviewer#429)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/431">Bump postcss from 7.0.32 to 7.0.36 (files_pdfviewer#431)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/432">Bump deps and use npm7 (files_pdfviewer#432)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/435">Update stable22 target versions (files_pdfviewer#435)</a></li>
        <li><a href="https://github.com/nextcloud/files_rightclick/pull/112">Update version on master (files_rightclick#112)</a></li>
        <li><a href="https://github.com/nextcloud/files_videoplayer/pull/211">Update version on master (files_videoplayer#211)</a></li>
        <li><a href="https://github.com/nextcloud/files_videoplayer/pull/216">Bump elliptic from 6.5.3 to 6.5.4 (files_videoplayer#216)</a></li>
        <li><a href="https://github.com/nextcloud/files_videoplayer/pull/217">Bump y18n from 4.0.0 to 4.0.1 (files_videoplayer#217)</a></li>
        <li><a href="https://github.com/nextcloud/files_videoplayer/pull/225">Bump ssri from 6.0.1 to 6.0.2 (files_videoplayer#225)</a></li>
        <li><a href="https://github.com/nextcloud/files_videoplayer/pull/229">Bump lodash from 4.17.20 to 4.17.21 (files_videoplayer#229)</a></li>
        <li><a href="https://github.com/nextcloud/files_videoplayer/pull/239">Bump node and npm version in package.json (files_videoplayer#239)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/474">Update version on master (firstrunwizard#474)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/475">Bump @babel/preset-env from 7.12.11 to 7.12.13 (firstrunwizard#475)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/476">Bump @babel/core from 7.12.10 to 7.12.13 (firstrunwizard#476)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/477">Bump eslint-plugin-promise from 4.2.1 to 4.3.1 (firstrunwizard#477)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/478">Bump stylelint-scss from 3.18.0 to 3.19.0 (firstrunwizard#478)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/479">Bump stylelint from 13.9.0 to 13.10.0 (firstrunwizard#479)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/480">Bump @babel/core from 7.12.13 to 7.12.16 (firstrunwizard#480)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/481">Bump @babel/preset-env from 7.12.13 to 7.12.16 (firstrunwizard#481)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/482">Bump @babel/core from 7.12.16 to 7.12.17 (firstrunwizard#482)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/483">Bump @babel/preset-env from 7.12.16 to 7.12.17 (firstrunwizard#483)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/484">Bump @babel/core from 7.12.17 to 7.13.8 (firstrunwizard#484)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/485">Bump @nextcloud/vue from 3.5.4 to 3.6.0 (firstrunwizard#485)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/486">Bump @babel/preset-env from 7.12.17 to 7.13.8 (firstrunwizard#486)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/487">Bump stylelint from 13.10.0 to 13.11.0 (firstrunwizard#487)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/489">Bump vue-style-loader from 4.1.2 to 4.1.3 (firstrunwizard#489)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/490">Bump @babel/preset-env from 7.13.8 to 7.13.9 (firstrunwizard#490)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/492">Bump elliptic from 6.5.3 to 6.5.4 (firstrunwizard#492)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/493">Add fallback text for video on first slide to fix accessibility (firstrunwizard#493)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/494">Bump acorn from 8.0.5 to 8.1.0 (firstrunwizard#494)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/495">Bump stylelint from 13.11.0 to 13.12.0 (firstrunwizard#495)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/497">Bump @nextcloud/vue from 3.6.0 to 3.7.2 (firstrunwizard#497)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/498">Bump @babel/preset-env from 7.13.9 to 7.13.10 (firstrunwizard#498)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/501">Bump @babel/preset-env from 7.13.10 to 7.13.12 (firstrunwizard#501)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/502">Extend reasons for email address (firstrunwizard#502)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/505">Bump y18n from 4.0.0 to 4.0.1 (firstrunwizard#505)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/506">Bump @babel/core from 7.13.8 to 7.13.14 (firstrunwizard#506)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/507">Bump @babel/preset-env from 7.13.12 to 7.13.15 (firstrunwizard#507)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/509">Bump @nextcloud/vue from 3.7.2 to 3.9.0 (firstrunwizard#509)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/510">Bump @babel/core from 7.13.14 to 7.13.15 (firstrunwizard#510)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/512">Bump @nextcloud/dialogs from 3.1.1 to 3.1.2 (firstrunwizard#512)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/513">Bump acorn from 8.1.0 to 8.1.1 (firstrunwizard#513)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/514">Bump ssri from 6.0.1 to 6.0.2 (firstrunwizard#514)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/517">Bump stylelint from 13.12.0 to 13.13.0 (firstrunwizard#517)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/518">Bump @babel/preset-env from 7.13.15 to 7.14.0 (firstrunwizard#518)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/519">Bump @babel/core from 7.13.15 to 7.14.0 (firstrunwizard#519)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/520">Bump stylelint from 13.12.0 to 13.13.1 (firstrunwizard#520)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/522">Bump acorn from 8.1.1 to 8.2.4 (firstrunwizard#522)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/523">Bump @babel/preset-env from 7.14.0 to 7.14.1 (firstrunwizard#523)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/524">Bump lodash from 4.17.19 to 4.17.21 (firstrunwizard#524)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/525">Bump hosted-git-info from 2.7.1 to 2.8.9 (firstrunwizard#525)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/526">Bump @babel/preset-env from 7.14.1 to 7.14.2 (firstrunwizard#526)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/528">Bump @babel/core from 7.14.0 to 7.14.2 (firstrunwizard#528)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/529">Bump vue-loader from 15.9.6 to 15.9.7 (firstrunwizard#529)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/530">Replace hardcoded "Nextcloud" with cloud name from theme (firstrunwizard#530)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/531">L10n: Spelling unification (firstrunwizard#531)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/532">Bump @babel/core from 7.14.2 to 7.14.3 (firstrunwizard#532)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/533">Bump browserslist from 4.16.1 to 4.16.6 (firstrunwizard#533)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/534">Bump eslint-plugin-import from 2.22.1 to 2.23.3 (firstrunwizard#534)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/536">Bump @babel/preset-env from 7.14.2 to 7.14.4 (firstrunwizard#536)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/537">Bump vue and vue-template-compiler (firstrunwizard#537)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/538">Bump acorn from 8.2.4 to 8.3.0 (firstrunwizard#538)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/539">Bump eslint-plugin-import from 2.23.3 to 2.23.4 (firstrunwizard#539)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/540">Bump vue and vue-template-compiler (firstrunwizard#540)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/542">Bump @babel/core from 7.14.3 to 7.14.5 (firstrunwizard#542)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/543">Bump @babel/preset-env from 7.14.4 to 7.14.5 (firstrunwizard#543)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/544">Bump acorn from 8.3.0 to 8.4.0 (firstrunwizard#544)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/546">Bump postcss from 7.0.25 to 7.0.36 (firstrunwizard#546)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/547">Bump node and npm version in package.json (firstrunwizard#547)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/548">Bump striptags from 3.1.1 to 3.2.0 (firstrunwizard#548)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/549">Bump @babel/core from 7.14.5 to 7.14.6 (firstrunwizard#549)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/550">Bump stylelint-webpack-plugin from 2.1.1 to 2.2.0 (firstrunwizard#550)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/553">Update stable22 target versions (firstrunwizard#553)</a></li>
        <li><a href="https://github.com/nextcloud/logreader/pull/439">Update version on master (logreader#439)</a></li>
        <li><a href="https://github.com/nextcloud/logreader/pull/462">Replace travis ci with more github ci (logreader#462)</a></li>
        <li><a href="https://github.com/nextcloud/logreader/pull/492">Upgrade to GitHub-native Dependabot (logreader#492)</a></li>
        <li><a href="https://github.com/nextcloud/logreader/pull/503">Fix space for l10n (logreader#503)</a></li>
        <li><a href="https://github.com/nextcloud/logreader/pull/504">Bump url-parse from 1.4.7 to 1.5.1 (logreader#504)</a></li>
        <li><a href="https://github.com/nextcloud/logreader/pull/530">Properly parse new log format with dedicated exception field (logreader#530)</a></li>
        <li><a href="https://github.com/nextcloud/logreader/pull/531">Update node checks (logreader#531)</a></li>
        <li><a href="https://github.com/nextcloud/logreader/pull/534">Bump node and npm version in package.json (logreader#534)</a></li>
        <li><a href="https://github.com/nextcloud/logreader/pull/539">Update stable22 target versions (logreader#539)</a></li>
        <li><a href="https://github.com/nextcloud/nextcloud_announcements/pull/73">Update version on master (nextcloud_announcements#73)</a></li>
        <li><a href="https://github.com/nextcloud/nextcloud_announcements/pull/77">Update openssl for PHP 8.0 (nextcloud_announcements#77)</a></li>
        <li><a href="https://github.com/nextcloud/nextcloud_announcements/pull/80">Update stable22 target versions (nextcloud_announcements#80)</a></li>
        <li><a href="https://github.com/nextcloud/nextcloud_announcements/pull/83">Bye travis (nextcloud_announcements#83)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1000">Bump webpack-cli from 4.7.0 to 4.7.2 (notifications#1000)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1001">Bump vue and vue-template-compiler (notifications#1001)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1002">Bump @babel/eslint-parser from 7.14.4 to 7.14.5 (notifications#1002)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1004">Bump @babel/preset-env from 7.14.4 to 7.14.5 (notifications#1004)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1005">Bump @babel/core from 7.14.3 to 7.14.5 (notifications#1005)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1006">Bump @nextcloud/vue from 3.10.1 to 4.0.1 (notifications#1006)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1007">Bump postcss from 7.0.26 to 7.0.36 (notifications#1007)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1008">Bump node and npm version in package.json (notifications#1008)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1009">Replace deprecated occ app:check-code with xml linter (notifications#1009)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1013">Dont load UI on embedded pages (notifications#1013)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1016">Fix casting token to int (notifications#1016)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1017">Use node 14 and npm7 (notifications#1017)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1018">Bump node-polyfill-webpack-plugin from 1.1.2 to 1.1.3 (notifications#1018)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1019">Bump stylelint-webpack-plugin from 2.1.1 to 2.2.0 (notifications#1019)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1020">Bump @babel/core from 7.14.5 to 7.14.6 (notifications#1020)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1021">Bump webpack from 5.38.1 to 5.39.1 (notifications#1021)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1023">Bump eslint from 7.28.0 to 7.29.0 (notifications#1023)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1024">Bump eslint-plugin-vue from 7.11.0 to 7.11.1 (notifications#1024)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1027">Fix handling the response of the proxy (notifications#1027)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1028">Fix asterix conflict with talk (notifications#1028)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1031">Update stable22 target versions (notifications#1031)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/1037">Increase the icon size to 20px (notifications#1037)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/847">Move unit and integration testing to github action (notifications#847)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/884">Bump elliptic from 6.5.3 to 6.5.4 (notifications#884)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/885">Bump @babel/core from 7.13.8 to 7.13.10 (notifications#885)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/887">Bump stylelint from 13.11.0 to 13.12.0 (notifications#887)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/889">Bump @nextcloud/vue from 3.5.4 to 3.7.2 (notifications#889)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/899">Bump @babel/preset-env from 7.12.10 to 7.13.12 (notifications#899)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/900">Bump @nextcloud/browserslist-config from 1.0.0 to 2.1.0 (notifications#900)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/901">Bump phpunit/phpunit from 8.5.13 to 9.5.4 (notifications#901)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/902">Fix "exports is not defined" error (notifications#902)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/903">Bump @nextcloud/vue from 3.7.2 to 3.8.0 (notifications#903)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/904">Bump css-loader from 5.1.3 to 5.2.0 (notifications#904)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/905">Bump @babel/core from 7.13.10 to 7.13.13 (notifications#905)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/906">Use phpunit version from vendor/ (notifications#906)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/907">Bump psalm/phar from 4.6.2 to 4.7.0 (notifications#907)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/908">Prepend * to document title when tab hidden and new notifications (notifications#908)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/909">Only send desktop notifications in one tab (notifications#909)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/910">Bump y18n from 4.0.0 to 4.0.1 (notifications#910)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/913">Bump core-js from 3.9.1 to 3.10.0 (notifications#913)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/914">Bump @babel/core from 7.13.13 to 7.13.14 (notifications#914)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/918">Update notification-workflow.md (notifications#918)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/919">Bump @babel/preset-env from 7.13.12 to 7.13.15 (notifications#919)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/920">Bump @nextcloud/router from 1.2.0 to 2.0.0 (notifications#920)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/921">Bump css-loader from 5.2.0 to 5.2.1 (notifications#921)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/923">Bump @nextcloud/vue from 3.8.0 to 3.9.0 (notifications#923)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/924">Bump @babel/core from 7.13.14 to 7.13.15 (notifications#924)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/925">Move to latest webpack-vue-config and global babel config (notifications#925)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/926">Bump @nextcloud/dialogs from 3.1.1 to 3.1.2 (notifications#926)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/927">Bump @nextcloud/capabilities from 1.0.2 to 1.0.4 (notifications#927)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/928">Fix admin notification api (notifications#928)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/930">Code++ (notifications#930)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/931">Bump sass from 1.32.8 to 1.32.10 (notifications#931)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/932">Bump webpack from 5.31.2 to 5.33.2 (notifications#932)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/933">Bump @nextcloud/webpack-vue-config from 4.0.3-alpha.2 to 4.0.3 (notifications#933)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/934">Bump node-sass from 4.14.1 to 5.0.0 (notifications#934)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/935">Defer deletion-push when rendering or deleting all notifications (notifications#935)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/937">Only push delete-push to devices that also got the notification (notifications#937)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/940">Bump sass from 1.32.10 to 1.32.11 (notifications#940)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/941">Bump @babel/core from 7.13.15 to 7.13.16 (notifications#941)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/942">Bump eslint from 7.24.0 to 7.25.0 (notifications#942)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/943">Bump eslint-webpack-plugin from 2.5.3 to 2.5.4 (notifications#943)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/944">Bump webpack from 5.33.2 to 5.35.1 (notifications#944)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/946">Take theming info from initial state so it only updates once (notifications#946)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/947">Bump sass from 1.32.11 to 1.32.12 (notifications#947)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/948">Bump @babel/preset-env from 7.13.15 to 7.14.0 (notifications#948)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/949">Bump stylelint from 13.12.0 to 13.13.0 (notifications#949)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/950">Bump webpack from 5.35.1 to 5.36.2 (notifications#950)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/951">Bump @babel/core from 7.13.16 to 7.14.0 (notifications#951)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/952">Bump lodash from 4.17.19 to 4.17.21 (notifications#952)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/953">Bump node-polyfill-webpack-plugin from 1.1.0 to 1.1.1 (notifications#953)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/954">Bump webpack-cli from 4.6.0 to 4.7.0 (notifications#954)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/955">Bump stylelint from 13.13.0 to 13.13.1 (notifications#955)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/956">Bump @babel/preset-env from 7.14.0 to 7.14.1 (notifications#956)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/957">Bump @nextcloud/event-bus from 1.2.0 to 2.0.0 (notifications#957)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/958">Bump @nextcloud/eslint-config from 5.0.0 to 5.1.0 (notifications#958)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/959">Bump hosted-git-info from 2.7.1 to 2.8.9 (notifications#959)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/960">Replace executeUpdate with executeStatement (notifications#960)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/962">Bump @babel/core from 7.14.0 to 7.14.2 (notifications#962)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/963">Bump vue-loader from 15.9.6 to 15.9.7 (notifications#963)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/964">Bump eslint-plugin-standard from 4.1.0 to 5.0.0 (notifications#964)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/965">Bump eslint-plugin-import from 2.22.1 to 2.23.0 (notifications#965)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/966">Bump node-sass from 5.0.0 to 6.0.0 (notifications#966)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/967">Bump eslint from 7.25.0 to 7.26.0 (notifications#967)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/968">Bump webpack from 5.36.2 to 5.37.0 (notifications#968)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/969">Bump sass from 1.32.12 to 1.32.13 (notifications#969)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/970">Bump node-polyfill-webpack-plugin from 1.1.1 to 1.1.2 (notifications#970)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/971">Bump @babel/eslint-parser from 7.13.14 to 7.14.2 (notifications#971)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/972">Bump @babel/preset-env from 7.14.1 to 7.14.2 (notifications#972)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/973">Debug missing notification bell (notifications#973)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/974">Bump sass from 1.32.13 to 1.33.0 (notifications#974)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/975">Bump webpack from 5.37.0 to 5.37.1 (notifications#975)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/976">Bump @babel/core from 7.14.2 to 7.14.3 (notifications#976)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/977">Bump eslint-plugin-import from 2.23.0 to 2.23.3 (notifications#977)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/978">Bump @babel/eslint-parser from 7.14.2 to 7.14.3 (notifications#978)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/979">Bump browserslist from 4.16.3 to 4.16.6 (notifications#979)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/980">Bump sass from 1.33.0 to 1.34.0 (notifications#980)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/981">Bump @babel/preset-env from 7.14.2 to 7.14.4 (notifications#981)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/982">Bump webpack from 5.37.1 to 5.38.1 (notifications#982)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/983">Bump eslint-config-standard from 16.0.2 to 16.0.3 (notifications#983)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/984">Bump @babel/eslint-parser from 7.14.3 to 7.14.4 (notifications#984)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/985">Bump @nextcloud/vue from 3.9.0 to 3.10.0 (notifications#985)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/986">Bump eslint from 7.26.0 to 7.27.0 (notifications#986)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/987">Bump vue and vue-template-compiler (notifications#987)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/988">Bump eslint-plugin-import from 2.23.3 to 2.23.4 (notifications#988)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/989">Bump babel-loader-exclude-node-modules-except from 1.1.2 to 1.2.1 (notifications#989)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/990">Bump eslint-plugin-vue from 7.9.0 to 7.10.0 (notifications#990)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/991">Bump @nextcloud/vue from 3.10.0 to 3.10.1 (notifications#991)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/992">Bump eslint from 7.27.0 to 7.28.0 (notifications#992)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/993">Bump sass from 1.34.0 to 1.34.1 (notifications#993)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/996">Only ask for permissions on HTTPS (notifications#996)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/999">Bump eslint-plugin-vue from 7.10.0 to 7.11.0 (notifications#999)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/116">Update version on master (password_policy#116)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/118">Check all password requirements in one attempt (password_policy#118)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/119">Settings in vue (password_policy#119)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/121">More Tests, update phpunit config (password_policy#121)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/122">CS fix (password_policy#122)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/124">Fix default password length (password_policy#124)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/125">Add dependabot config (password_policy#125)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/128">Bump @babel/preset-env from 7.13.10 to 7.13.12 (password_policy#128)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/129">Bump eslint-plugin-vue from 7.7.0 to 7.8.0 (password_policy#129)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/130">Bump @nextcloud/vue from 3.7.2 to 3.8.0 (password_policy#130)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/136">Migrate to github actions and codecov (password_policy#136)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/137">Bump dependencies and webpack config (password_policy#137)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/139">Don't parse assets (password_policy#139)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/140">Bump webpack from 5.28.0 to 5.30.0 (password_policy#140)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/141">Bump webpack from 5.30.0 to 5.31.2 (password_policy#141)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/142">Bump @nextcloud/webpack-vue-config from 4.0.1 to 4.0.2 (password_policy#142)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/143">Bump @babel/preset-env from 7.13.12 to 7.13.15 (password_policy#143)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/144">Bump @nextcloud/vue from 3.8.0 to 3.9.0 (password_policy#144)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/145">Bump @babel/core from 7.13.14 to 7.13.15 (password_policy#145)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/146">Bump eslint from 7.23.0 to 7.24.0 (password_policy#146)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/147">Set default password policy length to 10 (password_policy#147)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/148">By default enable HIBP check (password_policy#148)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/149">Bump @nextcloud/dialogs from 3.1.1 to 3.1.2 (password_policy#149)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/150">Bump webpack from 5.31.2 to 5.33.2 (password_policy#150)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/151">Bump eslint-plugin-vue from 7.8.0 to 7.9.0 (password_policy#151)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/152">Bump @nextcloud/webpack-vue-config from 4.0.2 to 4.0.3 (password_policy#152)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/153">Bump sass from 1.32.8 to 1.32.10 (password_policy#153)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/154">Bump eslint-webpack-plugin from 2.5.2 to 2.5.4 (password_policy#154)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/155">Bump @babel/core from 7.13.15 to 7.13.16 (password_policy#155)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/156">Bump sass from 1.32.10 to 1.32.11 (password_policy#156)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/157">Bump webpack from 5.33.2 to 5.35.1 (password_policy#157)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/158">Bump eslint from 7.24.0 to 7.25.0 (password_policy#158)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/160">Bump @babel/core from 7.13.16 to 7.14.0 (password_policy#160)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/161">Bump stylelint from 13.12.0 to 13.13.0 (password_policy#161)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/162">Bump @babel/preset-env from 7.13.15 to 7.14.0 (password_policy#162)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/163">Bump webpack from 5.35.1 to 5.36.2 (password_policy#163)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/164">Bump sass from 1.32.11 to 1.32.12 (password_policy#164)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/167">Bump @babel/preset-env from 7.14.0 to 7.14.1 (password_policy#167)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/168">Bump @nextcloud/eslint-config from 5.0.0 to 5.1.0 (password_policy#168)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/169">Bump webpack-cli from 4.6.0 to 4.7.0 (password_policy#169)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/170">Bump stylelint from 13.13.0 to 13.13.1 (password_policy#170)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/171">Bump @babel/core from 7.14.0 to 7.14.2 (password_policy#171)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/172">Bump eslint-plugin-import from 2.22.1 to 2.23.0 (password_policy#172)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/174">Bump @babel/eslint-parser from 7.13.14 to 7.14.2 (password_policy#174)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/175">Bump webpack from 5.36.2 to 5.37.0 (password_policy#175)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/176">Bump @babel/preset-env from 7.14.1 to 7.14.2 (password_policy#176)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/177">Bump vue-loader from 15.9.6 to 15.9.7 (password_policy#177)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/178">Bump node-polyfill-webpack-plugin from 1.1.0 to 1.1.2 (password_policy#178)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/179">Bump sass from 1.32.12 to 1.32.13 (password_policy#179)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/180">Bump eslint from 7.25.0 to 7.26.0 (password_policy#180)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/181">Bump sass from 1.32.13 to 1.33.0 (password_policy#181)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/182">Bump @babel/eslint-parser from 7.14.2 to 7.14.3 (password_policy#182)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/183">Bump @babel/core from 7.14.2 to 7.14.3 (password_policy#183)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/184">Bump eslint-plugin-import from 2.23.0 to 2.23.3 (password_policy#184)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/185">Bump eslint from 7.26.0 to 7.27.0 (password_policy#185)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/186">Bump webpack from 5.37.0 to 5.37.1 (password_policy#186)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/187">Bump browserslist from 4.16.3 to 4.16.6 (password_policy#187)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/189">Bump @babel/preset-env from 7.14.2 to 7.14.4 (password_policy#189)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/191">Bump sass from 1.33.0 to 1.34.0 (password_policy#191)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/192">Bump @babel/eslint-parser from 7.14.3 to 7.14.4 (password_policy#192)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/193">Bump webpack from 5.37.1 to 5.38.1 (password_policy#193)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/194">Bump eslint-plugin-vue from 7.9.0 to 7.10.0 (password_policy#194)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/195">Bump eslint from 7.27.0 to 7.28.0 (password_policy#195)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/197">Bump eslint-plugin-import from 2.23.3 to 2.23.4 (password_policy#197)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/198">Bump sass from 1.34.0 to 1.34.1 (password_policy#198)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/200">Bump trim-newlines from 3.0.0 to 3.0.1 (password_policy#200)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/201">Bump eslint-plugin-vue from 7.10.0 to 7.11.0 (password_policy#201)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/203">Bump webpack-cli from 4.7.0 to 4.7.2 (password_policy#203)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/204">Bump @babel/eslint-parser from 7.14.4 to 7.14.5 (password_policy#204)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/205">Bump @babel/preset-env from 7.14.4 to 7.14.5 (password_policy#205)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/207">Bump webpack-merge from 5.7.3 to 5.8.0 (password_policy#207)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/208">Bump @babel/core from 7.14.3 to 7.14.5 (password_policy#208)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/209">Bump postcss from 7.0.35 to 7.0.36 (password_policy#209)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/210">Bump node and npm version in package.json (password_policy#210)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/213">Bump striptags from 3.1.1 to 3.2.0 (password_policy#213)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/214">Bump sass from 1.34.1 to 1.35.1 (password_policy#214)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/215">Bump eslint-plugin-vue from 7.11.0 to 7.11.1 (password_policy#215)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/216">Bump stylelint-webpack-plugin from 2.1.1 to 2.2.0 (password_policy#216)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/217">Bump @babel/core from 7.14.5 to 7.14.6 (password_policy#217)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/218">Bump webpack from 5.38.1 to 5.39.1 (password_policy#218)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/219">Bump eslint from 7.28.0 to 7.29.0 (password_policy#219)</a></li>
        <li><a href="https://github.com/nextcloud/password_policy/pull/221">Update stable22 target versions (password_policy#221)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/618">Bump @nextcloud/axios from 1.5.0 to 1.6.0 (photos#618)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/625">Bump webpack from 4.44.2 to 4.46.0 (photos#625)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/640">Bump core-js from 3.8.1 to 3.8.3 (photos#640)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/644">Bump vuex from 3.6.0 to 3.6.2 (photos#644)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/645">Bump vue-router from 3.4.9 to 3.5.1 (photos#645)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/646">Bump workbox-webpack-plugin from 6.0.2 to 6.1.0 (photos#646)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/647">Bump @nextcloud/vue from 3.3.1 to 3.5.4 (photos#647)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/650">Update version on master (photos#650)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/651">Bump phpunit/phpunit from 7.5.20 to 9.5.2 (photos#651)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/653">Bump @babel/core from 7.12.10 to 7.12.13 (photos#653)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/655">Bump eslint-webpack-plugin from 2.4.3 to 2.5.0 (photos#655)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/659">Bump psalm/phar from 4.3.1 to 4.5.1 (photos#659)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/660">Bump @babel/preset-env from 7.12.11 to 7.12.16 (photos#660)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/661">Bump eslint from 7.18.0 to 7.20.0 (photos#661)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/665">Bump psalm/phar from 4.5.1 to 4.6.1 (photos#665)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/666">Bump @babel/preset-env from 7.12.16 to 7.12.17 (photos#666)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/667">Bump eslint-webpack-plugin from 2.5.0 to 2.5.2 (photos#667)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/668">Bump eslint-plugin-vue from 7.5.0 to 7.6.0 (photos#668)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/669">Bump core-js from 3.8.3 to 3.9.0 (photos#669)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/670">Bump stylelint from 13.9.0 to 13.10.0 (photos#670)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/671">Bump stylelint-scss from 3.18.0 to 3.19.0 (photos#671)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/672">Bump eslint-plugin-promise from 4.2.1 to 4.3.1 (photos#672)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/673">Bump url-parse from 1.4.7 to 1.5.1 (photos#673)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/674">Bump babel-loader-exclude-node-modules-except from 1.0.3 to 1.1.2 (photos#674)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/675">Bump @vue/test-utils from 1.1.2 to 1.1.3 (photos#675)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/676">Bump vue-virtual-grid from 2.3.0 to 2.3.1 (photos#676)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/677">Bump stylelint from 13.10.0 to 13.11.0 (photos#677)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/678">Bump @babel/preset-env from 7.12.17 to 7.13.0 (photos#678)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/679">Bump @babel/core from 7.12.13 to 7.13.1 (photos#679)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/680">Bump workbox-webpack-plugin from 6.1.0 to 6.1.1 (photos#680)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/681">Bump @nextcloud/browserslist-config from 1.0.0 to 2.0.0 (photos#681)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/686">- fix Photos not shown in large browser windows #630 (photos#686)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/690">Fix docu #685 (photos#690)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/692">Bump @babel/preset-env from 7.13.0 to 7.13.8 (photos#692)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/693">Bump @babel/core from 7.13.1 to 7.13.8 (photos#693)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/696">Bump psalm/phar from 4.6.1 to 4.6.2 (photos#696)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/697">Bump core-js from 3.9.0 to 3.9.1 (photos#697)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/698">Bump eslint from 7.20.0 to 7.21.0 (photos#698)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/699">Bump @babel/preset-env from 7.13.8 to 7.13.9 (photos#699)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/700">Bump eslint-plugin-vue from 7.6.0 to 7.7.0 (photos#700)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/701">Bump @nextcloud/vue from 3.5.4 to 3.7.2 (photos#701)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/702">Bump @babel/core from 7.13.8 to 7.13.10 (photos#702)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/703">Bump @babel/preset-env from 7.13.9 to 7.13.10 (photos#703)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/704">Bump debounce from 1.2.0 to 1.2.1 (photos#704)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/705">Bump stylelint from 13.11.0 to 13.12.0 (photos#705)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/706">Bump eslint from 7.21.0 to 7.22.0 (photos#706)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/709">Add vue-virtual-grid to babel (photos#709)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/712">Bump phpunit/phpunit from 9.5.2 to 9.5.3 (photos#712)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/714">Bump qs from 6.9.6 to 6.10.0 (photos#714)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/716">Bump qs from 6.10.0 to 6.10.1 (photos#716)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/717">Bump @nextcloud/browserslist-config from 2.0.0 to 2.1.0 (photos#717)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/718">Bump @babel/preset-env from 7.13.10 to 7.13.12 (photos#718)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/719">Bump eslint-plugin-vue from 7.7.0 to 7.8.0 (photos#719)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/721">Bump phpunit/phpunit from 9.5.3 to 9.5.4 (photos#721)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/723">Bump @babel/core from 7.13.10 to 7.13.13 (photos#723)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/724">Bump eslint-webpack-plugin from 2.5.2 to 2.5.3 (photos#724)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/725">Bump eslint from 7.22.0 to 7.23.0 (photos#725)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/728">Bump y18n from 4.0.0 to 4.0.1 (photos#728)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/732">Bump @babel/core from 7.13.13 to 7.13.14 (photos#732)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/733">Bump @nextcloud/vue from 3.7.2 to 3.9.0 (photos#733)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/735">Bump @babel/core from 7.13.14 to 7.13.15 (photos#735)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/736">Bump eslint from 7.23.0 to 7.24.0 (photos#736)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/738">Bump @babel/preset-env from 7.13.12 to 7.13.15 (photos#738)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/740">Bump @nextcloud/dialogs from 3.1.1 to 3.1.2 (photos#740)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/742">Bump eslint-plugin-vue from 7.8.0 to 7.9.0 (photos#742)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/743">Bump @vue/test-utils from 1.1.3 to 1.1.4 (photos#743)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/745">Fixed typos (photos#745)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/749">Bump @babel/core from 7.13.15 to 7.13.16 (photos#749)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/750">Bump eslint from 7.24.0 to 7.25.0 (photos#750)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/751">Bump eslint-webpack-plugin from 2.5.3 to 2.5.4 (photos#751)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/753">Bump ssri from 6.0.1 to 6.0.2 (photos#753)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/756">Bump @babel/preset-env from 7.13.15 to 7.14.0 (photos#756)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/757">Bump stylelint from 13.12.0 to 13.13.0 (photos#757)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/758">Bump @babel/core from 7.13.16 to 7.14.0 (photos#758)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/760">Bump @vue/test-utils from 1.1.4 to 1.2.0 (photos#760)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/761">Bump stylelint from 13.13.0 to 13.13.1 (photos#761)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/762">Bump @babel/preset-env from 7.14.0 to 7.14.1 (photos#762)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/765">Bump hosted-git-info from 2.8.5 to 2.8.9 (photos#765)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/768">Bump vue-loader from 15.9.6 to 15.9.7 (photos#768)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/769">Bump eslint-plugin-import from 2.22.1 to 2.23.3 (photos#769)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/770">Bump @babel/core from 7.14.0 to 7.14.3 (photos#770)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/772">Bump @babel/preset-env from 7.14.1 to 7.14.2 (photos#772)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/773">Bump eslint from 7.25.0 to 7.27.0 (photos#773)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/774">Fix l10n (photos#774)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/775">Bump browserslist from 4.12.0 to 4.16.6 (photos#775)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/780">Bump eslint-config-standard from 16.0.2 to 16.0.3 (photos#780)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/781">Bump @babel/preset-env from 7.14.2 to 7.14.4 (photos#781)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/782">Bump @nextcloud/vue from 3.9.0 to 3.10.0 (photos#782)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/783">Fix sorting if one of the file name is only composed with number (photos#783)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/787">Bump eslint-plugin-vue from 7.9.0 to 7.10.0 (photos#787)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/789">Bump eslint-plugin-import from 2.23.3 to 2.23.4 (photos#789)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/790">Bump babel-loader-exclude-node-modules-except from 1.1.2 to 1.2.1 (photos#790)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/792">Bump eslint from 7.27.0 to 7.28.0 (photos#792)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/793">Bump phpunit/phpunit from 9.5.4 to 9.5.5 (photos#793)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/794">Bump @babel/core from 7.14.3 to 7.14.5 (photos#794)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/795">Bump eslint-plugin-vue from 7.10.0 to 7.11.0 (photos#795)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/798">Bump webpack-merge from 5.7.3 to 5.8.0 (photos#798)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/799">Bump @babel/preset-env from 7.14.4 to 7.14.5 (photos#799)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/801">Bump deps and use npm7 (photos#801)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/804">Support external storage (photos#804)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/814">Update stable22 target versions (photos#814)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/521">Bump eslint-plugin-import from 2.22.0 to 2.22.1 (privacy#521)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/522">Bump eslint-import-resolver-webpack from 0.12.2 to 0.13.0 (privacy#522)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/526">Bump @nextcloud/eslint-plugin from 1.4.0 to 1.5.0 (privacy#526)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/544">Bump babel-jest from 26.3.0 to 26.6.3 (privacy#544)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/564">Bump webpack-merge from 5.1.4 to 5.7.3 (privacy#564)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/565">Bump nextcloud/coding-standard from 0.3.0 to 0.5.0 (privacy#565)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/573">Update version on master (privacy#573)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/577">Bump @nextcloud/axios from 1.4.0 to 1.6.0 (privacy#577)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/593">Bump stylelint from 13.7.1 to 13.12.0 (privacy#593)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/594">Bump elliptic from 6.5.3 to 6.5.4 (privacy#594)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/599">Bump phpunit/phpunit from 8.5.8 to 8.5.15 (privacy#599)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/602">L10n: Remove space and dot at EOL. (privacy#602)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/603">Bump webpack-cli from 3.3.12 to 4.6.0 (privacy#603)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/605">Bump y18n from 4.0.0 to 4.0.1 (privacy#605)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/612">Bump ssri from 6.0.1 to 6.0.2 (privacy#612)</a></li>
        <li><a href="https://github.com/nextcloud/privacy/pull/613">Add node check (privacy#613)</a></li>
        ...
        <li><a href="https://github.com/nextcloud/privacy/pull/638">Bump node and npm version in package.json (privacy#638)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/371">Update version on master (recommendations#371)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/374">Bump stylelint-scss from 3.18.0 to 3.19.0 (recommendations#374)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/378">Bump eslint-plugin-promise from 4.2.1 to 4.3.1 (recommendations#378)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/381">Bump elliptic from 6.5.3 to 6.5.4 (recommendations#381)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/382">Bump y18n from 4.0.0 to 4.0.1 (recommendations#382)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/386">Bump @nextcloud/vue-dashboard from 1.0.1 to 1.1.0 (recommendations#386)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/390">Bump @nextcloud/dialogs from 3.1.1 to 3.1.2 (recommendations#390)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/392">Bump ssri from 6.0.1 to 6.0.2 (recommendations#392)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/394">Bump css-loader from 5.0.1 to 5.2.4 (recommendations#394)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/395">Bump @babel/preset-env from 7.12.11 to 7.14.0 (recommendations#395)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/396">Bump @babel/core from 7.12.10 to 7.14.0 (recommendations#396)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/397">Bump stylelint from 13.9.0 to 13.13.0 (recommendations#397)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/399">Bump hosted-git-info from 2.8.5 to 2.8.9 (recommendations#399)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/400">Bump browserslist from 4.16.1 to 4.16.6 (recommendations#400)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/401">Show file path on hover (recommendations#401)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/403">Bump @babel/preset-env from 7.14.0 to 7.14.4 (recommendations#403)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/404">Bump stylelint from 13.13.0 to 13.13.1 (recommendations#404)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/405">Bump @babel/core from 7.14.0 to 7.14.3 (recommendations#405)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/406">Bump webpack-cli from 4.4.0 to 4.7.0 (recommendations#406)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/407">Bump vue-loader from 15.9.6 to 15.9.7 (recommendations#407)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/409">Bump eslint-plugin-import from 2.22.1 to 2.23.4 (recommendations#409)</a></li>
        ...
        <li><a href="https://github.com/nextcloud/recommendations/pull/411">Bump postcss from 7.0.17 to 7.0.36 (recommendations#411)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/412">Bump node and npm version in package.json (recommendations#412)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/269">Allow API endpoint access with a predefined token (serverinfo#269)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/273">Update version on master (serverinfo#273)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/274">Match any non-whitespace character in filesystem type pattern (serverinfo#274)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/279">Fix OCI test pipeline (serverinfo#279)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/283">Fix Internal Server Error @ /settings/admin/serverinfo in 21.0.0 (serverinfo#283)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/288">Use strict typing (serverinfo#288)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/289">Flip default in checkAuthorized (serverinfo#289)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/294">Hide free space if it can't be calculated (serverinfo#294)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/297">Move counting storage statistics to the background (serverinfo#297)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/300">Catch RuntimeException (serverinfo#300)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/302">Set Null Speed and Duplex to 'unknown' (serverinfo#302)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/303">Hide squashfs and overlay-FS from the overview (serverinfo#303)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/307">Update chart.js (serverinfo#307)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/312">Add ratelimit to ServerInfo API endpoint (serverinfo#312)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/319">Fix Chart.js Syntax (serverinfo#319)</a></li>
        ...
        <li><a href="https://github.com/nextcloud/text/pull/1393">Bump cypress-image-snapshot from 4.0.0 to 4.0.1 (text#1393)</a></li>
        ...
        <li><a href="https://github.com/nextcloud/text/pull/1449">Improve design of idle/reconnect message (text#1449)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1487">Formatting design details (text#1487)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1488">Use write permission when possible (text#1488)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1490">Bump core-js from 3.8.1 to 3.9.1 (text#1490)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1491">Bump psalm/phar from 4.3.1 to 4.6.2 (text#1491)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1492">Bump christophwurst/nextcloud from 20.0.5 to 21.0.0 (text#1492)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1502">Disable cypress recording for now (text#1502)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1509">Bump elliptic from 6.5.3 to 6.5.4 (text#1509)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1510">Add note about rich workspace config to README (text#1510)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1515">Cypress stablization (text#1515)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1517">Bump @nextcloud/vue from 3.3.2 to 3.7.2 (text#1517)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1522">Bump vuex from 3.6.0 to 3.6.2 (text#1522)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1523">Bump acorn from 8.0.4 to 8.1.0 (text#1523)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1535">Bump psalm/phar from 4.6.2 to 4.7.0 (text#1535)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1537">Bump y18n from 4.0.0 to 4.0.1 (text#1537)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1538">Bump stylelint-scss from 3.18.0 to 3.19.0 (text#1538)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1552">Bump @nextcloud/vue from 3.7.2 to 3.9.0 (text#1552)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1553">Bump cypress from 6.3.0 to 7.1.0 (text#1553)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1554">Bump prosemirror-view from 1.16.5 to 1.18.3 (text#1554)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1555">Bump @vue/test-utils from 1.1.2 to 1.1.4 (text#1555)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1556">Bump webpack-cli from 4.3.1 to 4.6.0 (text#1556)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1559">Bump all minor dependency updates (text#1559)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1563">Bump @nextcloud/browserslist-config from 1.0.0 to 2.1.0 (text#1563)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1564">Bump eslint-plugin-promise from 4.2.1 to 4.3.1 (text#1564)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1570">Bump css-loader from 5.2.2 to 5.2.4 (text#1570)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1576">Bump ssri from 6.0.1 to 6.0.2 (text#1576)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1577">Bump psalm/phar from 4.7.0 to 4.7.1 (text#1577)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1578">Bump @babel/plugin-transform-modules-commonjs from 7.13.8 to 7.14.0 (text#1578)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1581">Bump @babel/core from 7.13.15 to 7.14.0 (text#1581)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1583">Bump stylelint from 13.12.0 to 13.13.1 (text#1583)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1584">Bump cypress from 7.1.0 to 7.2.0 (text#1584)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1585">Bump @vue/test-utils from 1.1.4 to 1.2.0 (text#1585)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1586">Bump lodash from 4.17.19 to 4.17.21 (text#1586)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1587">Bump core-js from 3.10.1 to 3.12.1 (text#1587)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1588">Bump acorn from 8.1.1 to 8.2.4 (text#1588)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1589">Bump hosted-git-info from 2.8.8 to 2.8.9 (text#1589)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1590">Only return workspace property for top node in a propfind request (text#1590)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1594">Bump cypress from 7.2.0 to 7.3.0 (text#1594)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1596">Bump @babel/core from 7.14.0 to 7.14.2 (text#1596)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1597">Bump @babel/preset-env from 7.13.15 to 7.14.2 (text#1597)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1598">Bump @babel/plugin-transform-runtime from 7.13.15 to 7.14.2 (text#1598)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1599">Bump eslint-plugin-import from 2.22.1 to 2.23.2 (text#1599)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1600">Bump vue-loader from 15.9.6 to 15.9.7 (text#1600)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1601">Bump prosemirror-model from 1.14.0 to 1.14.1 (text#1601)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1602">Bump node-sass from 5.0.0 to 6.0.0 (text#1602)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1603">Bump @babel/plugin-transform-classes from 7.13.0 to 7.14.2 (text#1603)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1605">Bump webpack-cli from 4.6.0 to 4.7.0 (text#1605)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1606">Bump prosemirror-view from 1.18.3 to 1.18.6 (text#1606)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1608">Revert "Bump node-sass from 5.0.0 to 6.0.0" (text#1608)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1613">Small changes to README (text#1613)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1615">Bump css-loader from 5.2.4 to 5.2.5 (text#1615)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1618">Bump cypress from 7.3.0 to 7.4.0 (text#1618)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1619">Bump css-loader from 5.2.5 to 5.2.6 (text#1619)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1620">Bump eslint-plugin-import from 2.23.2 to 2.23.3 (text#1620)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1621">Bump @babel/plugin-transform-runtime from 7.14.2 to 7.14.3 (text#1621)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1622">Bump @babel/core from 7.14.2 to 7.14.3 (text#1622)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1623">Bump browserslist from 4.14.0 to 4.16.6 (text#1623)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1625">Bump psalm/phar from 4.7.1 to 4.7.3 (text#1625)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1642">Bump ws from 6.2.1 to 6.2.2 (text#1642)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1645">ViewerComponent: pass on autofocus to EditorWrapper (text#1645)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1652">Bump @babel/preset-env from 7.14.2 to 7.14.5 (text#1652)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1653">Bump @babel/plugin-transform-classes from 7.14.2 to 7.14.5 (text#1653)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1657">Bump postcss from 7.0.32 to 7.0.36 (text#1657)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1658">Try enabling apcu on cli for cypress (text#1658)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1663">Bump node and npm version in package.json (text#1663)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1666">Bump node version on github actions (text#1666)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1669">Bump acorn from 8.2.4 to 8.4.0 (text#1669)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1671">Bump cypress from 7.4.0 to 7.5.0 (text#1671)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1672">Bump @vue/test-utils from 1.2.0 to 1.2.1 (text#1672)</a></li>
        ...
        <li><a href="https://github.com/nextcloud/updater/pull/340">Change stable14 tests to stable19 (updater#340)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/341">Change stable15 tests to stable20 (updater#341)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/342">Change stable16 tests to stable21 (updater#342)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/343">Update used version of box (updater#343)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/362">Do not allow to keep maintenance mode active in web updater (updater#362)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/732">Bump node-notifier from 8.0.0 to 8.0.1 (viewer#732)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/752">Bump phpunit/phpunit from 7.5.20 to 8.5.14 (viewer#752)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/753">Bump core-js from 3.8.1 to 3.8.3 (viewer#753)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/762">Bump @nextcloud/vue from 3.3.1 to 3.5.4 (viewer#762)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/767">Bump @babel/plugin-proposal-class-properties from 7.12.1 to 7.12.13 (viewer#767)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/771">Bump @babel/core from 7.12.10 to 7.12.16 (viewer#771)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/772">Bump eslint from 7.18.0 to 7.20.0 (viewer#772)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/774">Bump @babel/preset-env (viewer#774)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/775">Bump eslint-plugin-promise from 4.2.1 to 4.3.1 (viewer#775)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/777">Bump eslint-plugin-vue from 7.3.0 to 7.6.0 (viewer#777)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/778">Bump cypress from 6.3.0 to 6.5.0 (viewer#778)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/779">Bump stylelint-scss from 3.18.0 to 3.19.0 (viewer#779)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/780">Bump eslint-webpack-plugin from 2.4.3 to 2.5.1 (viewer#780)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/781">Bump babel-loader-exclude-node-modules-except from 1.0.3 to 1.1.2 (viewer#781)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/782">Bump stylelint from 13.9.0 to 13.10.0 (viewer#782)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/784">Bump core-js from 3.8.3 to 3.9.0 (viewer#784)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/785">Bump eslint-webpack-plugin from 2.5.1 to 2.5.2 (viewer#785)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/786">Bump @babel/preset-env from 7.12.16 to 7.12.17 (viewer#786)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/787">Bump @babel/core from 7.12.16 to 7.12.17 (viewer#787)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/788">Use @nextcloud/browserslist-config (viewer#788)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/789">Bump @babel/core from 7.12.17 to 7.13.1 (viewer#789)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/790">Bump @babel/plugin-proposal-class-properties from 7.12.13 to 7.13.0 (viewer#790)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/791">Bump @nextcloud/browserslist-config from 1.0.0 to 2.0.0 (viewer#791)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/792">Bump @babel/preset-env from 7.12.17 to 7.13.0 (viewer#792)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/793">Bump stylelint from 13.10.0 to 13.11.0 (viewer#793)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/795">Bump @babel/core from 7.13.1 to 7.13.8 (viewer#795)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/796">Bump @babel/preset-env from 7.13.0 to 7.13.8 (viewer#796)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/800">Bump cypress from 6.5.0 to 6.6.0 (viewer#800)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/801">Bump eslint-plugin-vue from 7.6.0 to 7.7.0 (viewer#801)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/802">Bump core-js from 3.9.0 to 3.9.1 (viewer#802)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/803">Bump eslint from 7.20.0 to 7.21.0 (viewer#803)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/804">Bump @babel/preset-env from 7.13.8 to 7.13.9 (viewer#804)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/805">Bump elliptic from 6.5.3 to 6.5.4 (viewer#805)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/806">Bump @nextcloud/vue from 3.5.4 to 3.7.2 (viewer#806)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/809">Bump debounce from 1.2.0 to 1.2.1 (viewer#809)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/810">Bump @babel/core from 7.13.8 to 7.13.10 (viewer#810)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/811">Bump @babel/preset-env from 7.13.9 to 7.13.10 (viewer#811)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/812">Bump stylelint from 13.11.0 to 13.12.0 (viewer#812)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/813">Bump eslint from 7.21.0 to 7.22.0 (viewer#813)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/814">Add download button (viewer#814)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/816">Bump phpunit/phpunit from 8.5.14 to 8.5.15 (viewer#816)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/817">Bump wait-on from 5.2.1 to 5.3.0 (viewer#817)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/818">Bump cypress from 6.6.0 to 6.8.0 (viewer#818)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/820">Bump @nextcloud/browserslist-config from 2.0.0 to 2.1.0 (viewer#820)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/821">Bump eslint-plugin-vue from 7.7.0 to 7.8.0 (viewer#821)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/822">Bump @babel/preset-env from 7.13.10 to 7.13.12 (viewer#822)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/823">Bump webdav from 3.6.1 to 4.2.1 (viewer#823)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/824">Bump @nextcloud/vue from 3.7.2 to 3.8.0 (viewer#824)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/825">Bump eslint-webpack-plugin from 2.5.2 to 2.5.3 (viewer#825)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/826">Bump @babel/core from 7.13.10 to 7.13.13 (viewer#826)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/827">Bump eslint from 7.22.0 to 7.23.0 (viewer#827)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/829">Migrate to webpack5 and use our own vue-plyr fork (viewer#829)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/830">Migrate to @nextcloud/babel-config (viewer#830)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/831">Fix php-setup action version (viewer#831)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/832">Bump y18n from 4.0.0 to 4.0.1 (viewer#832)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/835">Bump webdav from 4.2.1 to 4.3.0 (viewer#835)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/836">Bump webpack from 5.28.0 to 5.30.0 (viewer#836)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/837">Bump @babel/core from 7.13.13 to 7.13.14 (viewer#837)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/838">Bump @babel/eslint-parser from 7.13.10 to 7.13.14 (viewer#838)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/841">Fix fullscreen (viewer#841)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/845">Bump @nextcloud/paths and @nextcloud/router to 2.0.0 (viewer#845)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/847">Bump cypress from 6.8.0 to 7.0.0 (viewer#847)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/850">Bump @babel/preset-env from 7.13.12 to 7.13.15 (viewer#850)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/851">Bump @babel/core from 7.13.14 to 7.13.15 (viewer#851)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/852">Bump cypress from 7.0.0 to 7.0.1 (viewer#852)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/853">Bump eslint from 7.23.0 to 7.24.0 (viewer#853)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/855">Add 'image/webp' mime type support (viewer#855)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/856">Limit scope of the icon white overwrite (viewer#856)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/857">Bump webpack from 5.30.0 to 5.32.0 (viewer#857)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/861">Bump cypress from 7.0.1 to 7.1.0 (viewer#861)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/862">Bump @nextcloud/webpack-vue-config from 4.0.2 to 4.0.3 (viewer#862)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/863">Bump sass from 1.32.8 to 1.32.10 (viewer#863)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/865">Bump @nextcloud/dialogs from 3.1.1 to 3.1.2 (viewer#865)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/868">Fixes for naughty filenames (viewer#868)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/871">Delete image.webp (viewer#871)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/873">Bump eslint-webpack-plugin from 2.5.3 to 2.5.4 (viewer#873)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/875">Bump eslint from 7.24.0 to 7.25.0 (viewer#875)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/880">Clean: use eslint on oddname + use encodeFilePath (viewer#880)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/881">Bump @nextcloud/eslint-config from 5.0.0 to 5.1.0 (viewer#881)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/886">Bump cypress from 7.1.0 to 7.2.0 (viewer#886)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/887">Bump @babel/plugin-transform-modules-commonjs from 7.13.8 to 7.14.0 (viewer#887)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/889">Split of oddname test to improve performance (viewer#889)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/891">Bump lodash from 4.17.19 to 4.17.21 (viewer#891)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/892">Bump hosted-git-info from 2.8.5 to 2.8.9 (viewer#892)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/899">Use physical pixel size for preview resolution (viewer#899)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/901">Bump sass from 1.32.10 to 1.33.0 (viewer#901)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/902">Bump webpack from 5.32.0 to 5.37.1 (viewer#902)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/903">Bump @babel/core from 7.13.15 to 7.14.3 (viewer#903)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/904">Bump eslint-plugin-cypress from 2.11.2 to 2.11.3 (viewer#904)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/911">Bump browserslist from 4.16.1 to 4.16.6 (viewer#911)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/913">React to sidebar events from nextcloud-bus (viewer#913)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/920">Bump @babel/eslint-parser from 7.13.14 to 7.14.4 (viewer#920)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/921">Bump eslint-plugin-vue from 7.8.0 to 7.10.0 (viewer#921)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/922">Bump ws from 7.4.1 to 7.4.6 (viewer#922)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/927">Fix: fullscreen for Firefox (viewer#927)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/930">Bump babel-loader-exclude-node-modules-except from 1.1.2 to 1.2.1 (viewer#930)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/931">Bump cypress from 7.2.0 to 7.4.0 (viewer#931)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/932">Bump sass from 1.33.0 to 1.34.1 (viewer#932)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/933">Bump vue and vue-template-compiler (viewer#933)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/934">Bump webpack-cli from 4.6.0 to 4.7.0 (viewer#934)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/935">Bump node-polyfill-webpack-plugin from 1.1.0 to 1.1.2 (viewer#935)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/938">Bump eslint-plugin-import from 2.22.1 to 2.23.4 (viewer#938)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/940">Bump vue-loader from 15.9.6 to 15.9.7 (viewer#940)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/941">Bump eslint from 7.25.0 to 7.28.0 (viewer#941)</a></li>
        ...
        <li><a href="https://github.com/nextcloud/viewer/pull/955">Bump deps and use npm7 (viewer#955)</a></li>
</ul>
...
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.9.tar.bz2.md5">nextcloud-20.0.9.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.9.zip.md5">nextcloud-20.0.9.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.9.tar.bz2.sha256">nextcloud-20.0.9.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.9.zip.sha256">nextcloud-20.0.9.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.9.tar.bz2.sha512">nextcloud-20.0.9.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.9.zip.sha512">nextcloud-20.0.9.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.9.tar.bz2.asc">nextcloud-20.0.9.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.9.zip.asc">nextcloud-20.0.9.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/25740">Avoid creating two share links when password is enforced (server#25740)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25844">Fix detecting cyclic group memberships (server#25844)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25848">Bump the ca location (server#25848)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25858">Card::getOwner should return the actual value (server#25858)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25873">Fix namespacing (server#25873)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25876">Update psalm baseline (server#25876)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25878">Disable trasbin during the moveFromStorage fallback (server#25878)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25900">Do not die after LDAP auth failed with expired acc (server#25900)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25919">Clear multiselect after selection in share panel (server#25919)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25934">Activity: show if files are hidden or not (server#25934)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25938">Sharebymail: set expiration on creation (server#25938)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25944">Catch notfound and forbidden exception in smb::getmetadata (server#25944)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25956">Skip empty obsolete owner when adding to own NC (server#25956)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25963">Fix admin password strengthify tooltip (server#25963)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25994">Add missing waits and asserts in acceptance tests (server#25994)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26009">Bump elliptic from 6.5.3 to 6.5.4 (server#26009)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26027">Hide expiration date field for remote shares (server#26027)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26040">Remove trash items from other trash backends when deleting all (server#26040)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26052">Cache baseurl in url generator (server#26052)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26059">Only clear share password model when actually saved (server#26059)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26063">Add appconfig to always show the unique label of a sharee (server#26063)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26088">Limit constructing of result objects in file search (server#26088)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26091">Apply object store copy optimization when 'cross storage' copy is wit… (server#26091)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26123">Allow overwriting isAuthenticated (server#26123)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26125">Send share notification instead of erroring on duplicate share (server#26125)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26130">Log exceptions when creating share (server#26130)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26134">Do cachejail search filtering in sql (server#26134)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26147">Return the fileid from `copyFromCache` and use it instead of doing an extra query (server#26147)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26152">Dont allow creating users with __groupfolders as uid (server#26152)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26163">Use correct exception type hint in catch statement (server#26163)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26168">Remove explicit fclose from S3->writeStream (server#26168)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26176">Adds ldap user:reset command (server#26176)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26181">Add getID function to the simplefile implementation (server#26181)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26190">Fix valid storages removed when cleaning remote storages (server#26190)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26205">Update user share must use correct expiration validation (server#26205)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26209">Expand 'path is already shared' error message (server#26209)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26217">Add (hidden) option to always show smb root as writable (server#26217)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26239">L10n: Add words user and because in ShareByMailProvider.php (server#26239)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26250">Fix non LGC glyphs in avatars and txt file previews (server#26250)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26258">Handle limit offset and sorting in files search (server#26258)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26262">Update icewind/smb to 3.4.0 (server#26262)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26272">Catch invalid cache source storage path (server#26272)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26275">Fix casing of core test folder, bring back missing tests (server#26275)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26278">L10n: Separate ellipsis (server#26278)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26290">Show better error messages when a file with a forbidden path is encountered (server#26290)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26297">Fix l10n (server#26297)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26302">Log when a storage is marked as unavailable (server#26302)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26305">Delete old birthday calendar object when moving contact to another ad… (server#26305)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26356">Fix broken Calendar Event Invite email icons in Gmail by using PNGs instead of SVGs (server#26356)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26360">Bump y18n from 4.0.0 to 4.0.1 (server#26360)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26364">Update cipher defaults (server#26364)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26378">Fix(translation): replace static error message (server#26378)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26381">Gracefully handle deleteFromSelf when share is already gone (server#26381)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26399">Log and continue when failing to update encryption keys during for individual files (server#26399)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26405">Remove leftover debug @NoCSRFRequired introduced with #26198 (server#26405)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26449">[3rdparty]phpseclib-2.0.31 (server#26449)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26454">20.0.9 final (server#26454)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/644">Bump phpseclib/phpseclib from 2.0.25 to 2.0.31 (3rdparty#644)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/563">Fix 'Daily activity summary' email subject translation (activity#563)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/567">Fix notifying own activities (activity#567)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/571">Send the footer with the defined language (activity#571)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/339">Make sure we only load the public script on public pages (files_pdfviewer#339)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/504">Extend reasons for email address (firstrunwizard#504)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/912">Only send desktop notifications in one tab (notifications#912)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/711">Add vue-virtual-grid to babel (photos#711)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/281">Match any non-whitespace character in filesystem type pattern (serverinfo#281)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1410">Make sure the session list is always at the end (text#1410)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1506">Pin versions (text#1506)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1513">Use write permission when possible (text#1513)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/345">Update CLI tests to PHP 7.4 to 8.0 (updater#345)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/352">Disable UI when web updater is disabled in config.php (updater#352)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/354">Remove obsolete pipeline php72-master (updater#354)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/360">Update used version of box (updater#360)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/364">Do not allow to keep maintenance mode active in web updater (updater#364)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/843">Fix fullscreen (viewer#843)</a></li>
</ul>
...
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.5.tar.bz2.md5">nextcloud-20.0.5.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.5.zip.md5">nextcloud-20.0.5.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.5.tar.bz2.sha256">nextcloud-20.0.5.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.5.zip.sha256">nextcloud-20.0.5.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.5.tar.bz2.sha512">nextcloud-20.0.5.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.5.zip.sha512">nextcloud-20.0.5.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.5.tar.bz2.asc">nextcloud-20.0.5.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.5.zip.asc">nextcloud-20.0.5.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/24546">Don't log params of imagecreatefromstring (server#24546)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24590">Use storage copy implementation when doing dav copy (server#24590)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24592">Use in objectstore copy (server#24592)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24697">Add tel, note, org and title search (server#24697)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24698">Check php compatibility of app store app releases (server#24698)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24709">Fix #24682]: ensure federation cloud id is retruned if FN property not found (server#24709)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24714">Do not include non-required scripts on the upgrade page (server#24714)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24716">LDAP: fix inGroup for memberUid type of group memberships (server#24716)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24728">Cancel user search requests to avoid duplicate results being added (server#24728)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24751">Also unset the other possible unused paramters (server#24751)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24760">Enables the file name check also to match name of mountpoints (server#24760)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24763">Fixes sharing to group ids with characters that are being url encoded (server#24763)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24791">Limit getIncomplete query to one row (server#24791)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24792">Fix Argon2 descriptions (server#24792)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24798">Actually set the TTL on redis set (server#24798)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24806">Allow to force rename a conflicting calendar (server#24806)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24823">Fix IPv6 localhost regex (server#24823)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24826">Catch the error on heartbeat update (server#24826)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24853">Make oc_files_trash.auto_id a bigint (server#24853)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24854">Fix total upload size overwritten by next upload (server#24854)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24876">Avoid huge exception argument logging (server#24876)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24878">Make share results distinguishable if there are more than one with the exact same display name (server#24878)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24963">Add migration for oc_share_external columns (server#24963)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24972">Don't throw a 500 when importing a broken ics reminder file (server#24972)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24976">Fix unreliable ViewTest (server#24976)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24990">Update root.crl due to revocation of transmission.crt (server#24990)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24997">Set the JSCombiner cache if needed (server#24997)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25009">Fix column name to check prior to deleting (server#25009)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25013">Catch throwable instead of exception (server#25013)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25019">Set the user language when adding the footer (server#25019)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25030">Change defaultapp in config.sample.php to dashboard to improve docs and align it to source code (server#25030)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25035">Fix clearing the label of a share (server#25035)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25066">Update psalm-baseline.xml (server#25066)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25074">Don't remove assignable column for now (server#25074)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25076">Add setup check to verify that the used DB version is still supported… (server#25076)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/542">Correctly set the user for activity parsing when preparing a notifica… (activity#542)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/597">Bump vue-virtual-grid from 2.2.1 to 2.3.0 (photos#597)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1221">Catch possible database exceptions when fetching document data (text#1221)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1234">Make sure we have the proper PHP version installed before running composer (text#1234)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1235">Revert removal of transformResponse (text#1235)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1255">Bump prosemirror-view from 1.16.1 to 1.16.5 (text#1255)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1257">Bump @babel/preset-env from 7.12.1 to 7.12.11 (text#1257)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1259">Bump babel-loader from 8.1.0 to 8.2.2 (text#1259)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1261">Bump eslint-plugin-standard from 4.0.2 to 4.1.0 (text#1261)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1263">Bump vue-loader from 15.9.5 to 15.9.6 (text#1263)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1265">Bump prosemirror-model from 1.12.0 to 1.13.1 (text#1265)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1266">Bump core-js from 3.7.0 to 3.8.1 (text#1266)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1269">Bump stylelint from 13.7.2 to 13.8.0 (text#1269)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1271">Bump @babel/plugin-transform-runtime from 7.12.1 to 7.12.10 (text#1271)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1273">Bump sass-loader from 10.0.5 to 10.1.0 (text#1273)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1274">Bump webpack-merge from 5.3.0 to 5.7.2 (text#1274)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1277">Bump @babel/core from 7.12.3 to 7.12.10 (text#1277)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1278">Bump cypress from 5.1.0 to 5.6.0 (text#1278)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1279">Bump @vue/test-utils from 1.1.1 to 1.1.2 (text#1279)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1303">Bump webpack-merge from 5.7.2 to 5.7.3 (text#1303)</a></li>
</ul>
...
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.3.tar.bz2.md5">nextcloud-20.0.3.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.3.zip.md5">nextcloud-20.0.3.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.3.tar.bz2.sha256">nextcloud-20.0.3.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.3.zip.sha256">nextcloud-20.0.3.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.3.tar.bz2.sha512">nextcloud-20.0.3.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.3.zip.sha512">nextcloud-20.0.3.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.3.tar.bz2.asc">nextcloud-20.0.3.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.3.zip.asc">nextcloud-20.0.3.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/24181">Check quota of subdirectories when uploading to them (server#24181)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24196">CircleId too short in some request (server#24196)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24212">Missing level in ScopedPsrLogger (server#24212)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24228">Fix nextcloud logo in email notifications misalignment (server#24228)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24230">Allow selecting multiple columns with SELECT DISTINCT (server#24230)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24231">Use file name instead of path in 'not allowed to share' message (server#24231)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24232">Fix setting images through occ for theming (server#24232)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24239">Use regex when searching on single file shares (server#24239)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24249">Harden EncryptionLegacyCipher a bit (server#24249)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24258">Update ScanLegacyFormat.php (server#24258)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24259">Simple typo in comments (server#24259)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24263">Use correct year for generated birthdays events (server#24263)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24297">Delete files that exceed trashbin size immediately (server#24297)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24311">Update sabre/xml to fix XML parsing errors (server#24311)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24325">Only check path for being accessible when the storage is a object home (server#24325)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24333">Avoid empty null default with value that will be inserted anyways (server#24333)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24342">Fix contacts menu position and show uid as a tooltip (server#24342)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24346">Fix the config key on the sharing expire checkbox (server#24346)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24353">Set the display name of federated sharees from addressbook (server#24353)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24367">Catch storage not available in versions expire command (server#24367)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24377">Use proper bundles for files client and fileinfo (server#24377)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24387">Properly encode path when fetching inherited shares (server#24387)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24391">Formatting remote sharer should take protocol, path into account (server#24391)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24443">Make sure we add new line between vcf groups exports (server#24443)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24446">Fix public calendars shared to circles (server#24446)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24453">Store scss variables under a different prefix for each theming config version (server#24453)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24455">External storages: save group ids not display names in configuration (server#24455)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24462">Use correct l10n source in files_sharing JS code (server#24462)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24477">Set frame-ancestors to none if none are filled (server#24477)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24478">Move the password fiels of chaging passwords to post (server#24478)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24479">Move the global password for files external to post (server#24479)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24483">Only attempt to move to trash if a file is not in appdata (server#24483)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24491">Fix loading mtime of new file in conflict dialog in firefox (server#24491)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24502">Harden setup check for TLS version if host is not reachable (server#24502)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24509">Fix file size computation on 32bit platforms (server#24509)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24511">Allow subscription to indicate that a userlimit is reached (server#24511)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24513">Set mountid for personal external storage mounts (server#24513)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24517">Only execute plain mimetype check for directories and do the fallback… (server#24517)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24527">Fix vsprint parameter (server#24527)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24530">Replace abandoned log normalizer with our fork (server#24530)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24531">Add icon to user limit notification (server#24531)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24532">Also run repair steps when encryption is disabled but a legacy key is present (server#24532)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24534">[3rdparty][security] Archive TAR to 1.4.11 (server#24534)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24553">Generate a new session id if the decrypting the session data fails (server#24553)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24556">Revert "Do not read certificate bundle from data dir by default" (server#24556)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24557">Dont use system composer for autoload checker (server#24557)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24563">Remember me is not an app_password (server#24563)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24582">Do not load nonexisting setup.js (server#24582)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/529">Update sabre/xml to fix XML parsing errors (3rdparty#529)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/532">Use composer v1 on CI (3rdparty#532)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/536">Bump pear/archive_tar from 1.4.9 to 1.4.11 (3rdparty#536)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/543">Replace abandoned log normalizer with our fork (3rdparty#543)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/535">Allow nullable values as subject params (activity#535)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/803">Don't log when unknown array is null (notifications#803)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/550">Feat/virtual grid (photos#550)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/583">Make sure we have a string to localecompare to (photos#583)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/336">Always get recommendations for dashboard if enabled (recommendations#336)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/258">Properly fetch oracle database information (serverinfo#258)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1181">Also register to urlChanged event to update RichWorkspace (text#1181)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1214">Move away from GET (text#1214)</a></li>
</ul>

<h3 id="20-0-2">Version 20.0.2 <small>November 20 2020</small></h3>
<p>Download: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.2.tar.bz2">nextcloud-20.0.2.tar.bz2</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.2.zip">nextcloud-20.0.2.zip</a></br>
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.2.tar.bz2.md5">nextcloud-20.0.2.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.2.zip.md5">nextcloud-20.0.2.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.2.tar.bz2.sha256">nextcloud-20.0.2.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.2.zip.sha256">nextcloud-20.0.2.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.2.tar.bz2.sha512">nextcloud-20.0.2.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.2.zip.sha512">nextcloud-20.0.2.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.2.tar.bz2.asc">nextcloud-20.0.2.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-20.0.2.zip.asc">nextcloud-20.0.2.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/23419">Inidicate preview availability in share api responses (server#23419)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23563">CalDavBackend: check if timerange is array before accessing (server#23563)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23575">Some emojis are in CHAR_CATEGORY_GENERAL_OTHER_TYPES (server#23575)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23583">Also expire share type email (server#23583)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23611">Only use index of mount point when it is there (server#23611)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23633">Only retry fetching app store data once every 5 minutes in case it fails (server#23633)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23636">Bring back the restore share button (server#23636)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23641">Fix updates of NULL appconfig values (server#23641)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23646">Fix sharing input placeholder for emails (server#23646)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23690">Use bigint for fileid in filecache_extended (server#23690)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23699">Enable theming background transparency (server#23699)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23702">Fix sharer flag on ldap:show-remnants when user owned more than a single share (server#23702)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23710">Make sure the function signatures of the backgroundjob match (server#23710)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23713">Check if array elements exist before using them (server#23713)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23726">Fix default quota display value in user row (server#23726)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23727">Use lib instead if core as l10n module in OC_Files (server#23727)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23732">Specify accept argument to avatar upload input field (server#23732)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23733">Save email as lower case (server#23733)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23736">Reset avatar cropper before showing (server#23736)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23745">Also run the SabreAuthInitEvent for the main server (server#23745)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23749">Type the \OCP\IUserManager::callForAllUsers closure with Psalm (server#23749)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23751">Type the \OCP\AppFramework\Services\IInitialState::provideLazyInitial… (server#23751)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23753">Don't overwrite the event if we use it later (server#23753)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23759">Inform the user when flow config data exceeds thresholds (server#23759)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23763">Type the \OCP\IUserManager::callForSeenUsers closure with Psalm (server#23763)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23774">Catch errors when closing file conflict dialog (server#23774)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23779">Document the backend registered events of LDAP (server#23779)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23787">Fetch the logger and system config once for all query builder instances (server#23787)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23789">Type the event dispatcher listener callables with Psalm (server#23789)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23794">Only run phpunit when "php" changed (server#23794)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23829">Remove bold font-weight and lower font-size for empty search box (server#23829)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23846">No need to check if there is an avatar available, because it is gener… (server#23846)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23850">Ensure filepicker list is empty before populating (server#23850)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23858">UserStatus: clear status message if message is null (server#23858)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23874">Fix grid view toggle in tags view (server#23874)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23884">Restrict query when searching for versions of trashbin files (server#23884)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23894">Fix potentially passing null to events where IUser is expected (server#23894)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23899">Make user status styles scoped (server#23899)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23900">Move help to separate stylesheet (server#23900)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23902">Add default font size (server#23902)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23917">Do not emit UserCreatedEvent twice (server#23917)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23924">Bearer must be in the start of the auth header (server#23924)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23935">Fix casting of integer and boolean on Oracle (server#23935)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23948">Skip already loaded apps in loadApps (server#23948)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23950">Fix repair mimetype step to not leave stray cursors (server#23950)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23951">Improve query type detection (server#23951)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23954">Fix iLike() falsely turning escaped % and _ into wildcards (server#23954)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23955">Replace some usages of OC_DB in OC\Share\* with query builder (server#23955)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23971">Use query builder instead of OC_DB in trashbin (server#23971)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23975">Fix greatest/least order for oracle (server#23975)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23992">Fix link share label placeholder not showing (server#23992)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23995">Unlock when promoting to exclusive lock fails (server#23995)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23996">Make sure root storage is valid before checking its size (server#23996)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23998">Use query builder instead of OC_DB in OC\Files\* (server#23998)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24001">Shortcut to avoid file system setup when generating the logo URL (server#24001)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24004">Remove old legacy scripts references (server#24004)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24012">Fix js search in undefined ocs response (server#24012)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24033">Don't leave cursors open (server#24033)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24044">Fix sharing tab state not matching resharing admin settings (server#24044)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24049">Run unit tests against oracle (server#24049)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24050">Use png icons in caldav reminder emails (server#24050)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24058">Manually iterate over calendardata when oracle is used (server#24058)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24079">Make is_user_defined nullable so we can store false on oracle (server#24079)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24081">Fix default internal expiration date enforce (server#24081)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24106">Register new command db:add-missing-primary-keys (server#24106)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24114">Convert the card resource to a string if necessary (server#24114)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24147">Don't throw on SHOW VERSION query (server#24147)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24153">Bump dompurify to 2.2.2 (server#24153)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24156">Set up FS before querying storage info in settings (server#24156)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24159">Fix default internal expiration date (server#24159)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24178">CircleId too short in some request (server#24178)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24183">Revert "circleId too short in some request" (server#24183)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24212">Missing level in ScopedPsrLogger (server#24212)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/523">Fix activity spinner on empty activity (activity#523)</a></li>
        <li><a href="https://github.com/nextcloud/activity/pull/528">Add OCI github action (activity#528)</a></li>
        <li><a href="https://github.com/nextcloud/files_pdfviewer/pull/257">Disable download button by default (files_pdfviewer#257)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/442">Feat/dependabot ga/stable20 (firstrunwizard#442)</a></li>
        <li><a href="https://github.com/nextcloud/notifications/pull/796">Fix loading notifications without a message on oracle (notifications#796)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1105">Do not setup appdata in constructor to avoid errors causing the whole instance to stop working (text#1105)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1125">Bump eslint-plugin-standard from 4.0.1 to 4.0.2 (text#1125)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1134">Bump sass-loader from 10.0.1 to 10.0.5 (text#1134)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1140">Bump webpack from 4.44.1 to 4.44.2 (text#1140)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1164">Bump dependencies to version in range (text#1164)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1166">Validate link on click (text#1166)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1177">Add migration to fix oracle issues with the database schema (text#1177)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1179">Bump cypress from 4.12.1 to 5.1.0 (text#1179)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/681">Fix URL escaping of shared files (viewer#681)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/684">Fix component click outside and cleanup structure (viewer#684)</a></li>
</ul>
...
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.10.tar.bz2.md5">nextcloud-19.0.10.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.10.zip.md5">nextcloud-19.0.10.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.10.tar.bz2.sha256">nextcloud-19.0.10.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.10.zip.sha256">nextcloud-19.0.10.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.10.tar.bz2.sha512">nextcloud-19.0.10.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.10.zip.sha512">nextcloud-19.0.10.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.10.tar.bz2.asc">nextcloud-19.0.10.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.10.zip.asc">nextcloud-19.0.10.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/25351">Show the actual error on share requests (server#25351)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25741">Avoid creating two share links when password is enforced (server#25741)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25845">Fix detecting cyclic group memberships (server#25845)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25849">Bump the ca location (server#25849)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25859">Card::getOwner should return the actual value (server#25859)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25901">Do not die after LDAP auth failed with expired acc (server#25901)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25957">Skip empty obsolete owner when adding to own NC (server#25957)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/25964">Fix admin password strengthify tooltip (server#25964)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26010">Bump elliptic from 6.5.3 to 6.5.4 (server#26010)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26028">Hide expiration date field for remote shares (server#26028)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26041">Remove trash items from other trash backends when deleting all (server#26041)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26060">Only clear share password model when actually saved (server#26060)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26073">Limit constructing of result objects in file search (server#26073)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26092">Apply object store copy optimization when 'cross storage' copy is wit… (server#26092)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26095">Bump yargs-parser from 5.0.0 to 5.0.1 (server#26095)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26129">Log exceptions when creating share (server#26129)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26135">Do cachejail search filtering in sql (server#26135)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26148">Return the fileid from `copyFromCache` and use it instead of doing an extra query (server#26148)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26164">Use correct exception type hint in catch statement (server#26164)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26169">Remove explicit fclose from S3->writeStream (server#26169)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26191">Fix valid storages removed when cleaning remote storages (server#26191)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26206">Update user share must use correct expiration validation (server#26206)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26216">Add (hidden) option to always show smb root as writable (server#26216)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26240">L10n: Add words user and because in ShareByMailProvider.php (server#26240)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26264">Handle limit offset and sorting in files search (server#26264)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26273">Catch invalid cache source storage path (server#26273)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26277">L10n: Separate ellipsis (server#26277)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26296">Fix l10n (server#26296)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26306">Delete old birthday calendar object when moving contact to another ad… (server#26306)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26359">Bump y18n from 3.2.1 to 3.2.2 (server#26359)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26365">Update cipher defaults (server#26365)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26380">Gracefully handle deleteFromSelf when share is already gone (server#26380)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26450">[3rdparty]phpseclib-2.0.31 (server#26450)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/26455">19.0.10 final (server#26455)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/646">Bump phpseclib/phpseclib from 2.0.25 to 2.0.31 (3rdparty#646)</a></li>
        <li><a href="https://github.com/nextcloud/serverinfo/pull/282">Match any non-whitespace character in filesystem type pattern (serverinfo#282)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1392">Remove EPUB mimetype (text#1392)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1411">Make sure the session list is always at the end (text#1411)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1435">Bump @babel/plugin-transform-modules-commonjs from 7.12.1 to 7.12.13 (text#1435)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1437">Bump @babel/plugin-proposal-class-properties from 7.12.1 to 7.12.13 (text#1437)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1465">Bump @babel/plugin-transform-runtime from 7.12.10 to 7.12.17 (text#1465)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1467">Bump @babel/preset-env from 7.12.11 to 7.12.17 (text#1467)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1469">Bump @babel/core from 7.12.10 to 7.12.17 (text#1469)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1514">Use write permission when possible (text#1514)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/344">Update CLI tests to PHP 7.4 to 8.0 (updater#344)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/350">Disable UI when web updater is disabled in config.php (updater#350)</a></li>
        <li><a href="https://github.com/nextcloud/updater/pull/353">Remove obsolete pipeline php72-master (updater#353)</a></li>
</ul>
...
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.7.tar.bz2.md5">nextcloud-19.0.7.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.7.zip.md5">nextcloud-19.0.7.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.7.tar.bz2.sha256">nextcloud-19.0.7.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.7.zip.sha256">nextcloud-19.0.7.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.7.tar.bz2.sha512">nextcloud-19.0.7.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.7.zip.sha512">nextcloud-19.0.7.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.7.tar.bz2.asc">nextcloud-19.0.7.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.7.zip.asc">nextcloud-19.0.7.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/24591">Use storage copy implementation when doing dav copy (server#24591)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24593">Use in objectstore copy (server#24593)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24762">Fixes sharing to group ids with characters that are being url encoded (server#24762)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24795">Fix Argon2 descriptions (server#24795)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24799">Actually set the TTL on redis set (server#24799)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24855">Fix total upload size overwritten by next upload (server#24855)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24875">Avoid huge exception argument logging (server#24875)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24880">Make share results distinguishable if there are more than one with the exact same display name (server#24880)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24901">Bump pear/archive_tar from 1.4.9 to 1.4.11 (server#24901)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24962">Fix #24682]: ensure federation cloud id is retruned if FN property not found (server#24962)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24973">Don't throw a 500 when importing a broken ics reminder file (server#24973)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24991">Update root.crl due to revocation of transmission.crt (server#24991)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/533">Bump pear/archive_tar from 1.4.9 to 1.4.11 (3rdparty#533)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1222">Catch possible database exceptions when fetching document data (text#1222)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1256">Bump prosemirror-view from 1.16.1 to 1.16.5 (text#1256)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1258">Bump @vue/test-utils from 1.1.1 to 1.1.2 (text#1258)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1260">Bump eslint-plugin-standard from 4.0.2 to 4.1.0 (text#1260)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1262">Bump @babel/preset-env from 7.12.1 to 7.12.11 (text#1262)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1264">Bump @babel/plugin-transform-runtime from 7.12.1 to 7.12.10 (text#1264)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1267">Bump babel-loader from 8.1.0 to 8.2.2 (text#1267)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1268">Bump prosemirror-model from 1.12.0 to 1.13.1 (text#1268)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1270">Bump vue-loader from 15.9.5 to 15.9.6 (text#1270)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1272">Bump stylelint from 13.7.2 to 13.8.0 (text#1272)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1275">Bump @babel/core from 7.12.3 to 7.12.10 (text#1275)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1276">Bump core-js from 3.7.0 to 3.8.1 (text#1276)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1290">Fix cypress tests (text#1290)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1294">Fix: use OC.Files API to get file info (text#1294)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1295">Fix link menu positioning (text#1295)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1302">Bump cypress from 5.1.0 to 5.6.0 (text#1302)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1326">Bump webpack from 4.44.2 to 4.45.0 (text#1326)</a></li>
</ul>


<h3 id="19-0-6">Version 19.0.6 <small>December 10 2020</small></h3>
<p>Download: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.6.tar.bz2">nextcloud-19.0.6.tar.bz2</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.6.zip">nextcloud-19.0.6.zip</a></br>
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.6.tar.bz2.md5">nextcloud-19.0.6.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.6.zip.md5">nextcloud-19.0.6.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.6.tar.bz2.sha256">nextcloud-19.0.6.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.6.zip.sha256">nextcloud-19.0.6.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.6.tar.bz2.sha512">nextcloud-19.0.6.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.6.zip.sha512">nextcloud-19.0.6.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.6.tar.bz2.asc">nextcloud-19.0.6.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.6.zip.asc">nextcloud-19.0.6.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/24182">Check quota of subdirectories when uploading to them (server#24182)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24195">CircleId too short in some request (server#24195)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24233">Fix setting images through occ for theming (server#24233)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24260">Simple typo in comments (server#24260)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24262">Use correct year for generated birthdays events (server#24262)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24296">Delete files that exceed trashbin size immediately (server#24296)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24306">Update sabre/xml to fix XML parsing errors (server#24306)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24327">Only check path for being accessible when the storage is a object home (server#24327)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24334">Avoid empty null default with value that will be inserted anyways (server#24334)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24343">Fix contacts menu position and show uid as a tooltip (server#24343)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24347">Fix the config key on the sharing expire checkbox (server#24347)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24354">Set the display name of federated sharees from addressbook (server#24354)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24368">Catch storage not available in versions expire command (server#24368)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24370">Avoid substr() error when strpos returns false (server#24370)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24386">Properly encode path when fetching inherited shares (server#24386)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24392">Formatting remote sharer should take protocol, path into account (server#24392)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24444">Make sure we add new line between vcf groups exports (server#24444)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24447">Fix public calendars shared to circles (server#24447)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24452">Store scss variables under a different prefix for each theming config version (server#24452)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24457">External storages: save group ids not display names in configuration (server#24457)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24463">Use correct l10n source in files_sharing JS code (server#24463)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24480">Update ScanLegacyFormat.php (server#24480)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24484">Only attempt to move to trash if a file is not in appdata (server#24484)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24492">Fix loading mtime of new file in conflict dialog in firefox (server#24492)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24503">Harden setup check for TLS version if host is not reachable (server#24503)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24508">Fix file size computation on 32bit platforms (server#24508)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24514">Set mountid for personal external storage mounts (server#24514)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24518">Only execute plain mimetype check for directories and do the fallback… (server#24518)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24528">Fix vsprint parameter (server#24528)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24554">Generate a new session id if the decrypting the session data fails (server#24554)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24561">Stable20] dont use system composer for autoload checker (server#24561)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24564">Remember me is not an app_password (server#24564)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24583">Do not load nonexisting setup.js (server#24583)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/530">Update sabre/xml to fix XML parsing errors (3rdparty#530)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/531">Use composer v1 on CI (3rdparty#531)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/584">Make sure we have a string to localecompare to (photos#584)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1182">Also register to urlChanged event to update RichWorkspace (text#1182)</a></li>
</ul>


<h3 id="19-0-5">Version 19.0.5 <small>November 20 2020</small></h3>
<p>Download: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.5.tar.bz2">nextcloud-19.0.5.tar.bz2</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.5.zip">nextcloud-19.0.5.zip</a></br>
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.5.tar.bz2.md5">nextcloud-19.0.5.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.5.zip.md5">nextcloud-19.0.5.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.5.tar.bz2.sha256">nextcloud-19.0.5.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.5.zip.sha256">nextcloud-19.0.5.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.5.tar.bz2.sha512">nextcloud-19.0.5.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.5.zip.sha512">nextcloud-19.0.5.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.5.tar.bz2.asc">nextcloud-19.0.5.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-19.0.5.zip.asc">nextcloud-19.0.5.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/23168">Add mount point to quota warning message (server#23168)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23202">Fix the user email issue while creating a user (server#23202)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23212">Also check the path based mimetype for flow rule checks (server#23212)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23214">Allow configuring the activity update interval of token (server#23214)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23233">Allow using saved login credentials for notify (server#23233)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23282">Fix the user remove from group in UI (server#23282)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23376">Add template typing to the QBMapper (server#23376)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23385">Fix adminpass strengthify margin (server#23385)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23404">VersioningTest.php:729 is unreliable and should be disabled (server#23404)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23421">Encode requesttoken for logout url in auto logout (server#23421)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23424">Fix undefined index and consequential damages in versions code (server#23424)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23439">Add option to disable notify self check (server#23439)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23499">SharedMountTest.php:367 is unreliable (server#23499)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23504">Provide log statements for SCSS cache (server#23504)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23511">SCSSCacher - Lock should not be removed (server#23511)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23515">Clear cached app config while waiting for the SCSSCache lock to return (server#23515)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23556">Update CA bundle to october version (server#23556)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23564">CalDavBackend: check if timerange is array before accessing (server#23564)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23571">LDAP: when nesting is not enabled, the group filter can be applied right away (server#23571)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23585">Also expire share type email (server#23585)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23623">Disable unreliable app-files.feature:108 (server#23623)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23624">Disable unreliable app-files-sharing.feature:338 (server#23624)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23634">Only retry fetching app store data once every 5 minutes in case it fails (server#23634)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23637">Bring back the restore share button (server#23637)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23642">Fix updates of NULL appconfig values (server#23642)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23647">Fix sharing input placeholder for emails (server#23647)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23676">Log the route not found exception on a lower level (server#23676)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23691">Use bigint for fileid in filecache_extended (server#23691)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23705">Enable theming background transparency (server#23705)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23708">Fix sharer flag on ldap:show-remnants when user owned more than a single share (server#23708)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23714">Check if array elements exist before using them (server#23714)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23728">Use lib instead if core as l10n module in OC_Files (server#23728)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23734">Save email as lower case (server#23734)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23755">Harden SSE key generation (server#23755)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23760">Inform the user when flow config data exceeds thresholds (server#23760)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23777">Add occ command to set theming values (server#23777)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23795">Only run phpunit when "php" changed (server#23795)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23806">Bump lodash from 4.17.15 to 4.17.20 (server#23806)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23847">No need to check if there is an avatar available, because it is gener… (server#23847)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23860">Inidicate preview availability in share api responses (server#23860)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23875">Fix grid view toggle in tags view (server#23875)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23885">Restrict query when searching for versions of trashbin files (server#23885)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23895">Fix potentially passing null to events where IUser is expected (server#23895)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23925">Bearer must be in the start of the auth header (server#23925)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23931">Do not emit UserCreatedEvent twice (server#23931)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23952">Improve query type detection (server#23952)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23997">Make sure root storage is valid before checking its size (server#23997)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24005">Remove old legacy scripts references (server#24005)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24013">Fix js search in undefined ocs response (server#24013)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24045">Fix sharing tab state not matching resharing admin settings (server#24045)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24048">Fix iLike() falsely turning escaped % and _ into wildcards (server#24048)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24052">Use png icons in caldav reminder emails (server#24052)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24057">Fix php-cs-fixer on stable19 by updating to a new minor version (server#24057)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24076">Unlock when promoting to exclusive lock fails (server#24076)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24080">Fix default internal expiration date enforce (server#24080)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24111">Fix password visibility toggles (server#24111)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24115">Convert the card resource to a string if necessary (server#24115)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24148">Don't throw on SHOW VERSION query (server#24148)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24155">Bump dompurify to 2.2.2 (server#24155)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24160">Fix default internal expiration date (server#24160)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24177">CircleId too short in some request (server#24177)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24184">Revert "circleId too short in some request" (server#24184)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/441">Feat/dependabot ga/stable19 (firstrunwizard#441)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/511">Pass preview availability too (photos#511)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1106">Do not setup appdata in constructor to avoid errors causing the whole instance to stop working (text#1106)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1163">Bump dependencies to version in range (text#1163)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1167">Validate link before opening (text#1167)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/671">Fix player controls on Firefox (viewer#671)</a></li>
        <li><a href="https://github.com/nextcloud/viewer/pull/682">Fix URL escaping of shared files (viewer#682)</a></li>
</ul>
...
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.13.tar.bz2.md5">nextcloud-18.0.13.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.13.zip.md5">nextcloud-18.0.13.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.13.tar.bz2.sha256">nextcloud-18.0.13.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.13.zip.sha256">nextcloud-18.0.13.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.13.tar.bz2.sha512">nextcloud-18.0.13.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.13.zip.sha512">nextcloud-18.0.13.zip.sha512</a></br>
...
<ul>
        ...
        <li><a href="https://github.com/nextcloud/server/pull/24800">Actually set the TTL on redis set (server#24800)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24857">Fix total upload size overwritten by next upload (server#24857)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24881">Make share results distinguishable if there are more than one with the exact same display name (server#24881)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24902">Bump pear/archive_tar from 1.4.8 to 1.4.11 (server#24902)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24974">Don't throw a 500 when importing a broken ics reminder file (server#24974)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24992">Update root.crl due to revocation of transmission.crt (server#24992)</a></li>
        <li><a href="https://github.com/nextcloud/3rdparty/pull/534">Bump pear/archive_tar from 1.4.8 to 1.4.11 (3rdparty#534)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1194">Bump stylelint from 13.7.2 to 13.8.0 (text#1194)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1209">Bump babel-loader from 8.2.1 to 8.2.2 (text#1209)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1226">Bump @babel/plugin-transform-runtime from 7.12.1 to 7.12.10 (text#1226)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1227">Bump core-js from 3.7.0 to 3.8.1 (text#1227)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1228">Bump prosemirror-view from 1.16.1 to 1.16.5 (text#1228)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1229">Bump @babel/core from 7.12.3 to 7.12.10 (text#1229)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1237">Bump vue-loader from 15.9.5 to 15.9.6 (text#1237)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1238">Bump @babel/preset-env from 7.12.1 to 7.12.11 (text#1238)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1240">Bump @vue/test-utils from 1.1.1 to 1.1.2 (text#1240)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1284">Bump prosemirror-model from 1.12.0 to 1.13.1 (text#1284)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1291">Fix cypress (text#1291)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1292">Handle 403 errors the same as not found (text#1292)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1293">Fix: use OC.Files API to get file info (text#1293)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1301">Bump cypress from 5.1.0 to 5.6.0 (text#1301)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1325">Bump webpack from 4.44.2 to 4.45.0 (text#1325)</a></li>
</ul>

<h3 id="18-0-12">Version 18.0.12 <small>December 10 2020</small></h3>
<p>Download: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.12.tar.bz2">nextcloud-18.0.12.tar.bz2</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.12.zip">nextcloud-18.0.12.zip</a></br>
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.12.tar.bz2.md5">nextcloud-18.0.12.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.12.zip.md5">nextcloud-18.0.12.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.12.tar.bz2.sha256">nextcloud-18.0.12.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.12.zip.sha256">nextcloud-18.0.12.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.12.tar.bz2.sha512">nextcloud-18.0.12.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.12.zip.sha512">nextcloud-18.0.12.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.12.tar.bz2.asc">nextcloud-18.0.12.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.12.zip.asc">nextcloud-18.0.12.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/24152">CircleId too short in some request (server#24152)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24261">Simple typo in comments (server#24261)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24332">Fix contacts menu position in sharing sidebar (server#24332)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24335">Avoid empty null default with value that will be inserted anyways (server#24335)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24344">Only check path for being accessible when the storage is a object home (server#24344)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24369">Catch storage not available in versions expire command (server#24369)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24371">Avoid substr() error when strpos returns false (server#24371)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24388">Properly encode path when fetching inherited shares (server#24388)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24437">Respect default share permissions (server#24437)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24445">Make sure we add new line between vcf groups exports (server#24445)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24458">External storages: save group ids not display names in configuration (server#24458)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24465">Use correct l10n source in files_sharing JS code (server#24465)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24481">Fix the config key on the sharing expire checkbox (server#24481)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24485">Only attempt to move to trash if a file is not in appdata (server#24485)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24504">Harden setup check for TLS version if host is not reachable (server#24504)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24555">Generate a new session id if the decrypting the session data fails (server#24555)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24562">Stable20] dont use system composer for autoload checker (server#24562)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24565">Remember me is not an app_password (server#24565)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/585">Make sure we have a string to localecompare to (photos#585)</a></li>
</ul>

<h3 id="18-0-11">Version 18.0.11 <small>November 20 2020</small></h3>
<p>Download: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.11.tar.bz2">nextcloud-18.0.11.tar.bz2</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.11.zip">nextcloud-18.0.11.zip</a></br>
Check the file integrity with:</br>
MD5: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.11.tar.bz2.md5">nextcloud-18.0.11.tar.bz2.md5</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.11.zip.md5">nextcloud-18.0.11.zip.md5</a></br>
SHA256: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.11.tar.bz2.sha256">nextcloud-18.0.11.tar.bz2.sha256</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.11.zip.sha256">nextcloud-18.0.11.zip.sha256</a></br>
SHA512: <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.11.tar.bz2.sha512">nextcloud-18.0.11.tar.bz2.sha512</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.11.zip.sha512">nextcloud-18.0.11.zip.sha512</a></br>
PGP (<a href="https://nextcloud.com/nextcloud.asc">Key</a>): <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.11.tar.bz2.asc">nextcloud-18.0.11.tar.bz2.asc</a> or <a href="https://download.nextcloud.com/server/releases/nextcloud-18.0.11.zip.asc">nextcloud-18.0.11.zip.asc</a></p>

<h4>Changes</h4>
<ul>
        <li><a href="https://github.com/nextcloud/server/pull/23204">Fix the user email issue while creating a user (server#23204)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23386">Fix adminpass strengthify margin (server#23386)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23393">Fix the user remove from group in UI (server#23393)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23405">VersioningTest.php:729 is unreliable and should be disabled (server#23405)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23423">Contactsmanager shall limit number of results early (server#23423)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23437">Use paginated search for contacts + fixes (server#23437)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23500">SharedMountTest.php:367 is unreliable (server#23500)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23506">Provide log statements for SCSS cache (server#23506)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23512">SCSSCacher - Lock should not be removed (server#23512)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23516">Clear cached app config while waiting for the SCSSCache lock to return (server#23516)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23549">Fix display of remote users in incoming share notifications (server#23549)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23557">Update CA bundle to october version (server#23557)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23565">CalDavBackend: check if timerange is array before accessing (server#23565)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23567">Dont hold a transaction during the move to trash (server#23567)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23584">Also expire share type email (server#23584)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23625">Disable unreliable app-files.feature:108 (server#23625)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23626">Disable unreliable app-files-sharing.feature:108 (server#23626)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23635">Only retry fetching app store data once every 5 minutes in case it fails (server#23635)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23638">Bring back the restore share button (server#23638)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23643">Fix updates of NULL appconfig values (server#23643)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23648">Fix sharing input placeholder for emails (server#23648)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23692">Use bigint for fileid in filecache_extended (server#23692)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23706">Enable theming background transparency (server#23706)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23709">Fix sharer flag on ldap:show-remnants when user owned more than a single share (server#23709)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23715">Check if array elements exist before using them (server#23715)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23729">Use lib instead if core as l10n module in OC_Files (server#23729)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23735">Save email as lower case (server#23735)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23756">Harden SSE key generation (server#23756)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23761">Inform the user when flow config data exceeds thresholds (server#23761)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23796">Only run phpunit when "php" changed (server#23796)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23803">Bump lodash from 4.17.15 to 4.17.20 (server#23803)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23848">No need to check if there is an avatar available, because it is gener… (server#23848)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23861">Inidicate preview availability in share api responses (server#23861)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23876">Fix grid view toggle in tags view (server#23876)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23886">Restrict query when searching for versions of trashbin files (server#23886)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23896">Fix potentially passing null to events where IUser is expected (server#23896)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23926">Bearer must be in the start of the auth header (server#23926)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/23953">Improve query type detection (server#23953)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24006">Remove old legacy scripts references (server#24006)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24020">Fix js search in undefined ocs response (server#24020)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24046">Fix sharing tab state not matching resharing admin settings (server#24046)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24047">Fix iLike() falsely turning escaped % and _ into wildcards (server#24047)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24051">Use png icons in caldav reminder emails (server#24051)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24077">Unlock when promoting to exclusive lock fails (server#24077)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24078">Add mount point to quota warning message (server#24078)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24082">Fix default internal expiration date enforce (server#24082)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24149">Don't throw on SHOW VERSION query (server#24149)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24154">Bump dompurify to 2.2.2 (server#24154)</a></li>
        <li><a href="https://github.com/nextcloud/server/pull/24161">Fix default internal expiration date (server#24161)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/435">Bump lodash from 4.17.14 to 4.17.20 (firstrunwizard#435)</a></li>
        <li><a href="https://github.com/nextcloud/firstrunwizard/pull/440">Add dependabot-approve-merge (firstrunwizard#440)</a></li>
        <li><a href="https://github.com/nextcloud/photos/pull/512">Pass preview availability too (photos#512)</a></li>
        <li><a href="https://github.com/nextcloud/recommendations/pull/321">Bump lodash from 4.17.14 to 4.17.20 (recommendations#321)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1161">Bump dependencies to version in range (text#1161)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1168">Validate link on click (text#1168)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1173">Bump eslint-plugin-standard from 4.0.2 to 4.1.0 (text#1173)</a></li>
        <li><a href="https://github.com/nextcloud/text/pull/1174">Bump babel-loader from 8.1.0 to 8.2.1 (text#1174)</a></li>
</ul>
...
<p>This is the final release of Nextcloud 17. To protect the security of your data, <a class="hyperlink" href="https://docs.nextcloud.com/server/latest/admin_manual/maintenance/upgrade.html">upgrade to Nextcloud Hub 19</a> or get a <a class="hyperlink" href="https://nextcloud.com/enterprise">subscription to Nextcloud Enterprise</a> to benefit from long term support.</p>
<ul>
...
<h4>Changes</h4>
<p>This is the final release of Nextcloud 16. To protect the security of your data, <a class="hyperlink" href="https://docs.nextcloud.com/server/latest/admin_manual/maintenance/upgrade.html">upgrade to Nextcloud Hub 19</a> or get a <a class="hyperlink" href="https://nextcloud.com/enterprise">subscription to Nextcloud Enterprise</a> to benefit from long term support.</p>
<ul>
...
<h4>Changes</h4>
<p>This is the final release of Nextcloud 15. To protect the security of your data, <a class="hyperlink" href="https://docs.nextcloud.com/server/latest/admin_manual/maintenance/upgrade.html">upgrade to Nextcloud Hub 19</a> or get a <a class="hyperlink" href="https://nextcloud.com/enterprise">subscription to Nextcloud Enterprise</a> to benefit from long term support.</p>
<ul>
...
<h4>Changes</h4>
<p>This is the final release of Nextcloud 14. To protect the security of your data, <a class="hyperlink" href="https://docs.nextcloud.com/server/latest/admin_manual/maintenance/upgrade.html">upgrade to Nextcloud Hub 19</a> or get a <a class="hyperlink" href="https://nextcloud.com/enterprise">subscription to Nextcloud Enterprise</a> to benefit from long term support.</p>
<ul>
