    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 revealOnScroll">
                ...
                <li><?php echo $l->t('Protect your files with client side, <a class="hyperlink" href="/endtoend">End-to-end encryption</a> (version >2.4)');?></li>
                </ul></p>
            </div>
            <div class="col-sm-4 revealOnScroll">
                <p class="section--paragraph"><ul>
                ...
                <li><?php echo $l->t('Branding support for <a class="hyperlink" href="/enterprise">enterprise customers</a>');?></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 revealOnScroll">
                ...
                <li><?php echo $l->t('Client-side, <a class="hyperlink" href="/endtoend">End-to-end encryption</a>');?></li>
