...
<div class="container">
	...
	<div class="row revealOnScroll">
		...
		<div class="col-sm-5 col-sm-offset-2">
			...
			<p class="section--paragraph revealOnScroll">If these hotels are full or not to your liking, you can use for example <a class="hyperlink" href="http://findhotelsnearanaddress.com/">this site</a> to find something close by the University.</p>
		</div>
	</div>
</div>
</section>
