<head>
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/pages/conf-18.css?v=1" rel="stylesheet">
...
<!-- 			<h2></h2> -->
			...
			<p class="section--paragraph"><a href="https://nextcloud.com/blog/nextcloud-conference-2018-millions-of-nec-routers-nextcloud-14-and-simple-signup/" class="button button--arrow button--large button--blue">Conference report <i class="icon-arrow-circle-o-right icon"></i></a></p>
...
<section class="section--program">
    <div class="container">
        ...
        <div class="fixbox">
            ...
            <div class="row text-center">
            <a class="button button--large button--blue button--arrow" href="https://nextcloud.com/schedule/2018/schedule.html">View the full schedule here</a>
            <a class="button button--large button--blue button--arrow" href="https://nextcloud.com/schedule/2018/speakers.html">See the speakers</a>
            </div>
        </div>
        </div>
    </div>
...
<!-- 			<p class="section--paragraph">People start coming in around 9am and the last usually leave around 9pm.</p> -->
			<p class="section--paragraph">Read our <a class="hyperlink" href="https://nextcloud.com/blog/significant-growth-at-nextcloud-conference-brought-150-customers-colleagues-and-friends-together/" target="_blank">blog on the Nextcloud Conference 2017</a> to get a feeling of the event.</p>
		</div>
		<div class="col-sm-5 col-sm-offset-2">
			...
			<p class="section--paragraph">In the weekend of August 25 and 26 we have a program with talks and workshops to provide a chance to learn and improve coding skills on and around Nextcloud. For example:
			<ul>
...
<!-- 			<p class="section--paragraph">Stay tuned for more information! We'll open registration later this year and expect our call for papers early 2018.</p> -->
			<p class="section--paragraph">On Monday the 27th we have a <a class="hyperlink" href="<?php echo home_url('training') ?>">special Enterprise day with a focus on enterprise and large scale Nextcloud usage.</a></p>
...
<!-- 			<p class="section--paragraph">Submit your session ideas in our <a class="hyperlink" href="https://eventyay.com/e/77d26f89/cfs/">call for papers</a> now!</p> -->
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <p class="section--paragraph text-center">Nextcloud is committed to support diversity and will provide support to people of underrepresented groups in tech. This includes people who belong to one or more of the following groups: women, people of color, nonbinary & gender non-conforming people, people with disabilities, and LGBTQIA+ people.</p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <p class="section--paragraph text-center">The event is free and provides catered lunch. We will provide up to 80% support of travel & accomodation costs during the event to people who have contributed to Nextcloud in one way or another. For instance, you can <a class="hyperlink" href="https://github.com/nextcloud/server/labels/good%20first%20issue">solve a good first issue</a>, <a class="hyperlink" href="https://nextcloud.com/design/">work on the design</a>, <a class="hyperlink" href="https://www.meetup.com/topics/nextcloud/">organize a local Nextcloud meetup</a>, <a class="hyperlink" href="https://nextcloud.com/contribute/">or contribute in other ways</a>.</p>
...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <h2>Partners!</h2>
            <p class="section--paragraph">The event is made possible thanks to the generous donation of the location by the <a class="hyperlink" href="http://www.tu-berlin.de/" target="_blank">Technische Universität Berlin</a> and the financial and practical support of <a class="hyperlink" href="https://nextcloud.com">Nextcloud GmbH</a>.</p>
            <p class="section--paragraph">TUXEDO Computers contributes a number of loan laptops for workshop or hackweek attendees who need a device to work with but forgot their own. Media partners like Linux Magazine and Admin Magazine will cover the Nextcloud Conference!</p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
    ...
    <div class="row">
        ...
        <p class="section--paragraph">Contact us if you'd also like to contribute as partner!</p>
        </div>
    </div>
</div>
</section>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-6">
			...
			<h2>Entree</h2>
			<p class="section--paragraph">The Nextcloud Contributor Conference will be entirely open and free. We only ask you to <a class="hyperlink" href="https://eventyay.com/e/77d26f89/" target="_blank">register</a> to help us plan better for the event</p>
		</div>
	</div>
	<div class="row">
		<div class="col-md-6">
...
<div class="container">
	<div class="row conf-about">
		<div class="col-sm-6">
			...
			<p class="section--paragraph"><a href="<?php echo get_template_directory_uri(); ?>/assets/img/conference/grouppic2017.jpg" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/grouppic2017.jpg" style="width: 95%" alt="group photo" class="aligncenter" /></a></p>
