...
<!-- 			<p class="section--paragraph ">People start coming in around 9am and the last usually leave around 9pm.</p> -->
		...
		<div class="col-sm-5 col-sm-offset-2">
			...
			<p class="section--paragraph ">In the weekend of September 14 and 15 we have a program with talks and workshops to provide a chance to learn and improve coding skills on and around Nextcloud. For example:
			<ul class="">
