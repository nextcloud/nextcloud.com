<head>
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/pages/conf.css?v=5" rel="stylesheet">
...
<section class="section--program">
    <div class="container">
        ...
        <div class="fixbox">
            ...
            <tbody>
            <tr>
            <th scope="row">Saturday<br> October 3</th>
            <th scope="row">Sunday<br> October 4</th>
            <th scope="row">Monday<br> October 5</th>
            <th scope="row">Tuesday<br> October 6</th>
            <th scope="row">Wednesday<br> October 7</th>
            <th scope="row">Thursday<br> October 8</th>
            <th scope="row">Friday<br> October 9</th>
            </tr>
            <tr>
            <td class="left">10:00 - <strong>Keynote</strong><br>
            11:00 - <strong>Talks</strong><br>
            13:00 - <strong>lunch/break/interviews</strong><br>
...
<div class="container">
	<div class="row conf-info">
		<div class="col-sm-5">
			...
			<p class="section--paragraph ">During the hackweek we collaborate on Nextcloud improvements in design, functionality, stability, performance and features. We share code, thoughts, inspiration, beer and knowledge, working in areas like:</p>
			<ul class="">
...
<!-- 			<p class="section--paragraph ">People start coming in around 9am and the last usually leave around 9pm.</p> -->
			<p class="section--paragraph ">Read our <a class="hyperlink" href="https://nextcloud.com/blog/massive-series-of-announcements-over-weekend-from-nextcloud-conf-event-continues/" target="_blank">blog on the Nextcloud Conference 2018</a> to get a feeling of the event. We will try to reproduce this online - having multiple rooms around various subjects, regular calls and workshops.</p>
		</div>
		<div class="col-sm-5 col-sm-offset-2">
			...
			<p class="section--paragraph ">In the weekend of October 3 and 4 we have a program with talks and workshops to provide a chance to learn and improve coding skills on and around Nextcloud. For example:
			<ul class="">
...
<!--<section class="section--enterprise">
	<div class="container-fluid">
			...
			<p class="section--paragraph ">Join our Enterprise training day Monday October 16.<br/><strong>Book until July 31st and get 50% off!</strong></p>
...
<div class="container">
    <div class="row ">
        <div class="col-md-8 col-md-offset-2">
            <h2 class="section--paragraph--header  text-center"><a href="https://diversitytickets.org/events/182" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/diversitytickets.svg" alt="Diversity tickets logo" class="aligncenter" /></a> Diversity Tickets</h2>
        </div>
    </div>
    <div class="row ">
        <div class="col-md-8 col-md-offset-2">
            <p class="section--paragraph  text-center">Nextcloud is committed to increase diversity and will provide support to people who are marginalized in tech. This includes women, people of color, nonbinary & gender non-conforming people, people with disabilities, and LGBTQIA+ people.</p>
        </div>
    </div>
    <div class="row ">
        <div class="col-md-8 col-md-offset-2">
            <p class="section--paragraph  text-center">We will provide 80% support of travel & accomodation costs during the event, and entry is free. Having <a class="hyperlink" href="https://nextcloud.com/contribute/">contributed to Nextcloud</a> before is not necessary.</p>
            <p class="text-center">Stay tuned, information is coming!</p>
...
<div class="container">
    <div class="row ">
        <div class="col-md-8 col-md-offset-2">
            ...
            <p class="section--paragraph ">The event is made possible thanks to the financial and practical support of <a class="hyperlink" href="https://nextcloud.com">Nextcloud GmbH</a>.</p>
            <!--<p class="section--paragraph ">TUXEDO Computers contributes a number of loan laptops for workshop or hackweek attendees who need a device to work with but forgot their own. Media partners like Linux Magazine and Admin Magazine will cover the Nextcloud Conference! Our dear friends at openSUSE sponsored our party and had a booth at the event.</p> -->
        </div>
    </div>
<!--    <div class="row ">
        <div class="col-sm-4 col-md-3">
            <p class="section--paragraph  text-center"><a href="http://www.tu-berlin.de/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/tub-logo.png" alt="TUBerlin logo" class="aligncenter img-responsive" /></a></p>
        </div>
        <div class="col-sm-4 col-md-3">
            <p class="section--paragraph  text-center"><a href="https://tuxedocomputers.com" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/tuxedo.png"  alt="Tuxedo Computers logo" class="aligncenter img-responsive" /></a></p>
        </div>
        <div class="col-sm-4 col-md-3">
            <p class="section--paragraph  text-center"><a href="https://opensuse.org" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/opensuse.png"  alt="opensuse logo" class="aligncenter img-responsive" /></a></p>
        </div>
        <div class="col-sm-4 col-md-3">
            <p class="section--paragraph  text-center"><a href="https://univention.de" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/partners/univention.png"  alt="Univention logo" class="aligncenter img-responsive" /></a></p>
        </div>
        <div class="col-sm-4 col-md-3">
            <p class="section--paragraph  text-center logo"><a href="https://turris.cz" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/turris.svg"  alt="turris logo" class="svg-logo aligncenter img-responsive" /></a></p>
        </div>
        <div class="col-sm-4 col-md-3">
            <p class="section--paragraph  text-center logo"><a href="https://nitrokey.com" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/nitrokey.svg"  alt="nitrokey logo" class="svg-logo aligncenter img-responsive" /></a></p>
        </div>
        <div class="col-sm-4 col-md-3">
            <p class="section--paragraph  text-center logo"><a href="https://nitrokey.com" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/Gnomelogo.svg"  alt="nitrokey logo" class="svg-logo aligncenter img-responsive" /></a></p>
        </div>
        <div class="col-sm-4 col-md-3">
            <p class="section--paragraph  text-center"><a href="http://www.admin-magazine.com/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/AdminMagazine.png" alt="Admin mag logo" class="aligncenter img-responsive" /></a></p>
        </div>
        <div class="col-sm-4 col-md-3">
            <p class="section--paragraph  text-center"><a href="http://www.linux-magazine.com/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/LinuxMagazine.png" alt="LinuxMagazin logo" class="aligncenter img-responsive" /></a></p>
        </div>
    </div>-->
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
        <p class="section--paragraph "><a href="mailto:events@nextcloud.com?subject=%5Bpartnership&body=We%20want%20to%20partner%20up" class="hyperlink">Contact us</a> if you'd also like to contribute as partner!</p>
        </div>
    </div>
</div>
</section>
...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<!--<p class="section--paragraph ">You can also RSVP on <a href="https://www.facebook.com/events/1610744752475847/" target="_blank">Facebook</a>, <a href="http://www.meetup.com/nextcloud-berlin/events/224095898/" target="_blank">Meetup.com</a> or <a href="https://plus.google.com/b/107072838776436530705/events/c2dlfpjfd4600hlt9oh747prlb8" target="_blank">Google+</a>!</p>-->
			<h2  class="">Location</h2>
			<p>We will have a small, invite-only in-person coordination and recording team at <a class="hyperlink" href="https://www.bum.berlin/">bUm</a>, but for 99% of the participants the event is on-line. Just register and you will get an account to participate with!</p>
<!-- 			<p class="section--paragraph ">Our conference will take place in Berlin at the <em>Technische Universität Berlin</em>, in the "<a class="hyperlink" href="https://www.math.tu-berlin.de/" target="_blank">Institut für Mathematik</a>" building, main entree at Strasse des 17. Juni 136, 10623 Berlin.</p> -->
<!-- 			<iframe width="100%" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=13.32431048154831%2C52.51259881205445%2C13.328194320201874%2C52.51417400875078&amp;layer=mapnik&amp;marker=52.513385601296605%2C13.326252400875092" style="border: 1px solid black"></iframe><br/><small><a href="http://www.openstreetmap.org/?mlat=52.51339&amp;mlon=13.32625#map=19/52.51339/13.32625">View Larger Map</a></small> -->
		...
		<!--<div class="col-md-6">
			<p class="section--paragraph "><a href="<?php echo get_template_directory_uri(); ?>/assets/img/conference/talks.jpg" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/talks_wee.jpg" style="width: 95%" alt="talk" class="aligncenter" /></a></p>
			<h2  class="">Entree</h2>
			<p class="section--paragraph "><p><a href="https://eventyay.com/e/70d8ad61/" class="hyperlink">The event costs €20,</a> and until July 31st we offer €15 Early bird tickets! Contributors get a free ticket - just <a href="mailto:events@nextcloud.com?subject=%5BContributor%20ticket%5D%20YOUR%20NAME&body=Link%20to%20your%20contribution" class="hyperlink">shoot us an email</a> with a link to your contribution(s) on github, transifex or otherwise! We provide catered lunch at the conference, you can find some hotel options further down the page.</a></p>
		</div>
	</div>
	<div class="row ">
		<div class="col-md-6">
			<p class="section--paragraph "><a href="<?php echo get_template_directory_uri(); ?>/assets/img/conference/drinks.jpg" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/drinks_wee.jpg" style="width: 95%" alt="group photo" class="aligncenter" /></a></p>
			<h2  class="">Code of conduct</h2>
			<p class="section--paragraph ">We want everybody to feel welcome at the event. Please be mindful of our <a class="hyperlink" href="https://nextcloud.com/community/code-of-conduct/">code of conduct</a></p>
			<p class="section--paragraph ">The conference is an open space which means potential issues. Please be sure that you are comfortable with that. Of course, you can always ask people not to take pictures or video of you but note that there will be video recordings of the talks.</p>
		</div>
		<div class="col-md-6">
			<h2 class="conf-acc">Berlin and accommodation</h2>
			<p class="section--paragraph ">We gathered some hotel options for you! Be quick, last year many hotels already had no space left in May...</p>
			<ul>
			...
			<p class="section--paragraph ">If these hotels are full or not to your liking, you can use for example <a class="hyperlink" href="http://findhotelsnearanaddress.com/">this site</a> to find something close by the University.</p>
		</div>-->
	</div>
</div>
</section>
...
<div class="container">
	<div class="row conf-about ">
		<div class="col-sm-6">
			...
			<p class="section--paragraph ">The Nextcloud Conference 2019 brought 250 Nextclouders to Berlin. Read our <a class="hyperlink" href="https://nextcloud.com/blog/massive-series-of-announcements-over-weekend-from-nextcloud-conf-event-continues/" target="_blank">blog</a> to learn more and watch the talks <a class="hyperlink" href="https://www.youtube.com/channel/UCQjN5Fs5QSz1loJqLb5bkew" target="_blank">on our youtube channel.</a></p>
			<p class="section--paragraph ">See the <a class="hyperlink" href="<?php echo home_url('conf-2019') ?>" target="_blank">full 2019 conference page here.</a></p>
			<p class="section--paragraph "><a href="<?php echo get_template_directory_uri(); ?>/assets/img/conference/grouppic2019.jpg" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/conference/grouppic2018-small.jpg" style="width: 95%" alt="group photo" class="aligncenter" /></a></p>
	<!--		<iframe src="//www.youtube-nocookie.com/embed/srGYbsugEPc?list=PLtZe22ggl2YCfEzrHbFCylXGLGYtsHm96" height="360" width="640" allowfullscreen="" frameborder="0"></iframe>-->
		...
		<div class="col-sm-6">
			<h2  class="">Questions, suggestions?</h2>
			<p class="section--paragraph ">Ask! And tell others you will join the conference! Our official hashtag for this conference is <em>#homeoffice</em> - often combined with #nextcloud of course. Find us on <a class="hyperlink" title="Nextcloud on Twitter" href="https://twitter.com/nextclouders" target="_blank">Twitter</a>, <a class="hyperlink" title="Nextcloud on Facebook" href="https://www.facebook.com/nextclouders" target="_blank">Facebook</a> and other social media. Find some <a class="hyperlink" href="https://github.com/nextcloud/promo/tree/master/Conference" target="_blank">promo materials here</a>.</p>
        </div>
    </div>
    <div class="row">
