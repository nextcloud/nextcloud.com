...
<div class="row conf-info">
    ...
    <h3>Hackathon</h3>
    <p>Friday, registration is at the hacking rooms and opens at 9. Walk from entry to the stairs on the right and follow the signs! This is where we are:</p>
    <ul>
	<li>3th floor:
		<ul>
...
<div class="row conf-info">
    ...
    <p>We have got wifi and many rooms are equipped with a (limited) number of network cables.</p>
