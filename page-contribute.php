...
<p>We are still starting up. We're defining our plans and will come with more <a href="/news">news</a> the coming days and weeks. We will start by delivering Nextcloud 9, adding bugfixes and Spreed.ME based on what currently is shipped in the Spreedbox. From there on we'll define and built the future, together with all of you!</p>

<p>While we bootstrap our product, website and community infrastructure, we invite you to join the conversations on <a href="https://help.nextcloud.com">our forums</a> and our <a href="irc://#nextcloud-dev@freenode.net">IRC channel on freenode</a>. Interact with us on our <a href="/news">blogs and social media</a>, too!</p>
...
<div class="row">
	<div class="col-md-6">
            ...
            <li>Learn to write Nextcloud code. (Try your hands on a <a href="https://github.com/nextcloud/core/issues?labels=Junior+Job&state=open">Junior Job</a>
          ...
          <a href="https://mailman.nextcloud.org/mailman/listinfo/devel">mailing list</a>! We look forward to your code and thoughts.</p>
    ...
    <h3><i class="icon-book"></i>&nbsp;&nbsp;Answer questions about Nextcloud use and development</h3>
        ...
        <ul><li>Join the <a href="https://forum.nextcloud.org">Nextcloud forums</a> and look for <a href="https://forum.nextcloud.org/search.php?search_id=unanswered">unanswered questions</a></li>
        <li>Answer Nextcloud development questions on <a href="https://stackoverflow.com/questions/tagged/nextcloud">Stack Overflow</a> and <a href="https://community.spiceworks.com/">Spiceworks</a></li>
        <li>Answer Nextcloud user questions on <a href="https://mailman.nextcloud.org/mailman/listinfo/user">the Nextcloud user mailing list</a></li></ul>
    </div>
</div>-->
<br />
