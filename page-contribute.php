	...
	<div class="col-md-8 col-md-offset-2">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<p class="section--paragraph"><?php echo $l->t('Improve the Nextcloud Server');?> (<a class="hyperlink"  href="<?php echo $DOCUMENTATION_DEVELOPER; ?>core"><?php echo $l->t('core development documentation</a>)');?></p>
		...
		<p><?php echo $l->t('Please be considerate of our <a class="hyperlink"  href="/community/code-of-conduct/">code of conduct</a>. We want to provide a positive and enjoyable environment for everybody.');?></p>
			...
			<div class="col-md-6">
				...
				<p class="section--paragraph"><?php echo $l->t('Testing upcoming Nextcloud Server releases is the best way of making sure the new release can do what you need it
					...
					find the <a class="hyperlink" href="ownCloud vs Nextcloud">issue submission page</a>.');?></p>
