...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<p><?php echo $l->t('<strong>Picking what to work on:</strong> The design process is pretty flexible and open. Anyone can contribute to Nextcloud design through issues in the <a href="https://github.com/nextcloud/" target="_blank" rel="noopener">Nextcloud organisation on Github</a>. Each app has its own repository where issues are tracked.');?></p>
			<ul>
				<li><?php echo $l->t('We track design and interface issues through the <a href="https://github.com/nextcloud/server/labels/design" target="_blank" rel="noopener">design label on our issue tracker</a>. (If you have a GitHub account, you can see the <a href="https://github.com/issues?q=is%3Aopen+label%3Adesign+user%3Anextcloud" target="_blank" rel="noopener">design issues across repositories too</a>).');?></li>
				<li><?php echo $l->t('If you are a new contributor looking to get involved, check through the <a href="https://github.com/nextcloud/server/issues?q=is%3Aopen+label%3A%22good+first+issue%22+label%3Adesign" target="_blank" rel="noopener">good first issues label</a>! 🎉');?></li>
			</ul>
			...
			<ul>
				...
				<li><?php echo $l->t('Ideally do a mockup to support the specification. We generally use the open source mockup software <a href="https://penpot.app/" target="_blank" rel="noopener">Penpot</a>, but you can use any method that feels comfortable. Even Inkscape or just a pen and paper mockup would work.');?></li>
			</ul>
			...
			<ul>
				<li><?php echo $l->t('<a href="https://github.com/nextcloud/desktop/issues/877" target="_blank" rel="noopener">This issue</a> has examples of other apps, some simple mockups, and specifications about the design. In the discussions in the comments there are updates to the design as well.');?></li>
				<li><?php echo $l->t('<a href="https://github.com/nextcloud/desktop/pull/1565" target="_blank" rel="noopener">This pull request</a> by a developer has the implementation of that issue, the changes they made, and more design discussions and adjustments.');?></li>
			</ul>		
	...
	<div class="row">
		<div class="col-md-12">
			...
			<p><?php echo $l->t('Universal access is very important to us. We follow web standards and check to make everything usable also with keyboard and assistive software such as screen readers. We aim to be compliant with the <a href="https://www.w3.org/WAI/standards-guidelines/wcag/" target="_blank" rel="noopener">Web Content Accessibility Guidelines 2.1</a> on AA level, with the high contrast theme even on AAA level. We also follow the German BITV 2.0 guidelines.');?></p>
			
			<p><?php echo $l->t('If you find any accessibility issues, don’t hesitate to report them on our <a href="https://github.com/nextcloud/server/issues/" target="_blank" rel="noopener">issue tracker</a>.');?></p>

			<p><?php echo $l->t('Find more info on the accessibility of Nextcloud in the <a href="https://docs.nextcloud.com/server/latest/user_manual/en/universal_access.html" target="_blank" rel="noopener">user manual</a>, and if you want to learn more about accessibility, check out <a href="https://www.a11yproject.com/" target="_blank" rel="noopener">The A11Y Project</a>');?></p>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul>
				<li><?php echo $l->t('<a href="https://ukhomeoffice.github.io/accessibility-posters/posters/accessibility-posters.pdf" target="_blank" rel="noopener">UK Home Office accessibility posters</a>');?></li>
				<li><?php echo $l->t('<a href="https://lawsofux.com/" target="_blank" rel="noopener">Laws of UX</a>');?></li>
				<li><?php echo $l->t('<a href="https://www.nngroup.com/" target="_blank" rel="noopener">Nielsen Norman Group</a>');?></li>
				<li><?php echo $l->t('<a href="https://ometer.com/preferences.html" target="_blank" rel="noopener">Choosing our preferences</a>');?></li>
			</ul>	
	...
	<div class="row">
		<div class="col-md-12">
			...
			<h3 class="section--paragraph__title"><?php echo $l->t('Nextcloud podcast talks about design');?></h3>
		
			<p><?php echo $l->t('Check out some of these interesting websites and articles!');?></p>
			<ul>
				<li><?php echo $l->t('<a href="https://nextcloud.com/blog/introducing-the-nextcloud-podcast/" target="_blank" >History of Nextcloud, design and community with design lead Jan</a>');?></li>
				<li><?php echo $l->t('<a href="https://nextcloud.com/blog/interview-with-nimisha-vijay-the-ux-ui-designer-at-nextcloud/" target="_blank" >UX designer Nimisha talks about design at Nextcloud</a>');?></li>
			</ul>	
