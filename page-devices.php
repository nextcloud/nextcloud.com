...
<!--         <h4>Currently available</h4> -->
        <div class="col-lg-4">
            <div class="block-container">
                ...
                <div class="col-md-12">
                    <h3 class="section--paragraph__title"><?php echo $l->t('Nextcloud on TrueNAS');?></h3>
                    <p class="section--paragraph"><em><?php echo $l->t('Add Nextcloud to your NAS');?></em></p>
                    <p class="section--paragraph"><?php echo $l->t('TrueNAS is an Open Source powered storage platform that scales from private home servers to 20PB+ storage platforms and has over a million deployments. Nextcloud Hub is be officially supported on TrueNAS systems with easy install of  the official Nextcloud Hub app requiring just a few clicks. Together, Nextcloud and TrueNAS provide an extremely versatile and reliable collaboration and data storage platform.');?></p>
                    <div class="devices-tags">
                        <span>Enterprise</span>
                        <span>Community</span>
                        <span>Official</span>
                    </div>
                    <a href="https://www.truenas.com/docs/core/solutions/integrations/nextcloud/ " class="button button--blue button--arrow button--large"><?php echo $l->t('Get started');?></a>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
