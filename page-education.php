...
<div class="container-widest">
    ...
    <div class="row">
		<div class="col-md-3 customer">
            <a href=""><img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/customers/tuberlin.svg" /></a>
        </div>
		<div class="col-md-3 customer">
...
<div class="container-widest">
    ...
    <div class="row revealOnScroll">
        ...
        <div class="col-md-3 featureblock">
        <p class=""><?php echo $l->t('Desktop and mobile clients for Win/Mac/Lin, Android and iOS complement the web interface, integrating in the file system. Nextcloud can also be reached through WebDAV.');?></p>
        </div>
        <div class="col-md-1 featureblock">
