		<div class="row headerrow">
			...
			<div class="col-md-7">
				<h2>Nextcloud Server 8.2 Features</h2>
				<p>Nextcloud Server 8.2 has significant improvements for users, administrators and developers.
					This page contains an overview of the most important changes.
				</p>
				<a href="/install" class="btn btn-lg btn-primary install-8-btn">Install Nextcloud 8.2 now</br></a>
...
<div class="wrap container">
	<div class="content row">
		<div class="featurewrapper">
			<h2>Nextcloud Server 8.2 Feature Improvements</h2>
		</div>
		...
		<div class="row featurerow">
			...
			<div class="col-md-4 featureblock">
				...
				<p class="featuredesc">A new sidebar in the Files app makes it easy to view details on a file without cluttering the interface. A larger preview with meta data, file activity, sharing state and older versions all resides in the new sidebar. In the future, Nextcloud apps can <a href="<?php echo $DOCUMENTATION_DEVELOPER; ?>app">add further functionality</a> through panels in the sidebar.</p>
			</div>
			...
			<div class="col-md-4 featureblock">
				...
				<p class="featuredesc">By reducing the number of colors and shades, the Nextcloud interface is cleaner. Actions on files like download, rename and delete can now be found in the three-dot 'more' menu and this release also introduces new, more modern icons.</p>
			</div>
		</div>
		...
		<div class="row featurerow">
			<div class="col-md-4 featureblock">
				...
				<p class="featuredesc">The text editor included in Nextcloud has been updated, featuring a new look and automatically saving your files.</p>
			</div>
		</div>
...
<!--                 </div> -->
		...
		<p>System administrators are strongly encouraged to check out the <a href="https://doc.nextcloud.org/server/8.2/admin_manual/release_notes.html">release notes for Nextcloud Server 8.2</a> before upgrading or doing a fresh installation!</p>
		<div class="row featurerow">
			<div class="col-md-4 featureblock">
				...
				<p class="featuredesc">Nextcloud now offers a notification window where an admin can push notifications out to users of the Nextcloud system, such as notification about a maintenance window. This is currently only in the web interface but future mobile and desktop client releases will incorporate the notification feature. There is an <a href="https://apps.nextcloud.com/content/show.php?content=173921">Announcement Center App in the app store</a> for sending system wide notifications.</p>
			</div>
		...
		<div class="row featurerow">
			<div class="col-md-6 featureblock">
				...
				<p>Nextcloud Server 8.2 has received a significant amount of security hardening, including the following:</br>
				<ul class="featureslist">
				<li>Nextcloud now encrypts user keys in the Nextcloud session. This means that, even if a server is compromised and the session data is discovered, user private keys stored in the session – required to unencrypt files stored on the server – can no longer be read.</li>
				...
				Find <a href="https://github.com/nextcloud/core/wiki/Nextcloud-8.2-Features#security">more changes and details here</a>.
				</p>
			</div>
			<div class="col-md-6 featureblock">
...
<!-- 			<div class="col-md-6 text-center"><iframe width="100%" height="360" src="https://www.youtube.com/embed/nx5PGWc7X18?rel=0" frameborder="0" allowfullscreen></iframe></div> -->
		...
		Nextcloud is <a href="http://karlitschek.de/2015/06/building-a-platform/">meant to be a platform</a>. This release introduces many improvements to the API, both to make more functionality available for app developers and to improve the existing interfaces.
