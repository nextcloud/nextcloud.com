		...
		<div class="col-md-4 table-column revealOnScroll">
			...
			<div class="table-content">
				...
				<div class="list revealOnScroll">
					...
					<li class="optional"><?php echo $l->t('<span title="Support for our secure and private peer to peer audio and video conferencing.">Secure WebRTC Conferencing</span>');?></li>
					<li class="optional"><?php echo $l->t('<span title="Allows web conferencing calls to connect with phone lines.">SIP gateway</span>');?></li>
					<li class="optional"><?php echo $l->t('<span title="Real time collaborative editing of often used office fileformats like DOCX, PPTX and more.">Collabora Online Office</span>');?></li>
				</div>
