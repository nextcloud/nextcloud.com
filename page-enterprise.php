    ...
    <div class="container">
        ...
        <div class="texts-wrapper col-md-6">
	        <div class="right-text-grey" data-slide="1">
				...
				<p>Nextcloud offers LDAP/Active Directory, SAML and Kerboros authentication. It accesses data on NFS, (s)FTP, WebDAV, Windows Network Drive, Object Stores like SWIFT and many more.</p>
	         ...
	         <div class="right-text-grey" data-slide="2">
	           ...
	           <p>Nextcloud supports two-factor authentication and Server Side Encryption, has brute force protection and features industry-standard security measures like CSP, SSC and password and session management.></p>
	        ...
	        <div class="right-text-grey" data-slide="3">
	            ...
	            <p>Our File Access Control app enables administrators to defining data access rules or triggering actions based on location, group membership, file type, tags and other properties.</p>
	        ...
	        <div class="right-text-grey" data-slide="4">
	            ...
	            <p>Users can access and share their data on Nextcloud through sync clients for Windows, Linux and Mac as well as Android and IOS, providing a smooth experience no matter where data is located.</p>
