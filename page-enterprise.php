...
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/pages/enterprise.css?v=3" rel="stylesheet">
...
<!--    <h1 class="section--heading-1 text-center"><?php echo $l->t('Nextcloud Enterprise Delivers');?></h2>
