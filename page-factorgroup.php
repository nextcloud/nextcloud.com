...
<div class="background ccp-background">
	<div class="container">
		<div class="col-md-6 topheader">
			...
			<h2><?php echo $l->t('Need a private cloud in Russia?');?><br /><?php echo $l->t('Factor Group and Nextcloud have you covered!');?><br/>
			<a class="button button--blue" href="https://www.fgts.ru/collection/nextcloud"><?php echo $l->t('Contact Factor Group');?></a></h2>
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
                ...
                <p class="section--paragraph text-center"><?php echo $l->t('Factor Group offers a wide network of skilled Nextcloud partners in Russia to choose from.');?></p>
		</div>
	</div>
</div>
</section>
            ...
            <div class="col-sm-4">
                ...
                <div class="row description">
                    <div class="title">
                        ...
                        <div class="text">
                            <strong><?php echo $l->t('Nextcloud Files');?></strong><br><small><?php echo $l->t('Enterprise File Sync and Share');?></small>
                        </div>
                    </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="row description">
                    <div class="title">
                        ...
                        <div class="text">
                            <strong><?php echo $l->t('Nextcloud Talk');?></strong><br><small><?php echo $l->t('Calls, chat and web meetings');?></small>
                        </div>
                    </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="row description">
                    <div class="title">
                        ...
                        <div class="text">
                            <strong><?php echo $l->t('Nextcloud Groupware');?></strong><br><small><?php echo $l->t('Calendar, Contacts & Mail');?></small>
                        </div>
                    </div>
...
<div class="container">
    <div class="row">
            ...
            <div class="col-md-6">
				<p class="section--paragraph"><?php echo $l->t('As official distributor in Russia, Factor Group offers the Russian market access to Nextcloud Enterprise through its network of qualified partners.');?></p>
				<p class="section--paragraph"><?php echo $l->t('Factor group specializes in supplying the telecommunications industry with the world\'s leading equipment and technological solutions, offering consulting services, pre-design and design works, pre-sale advice, equipment installation and commissioning support, employee training, as well as after-sales service, product versions updates, equipment repair and replacement. Factor group executives have expertise in networking and information technologies market in Russia and the CIS countries since 1991.');?></p>
				<a class="button button--white" href="https://www.fgts.ru/collection/nextcloud"><?php echo $l->t('Learn more');?></a>
			</div>
        <div>
    </div>
</div>
...
<div class="container-fluid icon-background">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="text">
                    <h3 class="section--paragraph__title"><?php echo $l->t('Why Nextcloud Enterprise');?><br /> <?php echo $l->t('by Factor Group');?></h3>
                    <li class="check"><?php echo $l->t('Tested and optimized for large organizations');?></li>
                    <li class="check"><?php echo $l->t('Early bug fixes, security patches and hardening');?></li>
                    <li class="check"><?php echo $l->t('Access to the best enterprise expertise');?></li>
                    <li class="check"><?php echo $l->t('Custom integration for your needs');?></li>
                    <li class="check"><?php echo $l->t('Reliable Russian support');?></li>
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
	<h1 class="section--heading-1 text-center"><?php echo $l->t('Why self hosting in Russia?');?></h1>
	<div class="row">
		<div class="col-md-6 feature--block">
            <h3 class="section--paragraph__title"><?php echo $l->t('You need 100% certainty');?></h3>
			<p class="section--paragraph"><?php echo $l->t('Sending around data by email or using foreign SaaS file sharing solutions does not provide much security for sensitive data. Encryption is complicated and cumbersome to use, reducing the real benefits due to employees working around them or making mistakes.');?></p>
			...
			<p class="section--paragraph"><?php echo $l->t('Factor Group offers access to a wide range of reliable partners who have strong, proven Nextcloud expertise and can ensure you get a reliable, secure and compliant setup.');?></p>
        </div>
        <div class="col-md-6 feature--block">
            <h3 class="section--paragraph__title"><?php echo $l->t('You need an Enterprise platform');?></h3>
			<p class="section--paragraph"><?php echo $l->t('Most consumer-grade solutions like Dropbox or Office 365 were not designed with privacy regulations and security concerns in mind, mixing data from consumers and businesses, spread out in data centers across the globe. Enterprise IT workloads may be processed by Cloud Providers liable to the US CLOUD Act, meaning your business data can be leaked on orders of the US judicial system, often without disclosure to you.');?></p>
			<p class="section--paragraph"><?php echo $l->t('Rather than trying to work around their limitations, Nextcloud Enterprise provides a security-first solution which puts you in complete control over the location and access policies of data.');?></p>
			<p class="section--paragraph"><?php echo $l->t('Nextcloud Enterprise gives you the certainty of a certified, compliant platform that is optimized and tested for enterprise environments.');?></p>
        </div>
    </div>
</div>
</section>
...
<div class="container">
    <div class="row">
        <div class="col-md-6  col-md-offset-3">
            <p class="section--paragraph"><?php echo $l->t('Do not risk your data to the services of an unqualified service provider. Get the certainty that comes from the real vendor expertise!');?></p>
            <a href="https://www.fgts.ru/collection/nextcloud" class="button button--blue button--arrow button--large"><?php echo $l->t('Contact Factor Group now');?></a>
        </div>
    </div>
</div>
</section>
        ...
        <div class="row">
         ...
         <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <p class="section--paragraph"><strong><?php echo $l->t('Goal:</strong> write a proposal document with a team of people, then having it reviewed by the board and approved for release');?></p>
                <p class="section--paragraph"><strong><?php echo $l->t('Tools:</strong> Files, Talk, Groupware, Collabora Online, tags, comments, groups, dashboard, Circles, Guests');?></p>
	...
	<div class="container">
        <div class="row">
            ...
            <div class="col-md-6 feature--block">
                ...
                <p class="section--paragraph"><i class="fa-key fa"></i> <?php echo $l->t('we follow industry best practices around security (aligned to');?> <a class="hyperlink" href="https://en.wikipedia.org/wiki/ISO/IEC_27001:2013">ISO27001</a>)</p>
                <p class="section--paragraph"><i class="fa-key fa"></i> <?php echo $l->t('we offer some of the');?> <a class="hyperlink" href="https://nextcloud.com/blog/introducing-the-nextcloud-bug-bounty-program/" target="_blank"><?php echo $l->t('highest open source security bug bounties');?></a></p>
                <p class="section--paragraph"><?php echo $l->t('');?></p>
                <p class="section--paragraph"><i class="fa-key fa"></i> <?php echo $l->t('we integrate unique in-transit, server-side and client-side end-to-end encryption technologies.');?></p>
                <p class="section--paragraph"><?php echo $l->t('');?></p>
...
<div class="container-fluid quote">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <p class="text-center"><?php echo $l->t('Efficient and secure team productivity with the content collaboration platform from the market leader.');?></p>
                <p class="text-center"><?php echo $l->t('Contact us to learn how we can help you.');?></p>
				<div class="text-center morebuttondiv">
					<a href="https://www.fgts.ru/collection/nextcloud" class="overlay-trigger button button--large button--arrow"><?php echo $l->t('Contact Factor Group');?></a>
				</div>
            </div>
        </div>
	</div>
...
<div class="container">
    <h1 class="section--heading-1 text-center"><?php echo $l->t('What sets Nextcloud Enterprise apart');?></h1>
    <div class="row feature-row">
        <div class="col-md-6 image--floated">
        ...
        <div class="col-md-6 feature--block">
            ...
            <p class="section--paragraph"><?php echo $l->t('Only a real enterprise solution guarantees your success!');?></p>
        </div>
    </div>
