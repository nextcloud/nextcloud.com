	...
	<div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <a class="button button--white button--small" href="<?php echo home_url('buy') ?>"><?php echo $l->t('get a quote');?></a></a>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
                ...
                <div class="line"></div>
				<div class="downarrow"><a href="#nce_for_community" data-toggle="collapse"><h3><?php echo $l->t('What does Nextcloud Enterprise mean for private users?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#what_I_get" data-toggle="collapse"><h3><?php echo $l->t('What does the subscription give me?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#languages" data-toggle="collapse"><h3><?php echo $l->t('In what languages do I get support?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#branding" data-toggle="collapse"><h3><?php echo $l->t('What branding support do I get?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#support_team" data-toggle="collapse"><h3><?php echo $l->t('Where is your support team?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#qa_team" data-toggle="collapse"><h3><?php echo $l->t('Where is your qa/testing team?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#pricing" data-toggle="collapse"><h3><?php echo $l->t('Nextcloud is open source, what is behind your prices?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#howbuy" data-toggle="collapse"><h3><?php echo $l->t('How do I buy Nextcloud subscriptions?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="downarrow"><a href="#why_opensource" data-toggle="collapse"><h3><?php echo $l->t('Why is Nextcloud Open Source?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#gpl" data-toggle="collapse"><h3><?php echo $l->t('What does the Open Source License mean?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#opencore" data-toggle="collapse"><h3><?php echo $l->t('Would a proprietary license not be better?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#sourcerelease" data-toggle="collapse"><h3><?php echo $l->t('Do I have to release the source code of systems Nextcloud connects to?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#logos" data-toggle="collapse"><h3><?php echo $l->t('Are my logos or the company name affected by the AGPL?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="downarrow"><a href="#pubsource" data-toggle="collapse"><h3><?php echo $l->t('Do I need to publish the source code if I use Nextcloud?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="downarrow"><a href="#migration" data-toggle="collapse"><h3><?php echo $l->t('How difficult is migration from ownCloud?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#partner" data-toggle="collapse"><h3><?php echo $l->t('How do I become a Nextcloud partner?');?></h3><span class="icon-arrow-down"></a></div>
				...
				<div class="line"></div>
				<div class="downarrow"><a href="#sellapp" data-toggle="collapse"><h3><?php echo $l->t('Can I sell my Nextcloud App?');?></h3><span class="icon-arrow-down"></a></div>
