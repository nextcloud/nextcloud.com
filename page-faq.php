...
<ul>
	<li>Nextcloud can run on Raspberry Pi like development boards but is certainly not limited to low-end hardware. Worlds' largest on-premise cloud deployment services <a href="https://nextcloud.com/sciebo-germanys-largest-cloud-project-500000-users-launches-today/" target="_blank">500,000 students on Nextcloud</a> and terabytes of data are shared through Nextcloud at organizations like the  <a href="http://cernbox.web.cern.ch/" target="_blank">atom smashers at CERN</a>. Nextcloud founder Frank Karlitschek wrote a <a href="http://karlitschek.de/2015/03/scaling/" target="_blank">post about the scalability of Nextcloud</a>.</li>
