<head>
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/pages/globalscale.css?v=1" rel="stylesheet">
...
<section class="section--scalability">
	<div class="container">
		...
		<p class="section--intro text-center revealOnScroll"><?php echo $l->t('It is hard to scale typical on-premises file sync & share architectures over a hundred thousand users. The shared components like storage, database and load balancers become expensive bottlenecks.');?></p>
