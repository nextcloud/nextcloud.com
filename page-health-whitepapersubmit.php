...
<div class="background healthcare-background">
	<div class="container">
		<div class="row">
...
// the app review mailing list address
	...
	$email_subject = "Industry analysis download";
    $email_message .= "\n";
    $email_message .= "Thank you for your interest in our Industry Analysis!"."\n\n";
    $email_message .= "You can download the analysis here:"."\n";
    $email_message .= "https://nextcloud.com/wp-content/themes/next/assets/files/Db2s23nL/healthcare-analysis.pdf"."\n\n";
...
// Third email to subscribe to the mailing list
 ...
 ?>
    ...
    <section class="section--whitepaper">
        <div class="container text-center">
            <h3>Thank you for your interest in our Industry Analysis</h3>
            <p>The Industry Analysis has been sent to <?php echo($email_to); ?>,</p>
