<head>
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/pages/home.css?v=12" rel="stylesheet">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 toptext ">
				<a class="announcement" href="https://nextcloud.com/blog/nextcloud-hub-20-debuts-dashboard-unifies-search-and-notifications-integrates-with-other-technologies/">
				<span class="type">News</span>
				<span class="message"><strong><?php echo $l->t('Nextcloud 20');?>:</strong> <?php echo $l->t('Dashboard, unified search, integration with third party platforms and more!');?></span>
				...
				<a class="button button--large button--arrow button--white" href="https://try.nextcloud.com" role="button" id="get-nextcloud-button"><?php echo $l->t('Try Nextcloud now');?></a>
			</div>
...
<div class="calltoaction">
	...
	<a href="<?php echo home_url('compare') ?>" class="button button--blue button--arrow button--large"><?php echo $l->t('Compare Nextcloud to other solutions like Office 365');?></a></p>
</div>
</section>
