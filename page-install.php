...
<div class="row">
  <div class="col-md-3">
    <hr class="narrow"></hr>
    <div class="numbadge centre"><i class="icon-download"></i></div>
    <h2>Get Nextcloud Server</h2>
    <p>Set up a server for yourself<!--, deploy to the cloud or find a provider-->:</p>
    <div class="btn-group">
	...
	<br />
	<a class="label label-blue" role="button" href="#instructions-server" rel="tooltip" title="Install instructions" id="server" data-toggle="popover">Details</a>
<!--       <a class="btn btn-default btn-lg" role="button" href="/hardware-TBD">Servers</a> - disabled for now, until we have a page like that... -->
  ...
  <div class="col-md-3">
    <hr class="narrow"></hr>
    <div class="numbadge centre"><i class="icon-refresh"></i></div>
    <h2>Sync your data</h2>
    <p>Connect to your Nextcloud with our Android client<!--clients for your devices-->:</p>
...
<!--   <div class="col-md-4"> -->
<!--     <hr class="narrow"></hr> -->
<!--     <div class="numbadge centre"><i class="icon-book"></i></div> -->
...
<!--   </div> -->
  <div class="col-md-3">
	<div class="numbadge centre"><i class="icon-comment"></i></div>
    <h2>Need help?</h2>
    <p>Discuss using, installing or maintaining Nextcloud in our support channels.</p>
    <ul>
    ...
    <p>These consist of users helping each other. Consider helping out others, too! <a href="/enterprise">Need enterprise support?</a></p>
<!--     <p>Find <a href="/support" target="_blank" rel="tooltip" title="An overview of where to find help">more support resources here</a>.</p> -->
  </div>
  <div class="col-md-3">
	<div class="numbadge centre"><i class="icon-rocket"></i></div>
<h2>Get Involved</h2>
    <p>If you want to help out with <a href="<?php echo $DOCUMENTATION_DEVELOPER; ?>" target="_blank" rel="tooltip" title="Developer Documentation">developing</a> and <a href="<?php echo $DOCUMENTATION_DEVELOPER; ?>testing/index.html" target="_blank"  rel="tooltip" title="Testing Documentation">testing</a>, grab a daily build.</p>
