...
<section class="section-jobs-opening">
	...
	<!-- 	<p>We have the following job openings:</p> -->
		...
		<div id="qtdev" class="collapse">
			...
			<p>You would work with the engineering team to bring new features and improvements to our client for Windows, Linux and Mac. You ideally have open source experience, know your way around git and Github and live in or close to the CET timezone.</p>
			<p>Responsibilities:</p>
			<ul>
		...
		<div id="phpdev" class="collapse">
			...
			<p>You would work with the engineering team to bring new features and improvements to the server back-end like new authentication or storage mechanisms, audio/video chat and more. You ideally have open source experience, know your way around git and Github and live in or close to the CET timezone.</p>
			<p>Responsibilities:</p>
			<ul>
		...
		<div id="androiddev" class="collapse">
			...
			<p>You would work with the engineering team to bring new features and improvements to the Android app like new authentication mechanisms, audio/video chat integration and more. You ideally have open source experience, know your way around git and Github and live in or close to the CET timezone.</p>
			<p>Responsibilities:</p>
			<ul>
		...
		<div id="iosdev" class="collapse">
			...
			<p>You would work with the engineering team to bring new features and improvements to the iOS app like new authentication mechanisms, audio/video chat integration and more. You ideally have open source experience, know your way around git and Github and live in or close to the CET timezone.</p>
			<p>Responsibilities:</p>
			<ul>
