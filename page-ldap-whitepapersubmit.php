...
// the app review mailing list address
	...
	$email_subject = "LDAP data sheet download";
    $email_message .= "\n";
    $email_message .= "Thank you for your interest in this data sheet!"."\n\n";
    $email_message .= "You can download the data sheet here:"."\n";
    $email_message .= "https://nextcloud.com/wp-content/themes/next/assets/files/Db2s23nL/ldap-datasheet.pdf"."\n\n";
...
// Third email to subscribe to the mailing list
 ...
 ?>
    ...
    <section class="section--whitepaper">
        <div class="container text-center">
            <h3>Thank you for your interest in our data sheet</h3>
            <p>The data sheet has been sent to <?php echo($email_to); ?>,</p>
