...
<div class="container">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<p class="section--paragraph"><?php echo $l->t('Our update check has noticed that your server is running PHP 5.6 or older. Nextcloud releases newer than version 13 do not support these PHP releases. We no longer provide public bug and security fixes to Nextcloud 13.');?></p>
