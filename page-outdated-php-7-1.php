...
<div class="container">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<p class="section--paragraph"><?php echo $l->t('Our update check has noticed that your server is running PHP 7.1 or older. We want to inform you that Nextcloud releases newer than version 17 will no longer support these PHP releases. It is recommended to prepare an upgrade to a newer version of PHP. We plan to maintain Nextcloud 17 publicly until shortly after Nextcloud 20 is released, which is expected for early October 2020.');?></p>
			...
			<p class="section--paragraph"><?php echo $l->t('If you are a customer and can not upgrade to a newer version of PHP between now and the end of the public Nextcloud 17 maintenance window, contact the Nextcloud support team for access to our long term support for Nextcloud 17. We are dedicated to accommodating your needs.');?></p>
