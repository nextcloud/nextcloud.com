<div class="pr">
<h1>Nextcloud Launches First Native Integrated End-to-end Encryption in Enterprise File Sync and Share Solution</h1>

<p><strong>September 27, Stuttgart.</strong> Nextcloud GmbH, the globally leading supplier of open source enterprise sync, share and communication technology, announces the availability of a preview of Nextcloud server and client components offering seamless, well-integrated end-to-end encryption in the clients. The feature offers advanced key management, easy and secure end-to-end encrypted sharing, Cryptographic Identity Protection and support for enterprise capabilities like HSM support and an offline administrator recovery key.</p>

<p><blockquote>Nextcloud is first to offer seamless, integrated end-to-end encryption in its clients as part of a complete enterprise class file sync and share solution</blockquote> said Frank Karlitschek, Managing Director of Nextcloud GmbH. <blockquote>Secure yet easy key handling between clients and users with enterprise key management and recovery options set this solution apart from others.</blockquote></p>

<p>As part of an encompassing set of unique security capabilities including leading web browser protections, brute force detection and multi-factor authentication, Nextcloud 13 will feature production ready end-to-end encryption to its clients as an option for system administrators and users. The clients will offer a per-folder capability to enable local encryption whereby all files as well as their names and metadata are securely encrypted. Advanced key handling with Cryptographic Identity Protection in the form of server signed certificates facilitates easily adding new devices and secure, end-to-end encrypted sharing with other users. Nextcloud supports an optional offline administrator recovery key and allows a complete audit log. Enterprises can optionally employ a secure HSM to to issue certificates to users.</p>

<p><blockquote>Organizations that demand the utmost security need a true enterprise solution that doesn't require users to manually exchange encryption keys and long, complex passwords or share large, encrypted volumes</blockquote> said Lukas Reschke, Security team lead at Nextcloud. <blockquote>Nextcloud 13 will be first to market with an integrated, secure technology to keep a subset of highly sensitive files cryptographically secure even in the worst case of an undetected, full server breach.</blockquote></p>
...
<p>Currently, the components are in preview state. Nextcloud would like to invite feedback on the design and current implementation at an early stage.</p>
...
<ul>
    ...
    <li><a href="https://nextcloud.com/blog/nextcloud-introducing-native-integrated-end-to-end-encryption">Release blog</a></li>
    <li><a href="https://nextcloud.com/endtoend">Webpage with information and whitepaper download</a></li>
    <li><a href="https://github.com/nextcloud/end_to_end_encryption_rfc">Github repository with draft of design</a></li>
    <li><a href="https://github.com/nextcloud/end_to_end_encryption">End-to-end Encryption Server app in github</a></li>
    <li><a href="https://nextcloud.com/press/pr20170927/">Press release</a></li>
</ul>
Users can read in our release blog where to get the Android, desktop and iOS apps for testing.
<br />
</p>
