...
Greatest momentum compared to other players in the self-hosted Enterprise File Sync and Share market according to Google Trends, which measures search volume and, by proxy, interest in products: <a href="https://trends.google.com/trends/explore?date=2016-01-01%202018-01-05&q=owncloud,nextcloud,sharefile,Egnyte,Accellion">Google Trends</a></p>

<img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/assets/img/screenshots/google-trends.png" />
<p>Screenshot from Google Trends on Thursday, January 11 0:30AM showing Nextcloud momentum over the last 18 months since its founding</p>
