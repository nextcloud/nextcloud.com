<head>
    ...
    <meta itemprop="image" content="https://nextcloud.com/media/development-growth-from-cauldron.io-project-3638.png">
    <meta name="twitter:image" content="https://nextcloud.com/media/development-growth-from-cauldron.io-project-3638.png">
    <meta name="twitter:image:src" content="https://nextcloud.com/media/development-growth-from-cauldron.io-project-3638.png">
    <meta property="og:image" content="https://nextcloud.com/media/development-growth-from-cauldron.io-project-3638.png">
</head>
...
<h1>German government funds first open source personal health data store</h1>
<h3>Nextcloud app offers counter-model to new wave of solutions that have their revenue models based on selling of data</h3>
<p><em>Stuttgart, April 21th 2021</em> - Nextcloud and Kailona introduce a health care app funded by the German Federal Ministry of Education and Research (BMBF) through the Prototype Fund. The app offers the first health and lifestyle data storage alternative and puts people in control over data sharing. As EU health care providers adapt to new technologies and government requirements, a wave of new apps offer to store health care data though business models aimed at monetizing the data by or with insurance and pharmaceutical companies. Kailona provides open source health information technology to protect people from data exploitation, give them control over their health and lifestyle data, and improve the health of individuals and societies. Kailona is already available to tens of thousands of users at providers in Europe and Asia through the Nextcloud Simple Signup program, with four major providers committed to give users free access to an account with the app available. More providers are expected to join shortly.</p>
<blockquote>Nobody chooses to get sick, so nobody should be discriminated against on the basis of their health data. We aim to put people back in control over their health data, rather than have it be exploited for economic gain.</blockquote>
<p>-- Armin Moehrle, managing director and founder at Kailona</p>
<p>Health care providers in most countries are obliged to provide patients timely access to their health records. Germany in particular requires health care providers to support an electronic patient dossier (ePA) since January 2021. Supporting this standard, Kailona provides a mechanism for patients to request their health records and keep track of compliance with the legislative requirements of the providers.</p>
<p>Users can use the data to gain insight in their own health and securely share portions of their health data with others including family and friends, researchers (in an anonymous fashion) or health care providers. Kailona empowers users to control access to their health data for their own benefit, their communities and society at large.</p>
<blockquote>Health care data is the most valuable, private and most abused kind of information and the vast majority of people has neither the means nor knowledge to protect their privacy or use the data in a productive way. The Kailona app is revolutionary in that it massively lowers the barrier and allows normal humans to not only control access to their data, but visualize, augment and benefit from it themselves.</blockquote>
<p>-- Frank Karlitschek, CEO at Nextcloud GmbH</p>
<p>In collaboration with four major Nextcloud providers, hosting.de in Germany, Tab.digital in Latvia, TheGood.Cloud in the Netherlands and Qinetics MSP in Malaysia, Kailona is now available for tens of thousands of users on fully free, easy to access accounts through the Simple Signup program of Nextcloud. Users can simply download a Nextcloud app for mobile or desktop or visit nextcloud.com/signup and in 3 simple steps gain access to a fully free account that features the health care app and can store their data safely in a data center near them.</p>
<p>For the hundreds of thousands of users that run their own Nextcloud server and the thousands of other small hosting providers and businesses offering a hosted Nextcloud, the Kailona app can be installed from the app store right now.</p>
...
<h2>Screenshots</h2>
<ul>
<li><a href="https://nextcloud.com/media/kailona-screenshot1.png">screenshot 1</a></li>
<li><a href="https://nextcloud.com/media/kailona-screenshot2.png">screenshot 2</a></li>
<li><a href="https://nextcloud.com/media/kailona-screenshot3.png">screenshot 3</a></li>
<li><a href="https://nextcloud.com/media/kailona-screenshot4.png">screenshot 4</a></li>
</ul>
...
<li>Über Kailona: <a href="https://kailona.org">kailona.org</a></li>
<li>Kailona blog about alpha release: <a href="https://nextcloud.com/blog/health-care-data-app-for-nextcloud-kailona-hits-alpha-and-is-looking-for-testers/">nextcloud.com/blog</a></li>
</ul>
<h2>Screenshots</h2>
<ul>
