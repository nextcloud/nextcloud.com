...
<a target="_blank" href="https://nextcloud.org/blog/nextcloud-server-9-0-released" class="btn btn-lg btn-default">Announcement</a>
...
<div class="row">
<!-- 	<div class="col-md-3"><a href="https://github.com/nextcloud/screenshots/archive/master.zip"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/screenshots/screenshots.png" style="width: 100%" alt="Download a zip file with screenshots" class="img-thumbnail"></a></div> -->
...
<!-- 		<div class="col-md-3"><a href="http://www.youtube.com/nextclouders"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/screenshots/youtube.png" style="width: 100%" alt="View the Nextcloud community YouTube channel" class="img-thumbnail"></a></div> -->
