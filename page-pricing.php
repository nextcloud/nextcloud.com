    ...
    <div class="row">
		<div class="col-md-4 table-column">
			<div class="table-header basic">
				...
				<h2 class="header"><?php echo $l->t('Starting at 100 users for €36/user/year');?></h2>
			</div>
			<div class="table-content">
				...
				<div class="list">
					...
					<li class="nocheck" title="<?php echo $l->t('Edit office documents collaboratively from within Nextcloud.');?>" rel="tooltip"><?php echo $l->t('<a class="hyperlink" href="https://nextcloud.com/blog/live-demo-of-hancom-works-now-available/">HANCOM Works</a>');?></li>
					<li class="nocheck" title="<?php echo $l->t('Edit office documents collaboratively from within Nextcloud.');?>" rel="tooltip"><?php echo $l->t('<a class="hyperlink" href="https://nextcloud.com/blog/ms-office-online-server-as-document-editor-in-nextcloud/">Microsoft Office Online</a>');?></li>
				...
				<div class="line"></div>
				<div class="list">
					<li class="ball" title="<?php echo $l->t('Pricing starts at 100 users. Contact us for a quote relevant for your specific market vertical.');?>" rel="tooltip"><?php echo $l->t('100 users: €36/user/year');?></li>
					<li class="ball" title="<?php echo $l->t('Contact us for a quote relevant for your specific market.');?>" rel="tooltip"><?php echo $l->t('200 users: €28,50/user/year');?></li>
		...
		<div class="col-md-4 table-column">
			<div class="table-header standard">
				...
				<h2 class=""><?php echo $l->t('Starting at 100 users for €65/user/year');?></h2>
			</div>
			<div class="table-content">
				...
				<div class="list">
                    ...
                    <li class="optional" title="<?php echo $l->t('Edit office documents collaboratively from within Nextcloud.');?>" rel="tooltip"><?php echo $l->t('<a class="hyperlink" href="https://nextcloud.com/blog/live-demo-of-hancom-works-now-available/">HANCOM Works</a>');?></li>
					<li class="nocheck" title="<?php echo $l->t('Edit office documents collaboratively from within Nextcloud.');?>" rel="tooltip"><?php echo $l->t('<a class="hyperlink" href="https://nextcloud.com/blog/ms-office-online-server-as-document-editor-in-nextcloud/">Microsoft Office Online</a>');?></li>
				...
				<div class="line"></div>
				<div class="list">
					<li class="ball" title="<?php echo $l->t('Pricing starts at 100 users. Contact us for a quote relevant for your specific market vertical.');?>" rel="tooltip"><?php echo $l->t('100 users: €65/user/year');?></li>
					<li class="ball" title="<?php echo $l->t('Contact us for a quote relevant for your specific market.');?>" rel="tooltip"><?php echo $l->t('200 users: €48.50/user/year');?></li>
					<li class="ball" title="<?php echo $l->t('Contact us for a quote relevant for your specific market.');?>" rel="tooltip"><?php echo $l->t('Additional pricing tiers are available up to millions of users');?></li>
					<li class="ball" title="<?php echo $l->t('Contact us for a quote relevant for your specific market.');?>" rel="tooltip"><?php echo $l->t('Framework agreements available');?></li>
				</div>
				<a class="button button--blue button--arrow button--large" href="<?php echo home_url('enterprise/buy') ?>" role="button" id="get-nextcloud-button"><?php echo $l->t('Request offer');?> <span class="icon-arrow"></span></a>
		...
		<div class="col-md-4 table-column highlight">
			<div class="table-header premium">
				...
				<h2 class=""><?php echo $l->t('Starting at 100 users for €95.50/user/year');?></h2>
			</div>
			<div class="table-content">
				<h1 class=""><?php echo $l->t('Features');?></h1>
				<div class="line"></div>
				...
				<div class="list">
					...
					<li class="optional" title="<?php echo $l->t('Edit office documents collaboratively from within Nextcloud.');?>" rel="tooltip"><?php echo $l->t('<a class="hyperlink" href="#featureblock-onlyoffice">ONLYOFFICE</a>');?></li>
                    <li class="optional" title="<?php echo $l->t('Edit office documents collaboratively from within Nextcloud.');?>" rel="tooltip"><?php echo $l->t('<a class="hyperlink" href="https://nextcloud.com/blog/live-demo-of-hancom-works-now-available/">HANCOM Works</a>');?></li>
					<li class="check" title="<?php echo $l->t('Edit office documents collaboratively from within Nextcloud.');?>" rel="tooltip"><?php echo $l->t('<a class="hyperlink" href="https://nextcloud.com/blog/ms-office-online-server-as-document-editor-in-nextcloud/">Microsoft Office Online</a>');?></li>
				...
				<div class="line"></div>
				<div class="list">
					<li class="ball" title="<?php echo $l->t('Pricing starts at 100 users. Contact us for a quote relevant for your specific market vertical.');?>" rel="tooltip"><?php echo $l->t('100 users: €95.50/user/year');?></li>
					<li class="ball" title="<?php echo $l->t('Contact us for a quote relevant for your specific market vertical.');?>" rel="tooltip"><?php echo $l->t('200 users: €74.50/user/year');?></li>
