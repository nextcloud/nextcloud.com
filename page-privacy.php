...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <ul>
                <li><a href="https://nextcloud.com/contribute/code-of-conduct/"><?php echo $l->t('You follow our Nextcloud community code of conduct');?></li>
                ...
                <li><?php echo $l->t('To contribute to our forums, you need an account. For that we need a real email address. You can ask us to close your accounta nd delete all private data (but not the posts, see below) any time. Use the contact form on the bottom of this page. Note that YOU are responsible for all actions taken with your account, whether authorized or not, unless you ask us to close your account or notify us it is compromised. You agree to pick a secure password and keep it safe!');?></li>
                <li><?php echo $l->t('You agree all content posted on the forums is owned by you and by posting on our forums is shared and licensed under the Attribution-ShareAlike 4.0 International license.');?> <a href="http://creativecommons.org/licenses/by-sa/4.0/">Attribution-ShareAlike 4.0 International</a></li>
                <li><?php echo $l->t('You may not break the law using the forum, use other users accounts, trade, buy or sell user names, advertise any products or use the forums to gather information for advertisement purposes. Also, you man not imply you are affiliated with or endorsed by Nextcloud GmbH or impersonate others.');?></li>
                <li><?php echo $l->t('You may not automate access to the forum or monitor it with tools like browser plug-ins, web crawlers and the like, unless it is for the purposes of a search engine. You may not circumvent security or access restrictions or try to work around our moderation efforts. Do not strain the forum with tecnical requests or requests designed to impose an unreasonable load on the forum infrastructure.');?></li>
            ...
            <p><?php echo $l->t('If you do not wish to follow those rules, please do not use our forums. We reserve the right to change, redact, and delete content on the forum for any reason.');?></p>
