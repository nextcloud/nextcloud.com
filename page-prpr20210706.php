<head>
    ...
    <meta itemprop="image" content="https://nextcloud.com/media/https://nextcloud.com/media/nextcloud-22-background.png">
    <meta name="twitter:image" content="https://nextcloud.com/media/https://nextcloud.com/media/nextcloud-22-background.png">
    <meta name="twitter:image:src" content="https://nextcloud.com/media/https://nextcloud.com/media/nextcloud-22-background.png">
    <meta property="og:image" content="https://nextcloud.com/media/https://nextcloud.com/media/nextcloud-22-background.png">
</head>
...
<div class="row">
<div class="pr">
<h1>Nextcloud Hub 22 is the digital office optimized for the post-pandemic workplace</h1>
...
<p><em>Stuttgart, July 6th, 2021</em> - Nextcloud GmbH, the company behind the worlds’ most deployed on-premises content collaboration platform, announces Nextcloud Hub 22, optimized for the modern, digital office. The release introduces user-defined groups, integrated chat and task management, an easy approval workflow and integrated PDF signing with DocuSign, EIDEasy and LibreSign. With Nextcloud Hub 22 also comes the introduction of an integrated knowledge management application with the name Collectives. There are also a series of improvements in Nextcloud Groupware.</p>
<blockquote>
<p>The last year has demanded an acceleration of digitalization in organizations and the market is moving towards more comprehensive digital collaboration solutions. Nextcloud has aligned its roadmap to the reality of new work in modern organizations, delivering the capabilities needed for the paperless office. With optimized workflows and more effective self-management for teams, Nextcloud Hub 22 will further facilitate remote work and global collaboration for teams.</p>
</blockquote>
...
<blockquote>
<p>The reality for modern organizations has shifted towards online work, which comes with two main downsides. First, the security, vendor lock-in and compliance challenges that comes with using foreign SaaS cloud solutions. And second, the use of a mishmash of poorly integrated platforms is a recipe for lost documents, version mismatches and security breaches. Nextcloud develops the most comprehensive, on-premises digital office, uniquely solving both problems at once.</p>
</blockquote>
...
<hr />
<h1>German</h1>
<h1>Nextcloud Hub 22 ist das ideale digitale Büro für die post-pandemische Arbeitswelt</h1>
...
<blockquote>
<p>Das letzte Jahr hat eine Beschleunigung der Digitalisierung in Organisationen gefordert und der Markt bewegt sich nun in Richtung umfassenderer Lösungen für die digitale Zusammenarbeit. Nextcloud hat die Roadmap auf die Realität des neuen Arbeitens in modernen Organisationen ausgerichtet und bietet die notwendigen Funktionen für das papierlose Büro. Mit optimierten Workflows und effektiverem Selbstmanagement für Teams wird Nextcloud Hub 22 die Remote-Arbeit und globale Zusammenarbeit für Teams weiter erleichtern.</p>
</blockquote>
...
<blockquote>
<p>Die Realität für moderne Organisationen hat sich in Richtung Online-Arbeit verschoben, was zwei große Nachteile mit sich bringt. Zuallererst sind da die Herausforderungen im Hinblick auf Sicherheit, Anbieterbindung und Konformität, die durch die Nutzung von fremden SaaS-Cloudlösungen entstehen. Und zweitens ist die Nutzung von verschiedensten - schlecht integrierten - Plattformen ein Garant für verlorene Dokumente, Versionsabweichungen und Sicherheitslücken. Nextcloud entwickelt die vollumfassendste On-Premises-Lösung für Ihr digitales Büro und löst damit auf einzigartige Weise beide Herausforderungen auf einmal.</p>
</blockquote>
