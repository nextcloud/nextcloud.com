		...
		<div class="col-md-10 col-md-offset-1">
			...
			<ul>
				...
				<ul>
					...
					<?php echo $l->t('Nextcloud has extensive LDAP/Active Directory support with an easy installation wizard, supporting password policies, user cleanup and more.');?></li>
					<li>Kerberos</br>
