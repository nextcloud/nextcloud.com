    ...
    <div class="row revealOnScroll">
        <div class="col-md-10 col-md-offset-1">
            ...
            <p class="section--paragraph">
                ...
                Our solution is built around combined assurance layers consisting of newly applied rich security features,
                applied best practices which are governed by policy and the design itself validated by industry standard
                testing processes.');?>
            </p>
        </div>
    </div>
...
<div class="container featureblock featureblock--has-separator">
    <div class="row">
        ...
        <div class="features--container revealOnScroll row">
            ...
            <div class="col-md-4">
                <div class="feature">
                    <?php echo file_get_contents(get_template_directory_uri()."/assets/img/icons/tools.svg"); ?>
            ...
            <div class="container featureblock featureblock--has-separator">
                ...
                <div class="features--container row revealOnScroll">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="feature">
                                <?php echo file_get_contents(get_template_directory_uri()."/assets/img/icons/ldap.svg"); ?>
                ...
                <div class="row">
                    <div class="features--container revealOnScroll">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <?php echo file_get_contents(get_template_directory_uri()."/assets/img/icons/permissions.svg"); ?>
