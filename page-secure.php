...
<div class="container featureblock">
	...
	<div class="row">
		<div class="features--container revealOnScroll">
			<div class="col-md-6">
				<div class="feature">
				<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/monitoring.svg">
			...
			<div class="col-md-6">
				<div class="feature">
					<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/encryption.svg">
				...
				<div class="feature">
					<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/virusscaning.svg">
					...
					<div class="info">
						<div class="col-md-6">
							...
							<ul class="securitybadge">
								<li><a href="https://bestpractices.coreinfrastructure.org/projects/209"><img class="" src="https://bestpractices.coreinfrastructure.org/assets/questions_page_badge-17b338c0e8528d695d8676e23f39f17ca2b89bb88176370803ee69aeebcb5be4.png"></a>
									...
									<li>
											<a href="<?php echo get_template_directory_uri(); ?>/assets/files/veracode_report.pdf"><img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/security/veracode-doc.png"></a>
									...
									<li>
											<a href="<?php echo get_template_directory_uri(); ?>/assets/files/NCC_report_full.pdf"><img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/security/ncc-doc.png"></a>
...
<div class="container featureblock">
	...
	<div class="row">
		<div class="features--container revealOnScroll">
			<div class="col-md-6">
				<div class="feature">
					<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/verified-security.svg">
...
<div class="container featureblock">
		...
		<div class="features--container revealOnScroll">
			<div class="col-md-6">
				<div class="feature">
					...
					<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/vault.svg">
	...
	<div class="row revealOnScroll">
		...
		<div class="col-md-6">
			<div class="feature">
				<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/keys.svg">
...
<div class="container featureblock">
	...
	<div class="row revealOnScroll">
		<div class="col-md-6">
			<div class="feature">
				<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/find-data.svg">
				...
				<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/camera.svg">
		...
		<div class="col-md-6">
			<div class="feature">
				<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/check-lock.svg">
