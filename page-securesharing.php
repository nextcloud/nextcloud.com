...
<div class="container">
	<div class="row revealOnScroll">
		<div class="col-md-8 col-md-offset-2">
			<p class="section--paragraph text-center">A recent Forrester report notes that unsecured and uncontrolled sharing of data opens the door to loss of version control, auditability, and control over innovative IP.</p>
		</div>
	</div>
	<div class="row revealOnScroll">
		<div class="col-md-8 col-md-offset-2">
...
<div class="container">
	<div class="row revealOnScroll">
			<p class="section--paragraph">Forrester urges senior corporate management and IT professionals to shift away from ad-hoc solutions like email, outdated technologies like FTP or customer-grade file sync and share. Key requirements for a solution include:
			<ul>
	...
	<div class="row revealOnScroll">
		<h3>Concerns</h3>
		<p class="section--paragraph">With 72% of the respondents agreeing with the statement, a key concern cited is the creation of new content silos. Having to migrate data and manage it in a new location, the goals of simplifying work flows while strengthening governance will not be achieved.</p>
