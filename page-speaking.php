...
<div class="row">
	...
	<p>Let's say, for example, we talk about our web application - Nextcloud. We want people to try it out, and we want to tell them three things about Nextcloud:
	<ul>
		<li><em>It matters</em></li>
		<li><em>It helps YOU</em></li>
		<li><em>It is easy</em></li>
	</ul>
	Another example, if you talk about the Nextcloud project:
	<ul>
	...
	<p>It is important to be well prepared with a stable, known-working setup. Updating your Linux to an unstable tree an hour before presenting isn't wise! Make sure you have the slides on both your laptop <em>and</em> on a USB stick. And perhaps one more time on your Nextcloud instance!</p>
