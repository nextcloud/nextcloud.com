...
<section class="section--whitepaper">
    <div class="container text-center">
        <h3>Thank you for your interest in our data sheets</h3>
        <p>The data sheets have been sent to <?php echo($email_to); ?>,</p>
...
<section class="section--whitepaper">
    <div class="container text-center">
        ...
        <p>Use the back key to go to the previous page and enter your email address to receive your data sheets!</p>
    </div>
</section>
<?php
}
