...
<p><?php echo $l->t('You can ask for help in our community support channels:');?></p>
	<ul>
	    ...
	    <li><?php echo $l->t('Finally, you could report a issue at our <a href="https://github.com/nextcloud/server/blob/master/.github/CONTRIBUTING.md" target="_blank">bug trackers</a> if you think you found a bug in Nextcloud itself');?></li>
	</ul>
