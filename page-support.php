...
<p><!--If you can not find the answers you are looking for <a href="https://doc.nextcloud.org" target="_blank">in our documentation</a> or our <a href="/faq" target="_blank">Frequently Asked Questions</a>, you can find help in our support channels.--> Depending on what you use Nextcloud for and how you use it, you can find resources in different places.</p>
  <table class="table table-striped">
    ...
    <tr>
      ...
      <td class="warning">We're working on this! Stay tuned.
      <!--There is a lot of content online about installing Nextcloud. Much can be found using the old name (ownCloud). There is a list on <a href="https://github.com/owncloud/core/wiki/Reviews-tutorials-and-videos-of-owncloud"  target="_blank">this ownCloud wiki page</a> and the old ownCloud <a href="https://www.youtube.com/playlist?list=PLtZe22ggl2YBi1u2dH0qg9fgnym5DwYbW" target="_blank">YouTube channel collects video tutorials</a> but if what you are looking for is not there, a <a href="https://www.google.com/search?q=owncloud+installation+tutorial" target="_blank">search engine</a> can find them easily.-->
      </td>
      <td class="warning">We are turning our Nextcloud expertise into documentation about deployment and management. This will be put online the coming months.
<!--       Nextcloud.com has a <a href="https://nextcloud.com/resources/" target="_blank">Resources section</a> with <a href="http://nextcloud.com/whitepapers" target="_blank">whitepapers</a>, <a href="https://nextcloud.com/webinars" target="_blank">webinars</a> and more. If you want to evaluate if Nextcloud offers what you need in your enterprise environment, check out the <a href="https://nextcloud.com/datasheets/" target="_blank">Data sheets</a>. -->
      </td>
    </tr>
    <tr>
	...
	<ul>
	    ...
	    <ul>
<!--		<li>Note: The Nextcloud forums have a <a href="https://forum.nextcloud.org/viewforum.php?f=17" target="_blank">special FAQ page</a> where each topic corresponds to typical mistakes or frequently occurring issues</li>-->
	    </ul>
...
<!-- 	    <li>You can ask over our social media, including in the <a href="https://plus.google.com/communities/101550101068949663712" target="_blank">Nextcloud Google Plus community</a>, the <a href="https://www.facebook.com/Nextclouders" target="_blank">Facebook page</a> or on <a href="https://twitter.com/search?q=%23nextcloud&src=typd" target="_blank">Twitter</a></li> -->
...
<!-- 	    <li>Finally, you could report a issue at our <a href="https://github.com/nextcloud/core/blob/master/CONTRIBUTING.md#submitting-issues" target="_blank">bug trackers</a> if you think you found a bug in Nextcloud itself</li> -->
			<li>We're creating more resources while we prepare our first Nextcloud release.<!-- Until then, we suggest to check out the ownCloud-based resources.--></li>
	</ul>
	<p>Please understand that all these channels essentially consist of users like you helping each other out. Consider helping others out where you can, to contribute back for the help you get. This is the only way to keep a community like Nextcloud healthy and sustainable!</p>
      ...
      <td class="warning"><p>We provide you the support you need to meet your business requirements. See <a href="/enterprise">here for more information</a>.</p>
<!--       <p>Find what you need to tune Nextcloud performance and meet business requirements in our <a href="http://doc.nextcloud.org" target="_blank">documentation</a> as well as the <a href="https://nextcloud.com/resources/" target="_blank">other self-help resources</a> provided by Nextcloud GmbH.</a> -->
		<!--<ul>
