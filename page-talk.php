...
<div class="container">
	...
	<div class="row">
		<div class="col-md-6  image--floated  image--feature new-img">
			<a target="_blank" href="<?php bloginfo('template_directory'); ?>/assets/img/features/Talk_upload.gif"><img src="<?php bloginfo('template_directory'); ?>/assets/img/features/Talk_upload.gif" class="img-responsive featureimg" alt="<?php echo $l->t('Dropping a file in a call in Talk');?>" /></a>
		</div>
        <div class="col-md-6">
	...
	<div class="row">
		<div class="col-md-6  image--floated  image--feature new-img">
            <a target="_blank" href="<?php bloginfo('template_directory'); ?>/assets/img/features/Talk_settings.png"><img src="<?php bloginfo('template_directory'); ?>/assets/img/features/Talk_settings.png" class="img-responsive featureimg" /></a>
		</div>
        <div class="col-md-6">
