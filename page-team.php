	...
	<div class="col-md-4">
		<div class="teamp">
			...
			<div class="teammeta">
				...
				<h4 class="teamexpertise">Founder</h4>
				<h4 class="teamlocation">lives in Stuttgart, Germany</h4>
				<p class="teamsocial"><!--<a href="https://spreed.me/"><i class="icon-rss icon"></i></a>--> <!--<a href="https://github.com/"><i class="icon-github icon"></i></a>--> <a href="https://twitter.com/nielsmache"><i class="icon-twitter icon"></i></a> </p>
			</div>
	...
	<div class="col-md-4">
		<div class="teamp">
			...
			<div class="teammeta">
				...
				<h4 class="teamlocation">lives in Stuttgart, Germany</h4>
				<p class="teamsocial"><!--<a href="http://blog.jospoortvliet.com/"><i class="icon-rss icon"></i></a>--> <!--<a href="https://github.com/jospoortvliet"><i class="icon-github icon"></i></a>--> <!--<a href="https://twitter.com/vanesteeg"><i class="icon-twitter icon"></i></a>--> &nbsp;</p>
			</div>
	...
	<div class="col-md-4">
		<div class="teamp">
			...
			<div class="teammeta">
				...
				<h4 class="teamlocation">lives in Stuttgart, Germany</h4>
				<p class="teamsocial"><a href="https://www.xing.com/profile/Brian_Krause"><i class="icon-xing icon"></i></a> <!--<a href="https://github.com/longsleep"><i class="icon-github icon"></i></a> <a href="https://twitter.com/rullzer"><i class="icon-twitter icon"></i></a>--></p>
			</div>
	...
	<div class="col-md-4">
		<div class="teamp">
			...
			<div class="teammeta">
				...
				<h4 class="teamlocation">lives in Berlin, Germany</h4>
				<p class="teamsocial"><a href="https://arthur-schiwon.de"><i class="icon-rss icon"></i></a> <a href="https://github.com/blizzz"><i class="icon-github icon"></i></a> <!--<a href="https://twitter.com/blizzz"><i class="icon-twitter icon"></i></a>--> </p>
			</div>
	...
	<div class="col-md-4">
		<div class="teamp">
			...
			<div class="teammeta">
				...
				<p class="teamsocial"><a href="http://rullzer.com/"><i class="icon-rss icon"></i></a> <a href="https://github.com/rullzer"><i class="icon-github icon"></i></a> <a href="https://twitter.com/rullzer"><i class="icon-twitter icon"></i></a> </p>
			</div>
