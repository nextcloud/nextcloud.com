		...
		<div class="teamp">
		 &nbsp;
			...
			<div class="teammeta">
				...
				<p class="teamsocial"><a href="https://karlitschek.de/"><i class="icon-rss icon"></i></a> <a href="https://github.com/karlitschek"><i class="icon-github-alt icon"></i></a> <a href="https://twitter.com/fkarlitschek"><i class="icon-twitter icon"></i></a> </p>
			</div>
	...
	<div class="col-md-4">
		...
		<div class="teamp">
			...
			<div class="teammeta">
				...
				<h4 class="teamexpertise">Founder</h4>
				<h4 class="teamlocation">lives in Stuttgart, Germany</h4>
				<p class="teamsocial"><!--<a href="https://spreed.me/"><i class="icon-rss icon"></i></a>--> <!--<a href="https://github.com/"><i class="icon-github-alt icon"></i></a>--> <a href="https://twitter.com/nielsmache"><i class="icon-twitter icon"></i></a> </p>
			</div>
			<p class="teamdescription">Currently managing director at <a href="http://www.struktur.de/">Struktur AG</a> and Nextcloud GmbH, Niels Mache was a co-founder of delix GmbH, one of the first Linux service providers, and of Red Hat Deutschland GmbH. During this time he led Red Hat Deutschland's development department as Director of Development, among other positions.</p>
		</div>
	</div>
	<div class="col-md-4">
		 &nbsp;
		<div class="teamp">
			...
			<p class="teamdescription">Andreas Rode is awesome.</p>
		</div>
	</div>
</div>
<div class="row">
		...
		<div class="teamp">
		 &nbsp;
			...
			<div class="teammeta">
				...
				<h4 class="teamexpertise">LDAP and Sharepoint maintainer</h4>
				<h4 class="teamlocation">lives in Berlin, Germany</h4>
				<p class="teamsocial"><a href="https://arthur-schiwon.de"><i class="icon-rss icon"></i></a> <a href="https://github.com/blizzz"><i class="icon-github-alt icon"></i></a> <a href="https://twitter.com/blizzz"><i class="icon-twitter icon"></i></a> </p>
			</div>
			<p class="teamdescription">Arthur Schiwon has been working on Nextcloud since 2010, developing state of the art user management and directory support. He has been SEO project manager at construktiv and is an active member at the (german speaking) Kubuntu community.</p>
		</div>
	</div>
	<div class="col-md-4">
		 &nbsp;
...
<div class="row">
	...
	<div class="col-md-4">
		...
		<div class="teamp">
			...
			<p class="teamdescription">open source designer, adviser & educator - need more ;-)</p>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-md-4">
		...
		<div class="teamp">
			...
			<div class="teammeta">
				...
				<h4 class="teamexpertise">Marketing & communication</h4>
				<h4 class="teamlocation">lives in Berlin, Germany</h4>
	...
	<div class="col-md-4">
		...
		<div class="teamp">
			...
			<div class="teammeta">
				...
				<h4 class="teamlocation">lives in Stuttgart, Germany</h4>
				<p class="teamsocial"><!--<a href="http://blog.jospoortvliet.com/"><i class="icon-rss icon"></i></a>--> <!--<a href="https://github.com/jospoortvliet"><i class="icon-github-alt icon"></i></a>--> <!--<a href="https://twitter.com/vanesteeg"><i class="icon-twitter icon"></i></a>--> &nbsp;</p>
			</div>
	...
	<div class="col-md-4">
		...
		<div class="teamp">
			...
			<div class="teammeta">
				...
				<p class="teamsocial"><a href="http://rullzer.com/"><i class="icon-rss icon"></i></a> <a href="https://github.com/rullzer"><i class="icon-github-alt icon"></i></a> <a href="https://twitter.com/rullzer"><i class="icon-twitter icon"></i></a> </p>
			</div>
			<p class="teamdescription">Roeland is awesome.</p>
		</div>
	</div>
	<div class="col-md-4">
		 &nbsp;
...
<div class="row">
	<div class="col-md-4">
		...
		<div class="teamp">
			...
			<p class="teamdescription">Morris Jobke is awesome.</p>
		</div>
	</div>
	<div class="col-md-4">
		 &nbsp;
