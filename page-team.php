    ...
    <div class="row">
		...
		<div class="col-md-4">
			<div class="teamp">
				...
				<p class="teamdescription">Lukas has been contributing to ownCloud since 2012 and is responsible for many of the security hardenings in the code. He has worked as security assessment and forensic investigator, reviewing security, giving trainings and dealing with breaches at Fortune 500 companies and several of the largest Swiss financial institutes as well as Facebook.</p>
			</div>
		</div>
		<div class="col-md-4">
			<div class="teamp">
