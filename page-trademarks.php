...
<p>Nextcloud and the Nextcloud Logo is a registered trademark of <a href="http://nextcloud.com" target="_blank">Nextcloud, GmbH</a> in the Germany, other countries or both.</p>

<p>These guidelines cover the following marks pertaining both to the product name and the logo: Nextcloud and the blue/white cloud logo with or without the word Nextcloud. This set of marks is collectively referred to as the "Nextcloud Marks." Please note that use of the white/orange/blue cloud logo is used exclusively by Nextcloud, GmbH and its approved partners and is therefor not covered under these guidelines. Any permission for usage of that particular logo must be granted explicitly by Nextcloud, GmbH whom you can contact at at <a href="/contact" target="_blank">our contact page</a>.</p>
