<head>
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/pages/whitepapers.css?v=2" rel="stylesheet">
...
<!--        <div class="col-md-3">
            ...
            <div class="row">
				<div class="description">
					<h3 class="section--paragraph__title"><?php echo $l->t('Stadtsparkasse Munich Switches to Local Cloud');?></h3>
                    <p class="section--paragraph"><?php echo $l->t('Nextcloud partner HNK has provided this Munich city bank with a secure, compliant collaboration platform.');?></p>
                </div>
        ...
        <div class="col-md-3">
            ...
            <div class="row">
				<div class="description">
                    ...
                    <a style="margin-top: 115px" class="button button--blue button--small" href="https://www.hackerone.com/resources/nextcloud-puts-hacker-powered-security-front-and-center"><?php echo $l->t('Download');?></a>
			</div>
		</div>
        <div class="col-md-3">
            <div class="row wpthumbnail">
...
<!--                         <input type="checkbox" name="newsletter" value="1"> <small>Sign me up for the Nextcloud newsletter</small><br/> -->
	...
	<div class="row list">
		<div class="col-md-3">
            ...
            <div class="row">
				<div class="description">
					<h3 class="section--paragraph__title"><?php echo $l->t('Workflows and Access Control');?></h3>
