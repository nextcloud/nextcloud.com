...
<!--                         <input type="checkbox" name="newsletter" value="1"> <small>Sign me up for the Nextcloud newsletter</small><br/> -->
        ...
        <div class="col-md-3">
            ...
            <div class="row">
				<div class="description">
					<h3 class="section--paragraph__title"><?php echo $l->t('Nextcloud for 33K middle school students in France');?></h3>
                    <p class="section--paragraph"><?php echo $l->t('SIB offers digital services that supports over 500 healthcare structures and public entities in France. Learn about their deployment of Nextcloud in middle schools (French version).');?></p>
                </div>
                <form name="whitepaper" method="post" action="<?php echo home_url('whitepaper-submit') ?>">
