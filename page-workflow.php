<div class="featurerow">
	<h1 class="featuretitle">File Access Control and Monitoring</h1>
	<div class="row">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<p class="">The Workflow engine expands these capabilities, enabling administrators to start any kind of actions based on these triggers, for example converting certain file types to PDF upon upload or emailing files put in a specified folder with a given tag to a given mail address.</p>
...
<!-- 		<a href="https://www.youtube.com/watch?v=9-JEmlH2DEg" target="_blank" style="border: none;"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/federation/federation.gif" alt="in action" /></a> -->
	...
	<div class="col-md-8">
		...
		<p>The <a href="http://opennms.org/">openNMS monitoring app</a> has already support for monitoring Nextcloud 10 systems and the template can be easily modified for other tools like Nagios.</p>
	</div>
</div>
