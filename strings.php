...
/* VERSIONS */
$VERSIONS_SERVER_MAJOR_STABLE = '17';
$VERSIONS_SERVER_FULL_STABLE = '17.0.1';
$VERSIONS_SERVER_MAJOR_DEVELOPMENT = '18.0.0';
$VERSIONS_SERVER_MAJOR_DEV_DOCS = '17'; // Used in dev docs links
$VERSIONS_CLIENT_DESKTOP_STABLE_FULL = '2.6.1';
...
$DOWNLOAD_CLIENT_DESKTOP_STABLE_WIN = $DOWNLOAD_CLIENT_DESKTOP_BASE.'Windows/Nextcloud-2.6.1-setup.exe';
$DOWNLOAD_CLIENT_DESKTOP_STABLE_MAC = $DOWNLOAD_CLIENT_DESKTOP_BASE.'Mac/Installer/Nextcloud-2.6.1.20191105.pkg';
$DOWNLOAD_CLIENT_DESKTOP_STABLE_MAC_LEGACY = $DOWNLOAD_CLIENT_DESKTOP_BASE.'Mac/Installer/Nextcloud-2.6.1.20191104-legacy.pkg';
$DOWNLOAD_CLIENT_DESKTOP_STABLE_LINUX = $DOWNLOAD_CLIENT_DESKTOP_BASE.'Linux/Nextcloud-2.6.1-x86_64.AppImage';
...
$VERSIONS_CLIENT_DESKTOP_TESTING = '2.6.1RC1';
$DOWNLOAD_CLIENT_DESKTOP_TEST_BASE= 'https://download.nextcloud.com/desktop/prereleases/';
$DOWNLOAD_CLIENT_DESKTOP_TEST_WIN = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'Windows/Nextcloud-2.6.1.5929-rc1-20191018.exe';
$DOWNLOAD_CLIENT_DESKTOP_TEST_MAC = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'Mac/Nextcloud-qt5.12.5-2.6.1.20191018rc1.pkg';
$DOWNLOAD_CLIENT_DESKTOP_TEST_LINUX = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'Linux/Nextcloud-2.6.1.20191018-rc1-x86_64.AppImage';
...
$SERVER_TESTING_VERSION ='17 beta 4'; // nothing to test -> leave it empty
$DOWNLOAD_SERVER_TAR_TESTING ='https://download.nextcloud.com/server/prereleases/nextcloud-17.0.0beta4.tar.bz2';
$DOWNLOAD_SERVER_ZIP_TESTING ='https://download.nextcloud.com/server/prereleases/nextcloud-17.0.0beta4.zip';
