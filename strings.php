...
$VERSIONS_SERVER_FULL_STABLE = '12.0.0';
...
$SERVER_TESTING_VERSION ='12.0.1RC4'; // nothing to test -> leave it empty
$DOWNLOAD_SERVER_TAR_TESTING ='https://download.nextcloud.com/server/prereleases/nextcloud-12.0.1RC4.tar.bz2';
$DOWNLOAD_SERVER_ZIP_TESTING ='https://download.nextcloud.com/server/prereleases/nextcloud-12.0.1RC4.zip';
