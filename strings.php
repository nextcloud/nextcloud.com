...
/* VERSIONS */
$VERSIONS_SERVER_MAJOR_STABLE = '18';
$VERSIONS_SERVER_FULL_STABLE = '18.0.1';
$VERSIONS_SERVER_MAJOR_DEVELOPMENT = '18.0.1';
$VERSIONS_SERVER_MAJOR_DEV_DOCS = '18'; // Used in dev docs links
$VERSIONS_CLIENT_DESKTOP_STABLE_FULL = '2.6.3';
...
$VERSIONS_CLIENT_DESKTOP_TESTING = '2.7.0beta1';
$DOWNLOAD_CLIENT_DESKTOP_TEST_BASE= 'https://download.nextcloud.com/desktop/prereleases/';
$DOWNLOAD_CLIENT_DESKTOP_TEST_WIN = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'Windows/Nextcloud-2.7.0.15031-beta1-20200119.exe';
$DOWNLOAD_CLIENT_DESKTOP_TEST_MAC = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'Mac/Nextcloud-qt5.12.5-2.7.0.20200122beta1.pkg';
$DOWNLOAD_CLIENT_DESKTOP_TEST_LINUX = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'Linux/Nextcloud-2.7.0.20200119-beta1-x86_64.AppImage';
...
$SERVER_TESTING_VERSION ='18 beta 3'; // nothing to test -> leave it empty
$DOWNLOAD_SERVER_TAR_TESTING ='https://download.nextcloud.com/server/prereleases/nextcloud-18.0.0beta3.tar.bz2';
$DOWNLOAD_SERVER_ZIP_TESTING ='https://download.nextcloud.com/server/prereleases/nextcloud-18.0.0beta3.zip';
