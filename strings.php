...
/* DOCUMENTATION */
$DOCUMENTATION_BASE = 'https://doc.nextcloud.org';
...
/* DOWNLOADS */
$OWNCLOUD_GPG = 'https://nextcloud.org/nextcloud.asc';
...
// Server
$DOWNLOAD_SERVER_BASE = 'https://download.nextcloud.org/community/';
...
$DOWNLOAD_SERVER_PACKAGES_STABLE = 'https://download.nextcloud.org/download/repositories/stable/nextcloud';
...
// Daily
$DOWNLOAD_SERVER_DAILY_TAR = $DOWNLOAD_SERVER_BASE.'daily/nextcloud-daily-master.tar.bz2';
$DOWNLOAD_SERVER_DAILY_TAR_MD5 = $DOWNLOAD_SERVER_BASE.'daily/nextcloud-daily-master.tar.bz2.md5';
$DOWNLOAD_SERVER_PACKAGES_DAILY = 'https://download.nextcloud.org/download/repositories/nightly/nextcloud';
...
// VM
$DOWNLOAD_VM_BASE = 'http://download.nextcloud.org/community/production/vm/';
...
$DOWNLOAD_CLIENT_MOBILE_ANDROID = 'https://play.google.com/store/apps/details?id=com.nextcloud.android';
