...
$DOWNLOAD_CLIENT_DESKTOP_STABLE_LINUX = $DOWNLOAD_CLIENT_DESKTOP_BASE.'/Nextcloud-'.$VERSIONS_CLIENT_DESKTOP_STABLE_FULL.'-x64.AppImage';
...
$SERVER_TESTING_VERSION ='23.0.0rc3'; // nothing to test -> leave it empty
