...
$VERSIONS_CLIENT_DESKTOP_TESTING = '3.5.0-rc3';
$DOWNLOAD_CLIENT_DESKTOP_TEST_BASE= 'https://github.com/nextcloud/desktop/releases/tag/v';
$DOWNLOAD_CLIENT_DESKTOP_TEST_WIN = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.''.$VERSIONS_CLIENT_DESKTOP_TESTING;
$DOWNLOAD_CLIENT_DESKTOP_TEST_MAC = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.''.$VERSIONS_CLIENT_DESKTOP_TESTING;
$DOWNLOAD_CLIENT_DESKTOP_TEST_LINUX = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.''.$VERSIONS_CLIENT_DESKTOP_TESTING;
...
$SERVER_TESTING_VERSION ='24.0.0rc3'; // nothing to test -> leave it empty
