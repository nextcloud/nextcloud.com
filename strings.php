...
$VERSIONS_SERVER_FULL_STABLE = '12.0.4';
...
$SERVER_TESTING_VERSION ='13.0 Beta 3'; // nothing to test -> leave it empty
$DOWNLOAD_SERVER_TAR_TESTING ='https://download.nextcloud.com/server/prereleases/nextcloud-13.0.0beta3.tar.bz2';
$DOWNLOAD_SERVER_ZIP_TESTING ='https://download.nextcloud.com/server/prereleases/nextcloud-13.0.0beta3.zip';
