    ...
    <div class="container">
        ...
        <div class="col-sm-3">
            ...
            <ul class="revealOnScroll">
                ...
                <li><a href="https://docs.nextcloud.com/server/11/admin_manual/"><?php echo $l->t('Admin manual') ?></a></li>
                <li><a href="https://docs.nextcloud.com/server/11/user_manual/"><?php echo $l->t('User manual') ?></a></li>
                <li><a href="https://docs.nextcloud.com/server/11/developer_manual/"><?php echo $l->t('Developer manual') ?></a></li>
