...
<!--						<li class="nav__item"><a href="<?php echo home_url('contributors') ?>"><?php echo $l->t('Community members');?></a></li>-->
				...
				<ul class="right-buttons">
                    ...
                    <li class="flag"><a href="<?php echo site_url(); ?>/de/<?php echo $pagename ?>" class="nav__label"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/flags/de.gif"></a> | <a href="<?php echo site_url(); ?>/<?php echo $pagename ?>" class="nav__label"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/flags/gb.gif"></a>
                    </li>
				</li>
				</ul>
			</div>
